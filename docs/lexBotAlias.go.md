...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/lexbotalias"
...
| <code><a href="#@cdktf/provider-aws.lexBotAlias.LexBotAlias.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&lexbotalias.LexBotAliasConfig {
	...
	BotVersion: *string,
	Name: *string,
	ConversationLogs: github.com/cdktf/cdktf-provider-aws-go/aws/v21.lexBotAlias.LexBotAliasConversationLogs,
	Description: *string,
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.lexBotAlias.LexBotAliasTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.lexBotAlias.LexBotAliasConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
