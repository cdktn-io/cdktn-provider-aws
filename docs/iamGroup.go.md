...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/iamgroup"
...
| <code><a href="#@cdktf/provider-aws.iamGroup.IamGroup.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.iamGroup.IamGroupConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
