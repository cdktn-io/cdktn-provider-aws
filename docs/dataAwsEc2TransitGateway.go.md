...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2transitgateway"
...
&dataawsec2transitgateway.DataAwsEc2TransitGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2TransitGateway.DataAwsEc2TransitGatewayTimeouts,
}
```
