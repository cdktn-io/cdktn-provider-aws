...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/fmsresourceset"
...
&fmsresourceset.FmsResourceSetConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.fmsResourceSet.FmsResourceSetTimeouts,
}
```
