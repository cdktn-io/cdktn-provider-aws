...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/rdsintegration"
...
&rdsintegration.RdsIntegrationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.rdsIntegration.RdsIntegrationTimeouts,
}
```
