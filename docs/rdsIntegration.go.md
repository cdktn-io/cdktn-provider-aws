...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/rdsintegration"
...
&rdsintegration.RdsIntegrationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.rdsIntegration.RdsIntegrationTimeouts,
}
```
