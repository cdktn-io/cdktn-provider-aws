...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/ssoadminapplication"
...
| <code><a href="#@cdktn/provider-aws.ssoadminApplication.SsoadminApplicationConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/ssoadmin_application#tags SsoadminApplication#tags}. |
