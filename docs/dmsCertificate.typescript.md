...
| <code><a href="#@cdktn/provider-aws.dmsCertificate.DmsCertificateConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/dms_certificate#tags DmsCertificate#tags}. |
| <code><a href="#@cdktn/provider-aws.dmsCertificate.DmsCertificateConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/dms_certificate#tags_all DmsCertificate#tags_all}. |
