...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsvpc"
...
&dataawsvpc.DataAwsVpcConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.dataAwsVpc.DataAwsVpcTimeouts,
}
```
