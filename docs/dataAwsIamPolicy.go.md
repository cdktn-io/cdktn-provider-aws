...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsiampolicy"
...
| <code><a href="#@cdktn/provider-aws.dataAwsIamPolicy.DataAwsIamPolicyConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/iam_policy#tags DataAwsIamPolicy#tags}. |
