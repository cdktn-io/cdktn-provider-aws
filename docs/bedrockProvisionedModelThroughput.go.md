...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/bedrockprovisionedmodelthroughput"
...
&bedrockprovisionedmodelthroughput.BedrockProvisionedModelThroughputConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.bedrockProvisionedModelThroughput.BedrockProvisionedModelThroughputTimeouts,
}
```
