...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/securitylakesubscriber"
...
&securitylakesubscriber.SecuritylakeSubscriberConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.securitylakeSubscriber.SecuritylakeSubscriberTimeouts,
}
```
