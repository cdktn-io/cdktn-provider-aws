...
```typescript
import { dataAwsElbHostedZoneId } from '@cdktf/provider-aws'
...
| <code><a href="#@cdktf/provider-aws.dataAwsElbHostedZoneId.DataAwsElbHostedZoneId.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
