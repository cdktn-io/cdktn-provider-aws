...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/appautoscalingscheduledaction"
...
| <code><a href="#@cdktf/provider-aws.appautoscalingScheduledAction.AppautoscalingScheduledAction.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&appautoscalingscheduledaction.AppautoscalingScheduledActionConfig {
	...
	ScalableTargetAction: github.com/cdktf/cdktf-provider-aws-go/aws/v21.appautoscalingScheduledAction.AppautoscalingScheduledActionScalableTargetAction,
	Schedule: *string,
...
| <code><a href="#@cdktf/provider-aws.appautoscalingScheduledAction.AppautoscalingScheduledActionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
