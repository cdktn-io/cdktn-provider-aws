...
| <code><a href="#@cdktn/provider-aws.iamUserPolicy.IamUserPolicyConfig.property.policy">policy</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/iam_user_policy#policy IamUserPolicy#policy}. |
| <code><a href="#@cdktn/provider-aws.iamUserPolicy.IamUserPolicyConfig.property.user">user</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/iam_user_policy#user IamUserPolicy#user}. |
| <code><a href="#@cdktn/provider-aws.iamUserPolicy.IamUserPolicyConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/iam_user_policy#id IamUserPolicy#id}. |
| <code><a href="#@cdktn/provider-aws.iamUserPolicy.IamUserPolicyConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/iam_user_policy#name IamUserPolicy#name}. |
| <code><a href="#@cdktn/provider-aws.iamUserPolicy.IamUserPolicyConfig.property.namePrefix">namePrefix</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/iam_user_policy#name_prefix IamUserPolicy#name_prefix}. |
