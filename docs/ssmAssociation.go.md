...
| <code><a href="#@cdktn/provider-aws.ssmAssociation.SsmAssociationConfig.property.parameters">Parameters</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ssm_association#parameters SsmAssociation#parameters}. |
...
| <code><a href="#@cdktn/provider-aws.ssmAssociation.SsmAssociationConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ssm_association#tags SsmAssociation#tags}. |
| <code><a href="#@cdktn/provider-aws.ssmAssociation.SsmAssociationConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ssm_association#tags_all SsmAssociation#tags_all}. |
