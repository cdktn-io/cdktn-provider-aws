...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawslbtargetgroup"
...
&dataawslbtargetgroup.DataAwsLbTargetGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsLbTargetGroup.DataAwsLbTargetGroupTimeouts,
}
```
