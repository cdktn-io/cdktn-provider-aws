...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dxhostedprivatevirtualinterfaceaccepter"
...
| <code><a href="#@cdktf/provider-aws.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepter.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dxhostedprivatevirtualinterfaceaccepter.DxHostedPrivateVirtualInterfaceAccepterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepterTimeouts,
	VpnGatewayId: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.dxHostedPrivateVirtualInterfaceAccepter.DxHostedPrivateVirtualInterfaceAccepterConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
