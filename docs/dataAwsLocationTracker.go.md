...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawslocationtracker"
...
| <code><a href="#@cdktn/provider-aws.dataAwsLocationTracker.DataAwsLocationTrackerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/location_tracker#tags DataAwsLocationTracker#tags}. |
