...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/msk_topic#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-aws.mskTopic.MskTopicConfig.property.clusterArn">ClusterArn</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/msk_topic#cluster_arn MskTopic#cluster_arn}. |
| <code><a href="#@cdktn/provider-aws.mskTopic.MskTopicConfig.property.name">Name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/msk_topic#name MskTopic#name}. |
| <code><a href="#@cdktn/provider-aws.mskTopic.MskTopicConfig.property.partitionCount">PartitionCount</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/msk_topic#partition_count MskTopic#partition_count}. |
| <code><a href="#@cdktn/provider-aws.mskTopic.MskTopicConfig.property.replicationFactor">ReplicationFactor</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/msk_topic#replication_factor MskTopic#replication_factor}. |
| <code><a href="#@cdktn/provider-aws.mskTopic.MskTopicConfig.property.configs">Configs</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/msk_topic#configs MskTopic#configs}. |
