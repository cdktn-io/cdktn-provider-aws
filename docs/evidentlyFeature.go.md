...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/evidentlyfeature"
...
&evidentlyfeature.EvidentlyFeatureConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.evidentlyFeature.EvidentlyFeatureTimeouts,
}
```
...
&evidentlyfeature.EvidentlyFeatureVariations {
	Name: *string,
	Value: github.com/cdktn-io/cdktn-provider-aws-go/aws.evidentlyFeature.EvidentlyFeatureVariationsValue,
}
```
