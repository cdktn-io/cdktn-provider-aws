...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsredshiftsubnetgroup"
...
| <code><a href="#@cdktn/provider-aws.dataAwsRedshiftSubnetGroup.DataAwsRedshiftSubnetGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/data-sources/redshift_subnet_group#tags DataAwsRedshiftSubnetGroup#tags}. |
