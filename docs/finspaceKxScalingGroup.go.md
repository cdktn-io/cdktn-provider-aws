...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/finspacekxscalinggroup"
...
&finspacekxscalinggroup.FinspaceKxScalingGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.finspaceKxScalingGroup.FinspaceKxScalingGroupTimeouts,
}
```
