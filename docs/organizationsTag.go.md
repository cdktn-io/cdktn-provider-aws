...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/organizationstag"
...
| <code><a href="#@cdktn/provider-aws.organizationsTag.OrganizationsTagConfig.property.key">Key</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/organizations_tag#key OrganizationsTag#key}. |
| <code><a href="#@cdktn/provider-aws.organizationsTag.OrganizationsTagConfig.property.resourceId">ResourceId</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/organizations_tag#resource_id OrganizationsTag#resource_id}. |
| <code><a href="#@cdktn/provider-aws.organizationsTag.OrganizationsTagConfig.property.value">Value</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/organizations_tag#value OrganizationsTag#value}. |
| <code><a href="#@cdktn/provider-aws.organizationsTag.OrganizationsTagConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/organizations_tag#id OrganizationsTag#id}. |
