...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/cloudhsmv2cluster"
...
&cloudhsmv2cluster.CloudhsmV2ClusterConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.cloudhsmV2Cluster.CloudhsmV2ClusterTimeouts,
}
```
