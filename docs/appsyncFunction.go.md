...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/appsyncfunction"
...
&appsyncfunction.AppsyncFunctionConfig {
	...
	Runtime: github.com/cdktn-io/cdktn-provider-aws-go/aws.appsyncFunction.AppsyncFunctionRuntime,
	SyncConfig: github.com/cdktn-io/cdktn-provider-aws-go/aws.appsyncFunction.AppsyncFunctionSyncConfig,
}
```
...
&appsyncfunction.AppsyncFunctionSyncConfig {
	...
	LambdaConflictHandlerConfig: github.com/cdktn-io/cdktn-provider-aws-go/aws.appsyncFunction.AppsyncFunctionSyncConfigLambdaConflictHandlerConfig,
}
```
