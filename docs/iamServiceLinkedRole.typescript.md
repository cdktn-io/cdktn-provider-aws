...
| <code><a href="#@cdktn/provider-aws.iamServiceLinkedRole.IamServiceLinkedRoleConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/iam_service_linked_role#tags IamServiceLinkedRole#tags}. |
| <code><a href="#@cdktn/provider-aws.iamServiceLinkedRole.IamServiceLinkedRoleConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/iam_service_linked_role#tags_all IamServiceLinkedRole#tags_all}. |
