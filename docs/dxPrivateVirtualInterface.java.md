...
//  .prefixPoolAllocatedCountIpv4(java.lang.Number)
//  .prefixPoolAllocatedCountIpv6(java.lang.Number)
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.vlan">vlan</a></code> | <code>java.lang.Number</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_private_virtual_interface#vlan DxPrivateVirtualInterface#vlan}. |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.bgpAsnLong">bgpAsnLong</a></code> | <code>java.lang.String</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_private_virtual_interface#bgp_asn_long DxPrivateVirtualInterface#bgp_asn_long}. |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.prefixPoolAllocatedCountIpv4">prefixPoolAllocatedCountIpv4</a></code> | <code>java.lang.Number</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_private_virtual_interface#prefix_pool_allocated_count_ipv4 DxPrivateVirtualInterface#prefix_pool_allocated_count_ipv4}. |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.prefixPoolAllocatedCountIpv6">prefixPoolAllocatedCountIpv6</a></code> | <code>java.lang.Number</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_private_virtual_interface#prefix_pool_allocated_count_ipv6 DxPrivateVirtualInterface#prefix_pool_allocated_count_ipv6}. |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.sitelinkEnabled">sitelinkEnabled</a></code> | <code>java.lang.Boolean\|io.cdktn.cdktn.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_private_virtual_interface#sitelink_enabled DxPrivateVirtualInterface#sitelink_enabled}. |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.tags">tags</a></code> | <code>java.util.Map<java.lang.String, java.lang.String></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_private_virtual_interface#tags DxPrivateVirtualInterface#tags}. |
...
##### `bgpAsn`<sup>Optional</sup> <a name="bgpAsn" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.bgpAsn"></a>
...
##### `bgpAsnLong`<sup>Optional</sup> <a name="bgpAsnLong" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.bgpAsnLong"></a>
...
##### `prefixPoolAllocatedCountIpv4`<sup>Optional</sup> <a name="prefixPoolAllocatedCountIpv4" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.prefixPoolAllocatedCountIpv4"></a>
...
##### `prefixPoolAllocatedCountIpv6`<sup>Optional</sup> <a name="prefixPoolAllocatedCountIpv6" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.prefixPoolAllocatedCountIpv6"></a>
...
##### `rateLimit`<sup>Optional</sup> <a name="rateLimit" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.Initializer.parameter.rateLimit"></a>
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetBgpAsn">resetBgpAsn</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetBgpAsnLong">resetBgpAsnLong</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetPrefixPoolAllocatedCountIpv4">resetPrefixPoolAllocatedCountIpv4</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetPrefixPoolAllocatedCountIpv6">resetPrefixPoolAllocatedCountIpv6</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetRateLimit">resetRateLimit</a></code> | *No description.* |
...
##### `resetBgpAsn` <a name="resetBgpAsn" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetBgpAsn"></a>

```java
public void resetBgpAsn()
```

##### `resetBgpAsnLong` <a name="resetBgpAsnLong" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetBgpAsnLong"></a>
...
##### `resetPrefixPoolAllocatedCountIpv4` <a name="resetPrefixPoolAllocatedCountIpv4" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetPrefixPoolAllocatedCountIpv4"></a>

```java
public void resetPrefixPoolAllocatedCountIpv4()
```

##### `resetPrefixPoolAllocatedCountIpv6` <a name="resetPrefixPoolAllocatedCountIpv6" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetPrefixPoolAllocatedCountIpv6"></a>

```java
public void resetPrefixPoolAllocatedCountIpv6()
```

##### `resetRateLimit` <a name="resetRateLimit" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.resetRateLimit"></a>
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.bgpAsnLongInput">bgpAsnLongInput</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv4Input">prefixPoolAllocatedCountIpv4Input</a></code> | <code>java.lang.Number</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv6Input">prefixPoolAllocatedCountIpv6Input</a></code> | <code>java.lang.Number</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.rateLimitInput">rateLimitInput</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.bgpAsnLong">bgpAsnLong</a></code> | <code>java.lang.String</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv4">prefixPoolAllocatedCountIpv4</a></code> | <code>java.lang.Number</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv6">prefixPoolAllocatedCountIpv6</a></code> | <code>java.lang.Number</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.rateLimit">rateLimit</a></code> | <code>java.lang.String</code> | *No description.* |
...
##### `bgpAsnLongInput`<sup>Optional</sup> <a name="bgpAsnLongInput" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.bgpAsnLongInput"></a>
...
##### `prefixPoolAllocatedCountIpv4Input`<sup>Optional</sup> <a name="prefixPoolAllocatedCountIpv4Input" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv4Input"></a>

```java
public java.lang.Number getPrefixPoolAllocatedCountIpv4Input();
```
...
##### `prefixPoolAllocatedCountIpv6Input`<sup>Optional</sup> <a name="prefixPoolAllocatedCountIpv6Input" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv6Input"></a>

```java
public java.lang.Number getPrefixPoolAllocatedCountIpv6Input();
```
...
##### `rateLimitInput`<sup>Optional</sup> <a name="rateLimitInput" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.rateLimitInput"></a>
...
##### `bgpAsnLong`<sup>Required</sup> <a name="bgpAsnLong" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.bgpAsnLong"></a>
...
##### `prefixPoolAllocatedCountIpv4`<sup>Required</sup> <a name="prefixPoolAllocatedCountIpv4" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv4"></a>
...
##### `prefixPoolAllocatedCountIpv6`<sup>Required</sup> <a name="prefixPoolAllocatedCountIpv6" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv6"></a>
...
##### `rateLimit`<sup>Required</sup> <a name="rateLimit" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterface.property.rateLimit"></a>
...
##### `bgpAsn`<sup>Optional</sup> <a name="bgpAsn" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceConfig.property.bgpAsn"></a>
...
##### `bgpAsnLong`<sup>Optional</sup> <a name="bgpAsnLong" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceConfig.property.bgpAsnLong"></a>
...
##### `prefixPoolAllocatedCountIpv4`<sup>Optional</sup> <a name="prefixPoolAllocatedCountIpv4" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceConfig.property.prefixPoolAllocatedCountIpv4"></a>
...
##### `prefixPoolAllocatedCountIpv6`<sup>Optional</sup> <a name="prefixPoolAllocatedCountIpv6" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceConfig.property.prefixPoolAllocatedCountIpv6"></a>
...
##### `rateLimit`<sup>Optional</sup> <a name="rateLimit" id="@cdktn/provider-aws.dxPrivateVirtualInterface.DxPrivateVirtualInterfaceConfig.property.rateLimit"></a>
