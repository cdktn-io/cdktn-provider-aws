...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/m2application"
...
&m2application.M2ApplicationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.m2Application.M2ApplicationTimeouts,
}
```
