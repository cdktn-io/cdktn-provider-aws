...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/ebssnapshot"
...
&ebssnapshot.EbsSnapshotConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.ebsSnapshot.EbsSnapshotTimeouts,
}
```
