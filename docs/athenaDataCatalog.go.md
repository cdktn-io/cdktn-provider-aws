...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog aws_athena_data_catalog}.

#### Initializers <a name="Initializers" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.Initializer"></a>

```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/athenadatacatalog"
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.resetId">ResetId</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.resetRegion">ResetRegion</a></code> | *No description.* |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.hasResourceMove"></a>

```go
func HasResourceMove() interface{}
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.importFrom"></a>

```go
func ImportFrom(id *string, provider TerraformProvider)
```

###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.importFrom.parameter.id"></a>

- *Type:* *string

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.importFrom.parameter.provider"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveFromId.parameter.id"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveTo.parameter.moveTarget"></a>
...
###### `index`<sup>Optional</sup> <a name="index" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveTo.parameter.index"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.moveToId.parameter.id"></a>
...
##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a AthenaDataCatalog resource upon running "cdktf plan <stack-name>". |
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.generateConfigForImport.parameter.importFromId"></a>

- *Type:* *string

The id of the existing AthenaDataCatalog that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.property.regionInput">RegionInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.property.region">Region</a></code> | <code>*string</code> | *No description.* |
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.property.regionInput"></a>
...
##### `Region`<sup>Required</sup> <a name="Region" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalog.property.region"></a>
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.description">Description</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#description AthenaDataCatalog#description}. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#name AthenaDataCatalog#name}. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.parameters">Parameters</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#parameters AthenaDataCatalog#parameters}. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.type">Type</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#type AthenaDataCatalog#type}. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#id AthenaDataCatalog#id}. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.region">Region</a></code> | <code>*string</code> | Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference). |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#tags AthenaDataCatalog#tags}. |
| <code><a href="#@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#tags_all AthenaDataCatalog#tags_all}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#description AthenaDataCatalog#description}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#name AthenaDataCatalog#name}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#parameters AthenaDataCatalog#parameters}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#type AthenaDataCatalog#type}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#id AthenaDataCatalog#id}.
...
##### `Region`<sup>Optional</sup> <a name="Region" id="@cdktf/provider-aws.athenaDataCatalog.AthenaDataCatalogConfig.property.region"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#region AthenaDataCatalog#region}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#tags AthenaDataCatalog#tags}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/athena_data_catalog#tags_all AthenaDataCatalog#tags_all}.
