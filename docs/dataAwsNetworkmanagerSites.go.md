...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsnetworkmanagersites"
...
| <code><a href="#@cdktf/provider-aws.dataAwsNetworkmanagerSites.DataAwsNetworkmanagerSites.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsNetworkmanagerSites.DataAwsNetworkmanagerSitesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
