...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawskinesisstream"
...
| <code><a href="#@cdktn/provider-aws.dataAwsKinesisStream.DataAwsKinesisStreamConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/kinesis_stream#tags DataAwsKinesisStream#tags}. |
