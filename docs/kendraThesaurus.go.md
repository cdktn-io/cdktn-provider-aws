...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/kendrathesaurus"
...
| <code><a href="#@cdktf/provider-aws.kendraThesaurus.KendraThesaurus.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&kendrathesaurus.KendraThesaurusConfig {
	...
	Name: *string,
	RoleArn: *string,
	SourceS3Path: github.com/cdktf/cdktf-provider-aws-go/aws/v21.kendraThesaurus.KendraThesaurusSourceS3Path,
	Description: *string,
	Id: *string,
	Region: *string,
	Tags: *map[string]*string,
	TagsAll: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.kendraThesaurus.KendraThesaurusTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.kendraThesaurus.KendraThesaurusConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.kendraThesaurus.KendraThesaurusConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/kendra_thesaurus#tags KendraThesaurus#tags}. |
| <code><a href="#@cdktf/provider-aws.kendraThesaurus.KendraThesaurusConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/kendra_thesaurus#tags_all KendraThesaurus#tags_all}. |
