...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/ssmquicksetupconfigurationmanager"
...
&ssmquicksetupconfigurationmanager.SsmquicksetupConfigurationManagerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.ssmquicksetupConfigurationManager.SsmquicksetupConfigurationManagerTimeouts,
}
```
