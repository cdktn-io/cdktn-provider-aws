...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/s3filesaccesspoint"
...
&s3filesaccesspoint.S3FilesAccessPointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v23.s3FilesAccessPoint.S3FilesAccessPointTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-aws.s3FilesAccessPoint.S3FilesAccessPointConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/s3files_access_point#tags S3FilesAccessPoint#tags}. |
