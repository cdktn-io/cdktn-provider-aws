...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/m2deployment"
...
&m2deployment.M2DeploymentConfig {
	...
	ForceStop: interface{},
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.m2Deployment.M2DeploymentTimeouts,
}
```
