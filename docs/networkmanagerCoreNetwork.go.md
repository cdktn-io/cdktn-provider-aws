...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/networkmanagercorenetwork"
...
&networkmanagercorenetwork.NetworkmanagerCoreNetworkConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.networkmanagerCoreNetwork.NetworkmanagerCoreNetworkTimeouts,
}
```
