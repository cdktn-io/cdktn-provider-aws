...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dxtransitvirtualinterface"
...
&dxtransitvirtualinterface.DxTransitVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v23.dxTransitVirtualInterface.DxTransitVirtualInterfaceTimeouts,
}
```
