...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dxtransitvirtualinterface"
...
&dxtransitvirtualinterface.DxTransitVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dxTransitVirtualInterface.DxTransitVirtualInterfaceTimeouts,
}
```
