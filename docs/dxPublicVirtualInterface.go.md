...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dxpublicvirtualinterface"
...
&dxpublicvirtualinterface.DxPublicVirtualInterfaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dxPublicVirtualInterface.DxPublicVirtualInterfaceTimeouts,
}
```
