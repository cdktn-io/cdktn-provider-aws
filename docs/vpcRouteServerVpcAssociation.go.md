...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/vpcrouteservervpcassociation"
...
&vpcrouteservervpcassociation.VpcRouteServerVpcAssociationConfig {
	...
	VpcId: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.vpcRouteServerVpcAssociation.VpcRouteServerVpcAssociationTimeouts,
}
```
