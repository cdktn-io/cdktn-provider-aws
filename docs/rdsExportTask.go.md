...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/rdsexporttask"
...
&rdsexporttask.RdsExportTaskConfig {
	...
	Region: *string,
	S3Prefix: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.rdsExportTask.RdsExportTaskTimeouts,
}
```
