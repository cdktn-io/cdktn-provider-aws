...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2localgatewayroutetable"
...
&dataawsec2localgatewayroutetable.DataAwsEc2LocalGatewayRouteTableConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2LocalGatewayRouteTable.DataAwsEc2LocalGatewayRouteTableTimeouts,
}
```
