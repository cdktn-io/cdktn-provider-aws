...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/ec2instanceconnectendpoint"
...
&ec2instanceconnectendpoint.Ec2InstanceConnectEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.ec2InstanceConnectEndpoint.Ec2InstanceConnectEndpointTimeouts,
}
```
