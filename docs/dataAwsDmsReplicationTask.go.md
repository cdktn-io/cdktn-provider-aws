...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawsdmsreplicationtask"
...
| <code><a href="#@cdktn/provider-aws.dataAwsDmsReplicationTask.DataAwsDmsReplicationTaskConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/dms_replication_task#tags DataAwsDmsReplicationTask#tags}. |
