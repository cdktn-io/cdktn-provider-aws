...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group aws_placement_group}.
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#name PlacementGroup#name}. |
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.strategy">Strategy</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#strategy PlacementGroup#strategy}. |
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#id PlacementGroup#id}. |
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.partitionCount">PartitionCount</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#partition_count PlacementGroup#partition_count}. |
...
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.spreadLevel">SpreadLevel</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#spread_level PlacementGroup#spread_level}. |
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#tags PlacementGroup#tags}. |
| <code><a href="#@cdktn/provider-aws.placementGroup.PlacementGroupConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/placement_group#tags_all PlacementGroup#tags_all}. |
