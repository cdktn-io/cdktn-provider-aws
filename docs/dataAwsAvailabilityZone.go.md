...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsavailabilityzone"
...
&dataawsavailabilityzone.DataAwsAvailabilityZoneConfig {
	...
	Region: *string,
	State: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsAvailabilityZone.DataAwsAvailabilityZoneTimeouts,
	ZoneId: *string,
}
```
