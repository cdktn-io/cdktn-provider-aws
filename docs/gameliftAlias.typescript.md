...
| <code><a href="#@cdktn/provider-aws.gameliftAlias.GameliftAliasConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/gamelift_alias#tags GameliftAlias#tags}. |
| <code><a href="#@cdktn/provider-aws.gameliftAlias.GameliftAliasConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/gamelift_alias#tags_all GameliftAlias#tags_all}. |
