...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsroute"
...
&dataawsroute.DataAwsRouteConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsRoute.DataAwsRouteTimeouts,
