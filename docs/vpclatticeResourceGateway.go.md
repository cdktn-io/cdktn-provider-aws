...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/vpclatticeresourcegateway"
...
&vpclatticeresourcegateway.VpclatticeResourceGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.vpclatticeResourceGateway.VpclatticeResourceGatewayTimeouts,
}
```
