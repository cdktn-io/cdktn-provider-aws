...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/bedrockagentagentcollaborator"
...
&bedrockagentagentcollaborator.BedrockagentAgentCollaboratorConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.bedrockagentAgentCollaborator.BedrockagentAgentCollaboratorTimeouts,
}
```
