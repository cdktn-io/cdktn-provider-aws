...
| <code><a href="#@cdktf/provider-aws.oamSink.OamSinkConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/oam_sink#tags OamSink#tags}. |
| <code><a href="#@cdktf/provider-aws.oamSink.OamSinkConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/oam_sink#tags_all OamSink#tags_all}. |
