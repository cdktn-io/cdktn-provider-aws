...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/finspacekxuser"
...
&finspacekxuser.FinspaceKxUserConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.finspaceKxUser.FinspaceKxUserTimeouts,
}
```
