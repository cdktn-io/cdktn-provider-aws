...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/dataawslambdafunctions"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/lambda_functions#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-aws.dataAwsLambdaFunctions.DataAwsLambdaFunctionsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/lambda_functions#id DataAwsLambdaFunctions#id}. |
