...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/ses_email_identity#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-aws.dataAwsSesEmailIdentity.DataAwsSesEmailIdentityConfig.property.email">Email</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/ses_email_identity#email DataAwsSesEmailIdentity#email}. |
| <code><a href="#@cdktn/provider-aws.dataAwsSesEmailIdentity.DataAwsSesEmailIdentityConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/ses_email_identity#id DataAwsSesEmailIdentity#id}. |
