...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawssecuritygroups"
...
&dataawssecuritygroups.DataAwsSecurityGroupsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsSecurityGroups.DataAwsSecurityGroupsTimeouts,
}
```
