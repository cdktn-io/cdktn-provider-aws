...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/eipdomainname"
...
&eipdomainname.EipDomainNameConfig {
	...
	DomainName: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.eipDomainName.EipDomainNameTimeouts,
}
```
