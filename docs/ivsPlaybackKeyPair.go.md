...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/ivsplaybackkeypair"
...
&ivsplaybackkeypair.IvsPlaybackKeyPairConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.ivsPlaybackKeyPair.IvsPlaybackKeyPairTimeouts,
}
```
