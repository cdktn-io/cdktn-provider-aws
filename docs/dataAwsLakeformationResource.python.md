...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource aws_lakeformation_resource}.
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.Initializer.parameter.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.Initializer.parameter.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.Initializer.parameter.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.Initializer.parameter.arn">arn</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource#arn DataAwsLakeformationResource#arn}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource#arn DataAwsLakeformationResource#arn}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource#id DataAwsLakeformationResource#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource#region DataAwsLakeformationResource#region}
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.toHclTerraform">to_hcl_terraform</a></code> | Adds this resource to the terraform JSON output. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.resetRegion">reset_region</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.toHclTerraform"></a>
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a DataAwsLakeformationResource resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.generateConfigForImport"></a>
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.generateConfigForImport.parameter.importFromId"></a>

- *Type:* str

The id of the existing DataAwsLakeformationResource that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.hybridAccessEnabled">hybrid_access_enabled</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.withFederation">with_federation</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.withPrivilegedAccess">with_privileged_access</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.region">region</a></code> | <code>str</code> | *No description.* |
...
##### `hybrid_access_enabled`<sup>Required</sup> <a name="hybrid_access_enabled" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.hybridAccessEnabled"></a>
...
##### `with_federation`<sup>Required</sup> <a name="with_federation" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.withFederation"></a>
...
##### `with_privileged_access`<sup>Required</sup> <a name="with_privileged_access" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.withPrivilegedAccess"></a>
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResource.property.regionInput"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResourceConfig.property.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResourceConfig.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResourceConfig.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsLakeformationResource.DataAwsLakeformationResourceConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/lakeformation_resource#id DataAwsLakeformationResource#id}. |
