...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawssubnets"
...
&dataawssubnets.DataAwsSubnetsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.dataAwsSubnets.DataAwsSubnetsTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-aws.dataAwsSubnets.DataAwsSubnetsConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/subnets#tags DataAwsSubnets#tags}. |
