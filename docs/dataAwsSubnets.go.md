...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawssubnets"
...
&dataawssubnets.DataAwsSubnetsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsSubnets.DataAwsSubnetsTimeouts,
}
```
