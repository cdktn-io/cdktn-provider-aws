...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsidentitystoreuser"
...
| <code><a href="#@cdktf/provider-aws.dataAwsIdentitystoreUser.DataAwsIdentitystoreUser.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dataawsidentitystoreuser.DataAwsIdentitystoreUserAlternateIdentifier {
	ExternalId: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dataAwsIdentitystoreUser.DataAwsIdentitystoreUserAlternateIdentifierExternalId,
	UniqueAttribute: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dataAwsIdentitystoreUser.DataAwsIdentitystoreUserAlternateIdentifierUniqueAttribute,
}
```
...
&dataawsidentitystoreuser.DataAwsIdentitystoreUserConfig {
	...
	AlternateIdentifier: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dataAwsIdentitystoreUser.DataAwsIdentitystoreUserAlternateIdentifier,
	Id: *string,
	Region: *string,
	UserId: *string,
}
...
| <code><a href="#@cdktf/provider-aws.dataAwsIdentitystoreUser.DataAwsIdentitystoreUserConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
