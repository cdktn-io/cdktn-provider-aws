...
| <code><a href="#@cdktn/provider-aws.shieldProtection.ShieldProtectionConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/shield_protection#tags ShieldProtection#tags}. |
| <code><a href="#@cdktn/provider-aws.shieldProtection.ShieldProtectionConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/shield_protection#tags_all ShieldProtection#tags_all}. |
