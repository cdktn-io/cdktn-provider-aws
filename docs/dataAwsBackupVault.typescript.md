...
| <code><a href="#@cdktn/provider-aws.dataAwsBackupVault.DataAwsBackupVaultConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/backup_vault#tags DataAwsBackupVault#tags}. |
