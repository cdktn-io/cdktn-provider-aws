...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawseips"
...
&dataawseips.DataAwsEipsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEips.DataAwsEipsTimeouts,
}
```
