...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/appfabricappauthorization"
...
&appfabricappauthorization.AppfabricAppAuthorizationConfig {
	...
	Tenant: interface{},
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.appfabricAppAuthorization.AppfabricAppAuthorizationTimeouts,
}
```
