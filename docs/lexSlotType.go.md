...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/lexslottype"
...
&lexslottype.LexSlotTypeConfig {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.lexSlotType.LexSlotTypeTimeouts,
