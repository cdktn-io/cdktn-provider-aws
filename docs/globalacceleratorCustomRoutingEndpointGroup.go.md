...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/globalacceleratorcustomroutingendpointgroup"
...
&globalacceleratorcustomroutingendpointgroup.GlobalacceleratorCustomRoutingEndpointGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.globalacceleratorCustomRoutingEndpointGroup.GlobalacceleratorCustomRoutingEndpointGroupTimeouts,
}
```
