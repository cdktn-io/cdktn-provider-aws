...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/bedrockagentcorememory"
...
&bedrockagentcorememory.BedrockagentcoreMemoryConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.bedrockagentcoreMemory.BedrockagentcoreMemoryTimeouts,
}
```
