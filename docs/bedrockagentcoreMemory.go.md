...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/bedrockagentcorememory"
...
&bedrockagentcorememory.BedrockagentcoreMemoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.bedrockagentcoreMemory.BedrockagentcoreMemoryTimeouts,
}
```
