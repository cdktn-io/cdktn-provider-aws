...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/media_store_container#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-aws.mediaStoreContainer.MediaStoreContainerConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/media_store_container#name MediaStoreContainer#name}. |
| <code><a href="#@cdktn/provider-aws.mediaStoreContainer.MediaStoreContainerConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/media_store_container#id MediaStoreContainer#id}. |
...
| <code><a href="#@cdktn/provider-aws.mediaStoreContainer.MediaStoreContainerConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/media_store_container#tags MediaStoreContainer#tags}. |
| <code><a href="#@cdktn/provider-aws.mediaStoreContainer.MediaStoreContainerConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/media_store_container#tags_all MediaStoreContainer#tags_all}. |
