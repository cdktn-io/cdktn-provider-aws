...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dsqlcluster"
...
&dsqlcluster.DsqlClusterConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dsqlCluster.DsqlClusterTimeouts,
}
```
