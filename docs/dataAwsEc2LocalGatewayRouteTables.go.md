...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2localgatewayroutetables"
...
&dataawsec2localgatewayroutetables.DataAwsEc2LocalGatewayRouteTablesConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2LocalGatewayRouteTables.DataAwsEc2LocalGatewayRouteTablesTimeouts,
}
```
