...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/route53resolverruleassociation"
...
| <code><a href="#@cdktf/provider-aws.route53ResolverRuleAssociation.Route53ResolverRuleAssociation.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&route53resolverruleassociation.Route53ResolverRuleAssociationConfig {
	...
	Name: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.route53ResolverRuleAssociation.Route53ResolverRuleAssociationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.route53ResolverRuleAssociation.Route53ResolverRuleAssociationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
