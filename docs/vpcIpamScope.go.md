...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/vpcipamscope"
...
&vpcipamscope.VpcIpamScopeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v24.vpcIpamScope.VpcIpamScopeTimeouts,
}
```
