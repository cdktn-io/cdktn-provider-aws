...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/appfabricappbundle"
...
| <code><a href="#@cdktn/provider-aws.appfabricAppBundle.AppfabricAppBundleConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appfabric_app_bundle#tags AppfabricAppBundle#tags}. |
