...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/appfabricappbundle"
...
| <code><a href="#@cdktn/provider-aws.appfabricAppBundle.AppfabricAppBundleConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/appfabric_app_bundle#tags AppfabricAppBundle#tags}. |
