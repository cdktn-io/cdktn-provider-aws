...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/quicksightnamespace"
...
&quicksightnamespace.QuicksightNamespaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.quicksightNamespace.QuicksightNamespaceTimeouts,
}
```
