...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/quicksightnamespace"
...
&quicksightnamespace.QuicksightNamespaceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.quicksightNamespace.QuicksightNamespaceTimeouts,
}
```
