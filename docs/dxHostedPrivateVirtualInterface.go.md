...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dxhostedprivatevirtualinterface"
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.resetBgpAsn">ResetBgpAsn</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.resetBgpAsnLong">ResetBgpAsnLong</a></code> | *No description.* |
...
##### `ResetBgpAsn` <a name="ResetBgpAsn" id="@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.resetBgpAsn"></a>

```go
func ResetBgpAsn()
```

##### `ResetBgpAsnLong` <a name="ResetBgpAsnLong" id="@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.resetBgpAsnLong"></a>
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv4">PrefixPoolAllocatedCountIpv4</a></code> | <code>*f64</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.prefixPoolAllocatedCountIpv6">PrefixPoolAllocatedCountIpv6</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.bgpAsnLongInput">BgpAsnLongInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.rateLimitInput">RateLimitInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.bgpAsnLong">BgpAsnLong</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.rateLimit">RateLimit</a></code> | <code>*string</code> | *No description.* |
...
##### `BgpAsnLongInput`<sup>Optional</sup> <a name="BgpAsnLongInput" id="@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.bgpAsnLongInput"></a>
...
##### `BgpAsnLong`<sup>Required</sup> <a name="BgpAsnLong" id="@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterface.property.bgpAsnLong"></a>
...
&dxhostedprivatevirtualinterface.DxHostedPrivateVirtualInterfaceConfig {
	...
	RateLimit: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceConfig.property.vlan">Vlan</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface#vlan DxHostedPrivateVirtualInterface#vlan}. |
...
| <code><a href="#@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceConfig.property.bgpAsnLong">BgpAsnLong</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface#bgp_asn_long DxHostedPrivateVirtualInterface#bgp_asn_long}. |
...
##### `BgpAsn`<sup>Optional</sup> <a name="BgpAsn" id="@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceConfig.property.bgpAsn"></a>
...
##### `BgpAsnLong`<sup>Optional</sup> <a name="BgpAsnLong" id="@cdktn/provider-aws.dxHostedPrivateVirtualInterface.DxHostedPrivateVirtualInterfaceConfig.property.bgpAsnLong"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface#create DxHostedPrivateVirtualInterface#create}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dx_hosted_private_virtual_interface#delete DxHostedPrivateVirtualInterface#delete}.
