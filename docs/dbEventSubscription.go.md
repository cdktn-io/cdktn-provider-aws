...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dbeventsubscription"
...
&dbeventsubscription.DbEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dbEventSubscription.DbEventSubscriptionTimeouts,
}
```
