...
| <code><a href="#@cdktn/provider-aws.emrStudio.EmrStudioConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/emr_studio#tags EmrStudio#tags}. |
| <code><a href="#@cdktn/provider-aws.emrStudio.EmrStudioConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/emr_studio#tags_all EmrStudio#tags_all}. |
