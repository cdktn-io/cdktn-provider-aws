...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/vpcipampool"
...
&vpcipampool.VpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.vpcIpamPool.VpcIpamPoolTimeouts,
}
```
