...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/datazoneglossaryterm"
...
&datazoneglossaryterm.DatazoneGlossaryTermConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v23.datazoneGlossaryTerm.DatazoneGlossaryTermTimeouts,
}
```
