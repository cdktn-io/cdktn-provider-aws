...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/datazoneglossaryterm"
...
&datazoneglossaryterm.DatazoneGlossaryTermConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.datazoneGlossaryTerm.DatazoneGlossaryTermTimeouts,
}
```
