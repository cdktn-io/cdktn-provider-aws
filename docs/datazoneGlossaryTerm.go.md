...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/datazoneglossaryterm"
...
&datazoneglossaryterm.DatazoneGlossaryTermConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.datazoneGlossaryTerm.DatazoneGlossaryTermTimeouts,
}
```
