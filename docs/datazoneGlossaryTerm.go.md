...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/datazoneglossaryterm"
...
&datazoneglossaryterm.DatazoneGlossaryTermConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.datazoneGlossaryTerm.DatazoneGlossaryTermTimeouts,
}
```
