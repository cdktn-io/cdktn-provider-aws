...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsnatgateway"
...
&dataawsnatgateway.DataAwsNatGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.dataAwsNatGateway.DataAwsNatGatewayTimeouts,
	VpcId: *string,
}
```
...
| <code><a href="#@cdktn/provider-aws.dataAwsNatGateway.DataAwsNatGatewayConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/nat_gateway#tags DataAwsNatGateway#tags}. |
