...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsroutetables"
...
&dataawsroutetables.DataAwsRouteTablesConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsRouteTables.DataAwsRouteTablesTimeouts,
	VpcId: *string,
}
```
