...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsroutetables"
...
&dataawsroutetables.DataAwsRouteTablesConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v24.dataAwsRouteTables.DataAwsRouteTablesTimeouts,
	VpcId: *string,
}
```
...
| <code><a href="#@cdktn/provider-aws.dataAwsRouteTables.DataAwsRouteTablesConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/data-sources/route_tables#tags DataAwsRouteTables#tags}. |
