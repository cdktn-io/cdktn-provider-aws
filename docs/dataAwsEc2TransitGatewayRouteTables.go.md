...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2transitgatewayroutetables"
...
&dataawsec2transitgatewayroutetables.DataAwsEc2TransitGatewayRouteTablesConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2TransitGatewayRouteTables.DataAwsEc2TransitGatewayRouteTablesTimeouts,
}
```
