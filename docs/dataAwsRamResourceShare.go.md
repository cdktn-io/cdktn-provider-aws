...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsramresourceshare"
...
| <code><a href="#@cdktn/provider-aws.dataAwsRamResourceShare.DataAwsRamResourceShareConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/ram_resource_share#tags DataAwsRamResourceShare#tags}. |
