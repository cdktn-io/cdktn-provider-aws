...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/amifrominstance"
...
&amifrominstance.AmiFromInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.amiFromInstance.AmiFromInstanceTimeouts,
}
```
