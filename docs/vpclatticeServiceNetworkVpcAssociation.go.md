...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/vpclatticeservicenetworkvpcassociation"
...
&vpclatticeservicenetworkvpcassociation.VpclatticeServiceNetworkVpcAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.vpclatticeServiceNetworkVpcAssociation.VpclatticeServiceNetworkVpcAssociationTimeouts,
}
```
