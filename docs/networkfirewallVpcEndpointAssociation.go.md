...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/networkfirewallvpcendpointassociation"
...
&networkfirewallvpcendpointassociation.NetworkfirewallVpcEndpointAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.networkfirewallVpcEndpointAssociation.NetworkfirewallVpcEndpointAssociationTimeouts,
}
```
