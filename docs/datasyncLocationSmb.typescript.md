...
| <code><a href="#@cdktn/provider-aws.datasyncLocationSmb.DatasyncLocationSmbConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/datasync_location_smb#tags DatasyncLocationSmb#tags}. |
| <code><a href="#@cdktn/provider-aws.datasyncLocationSmb.DatasyncLocationSmbConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/datasync_location_smb#tags_all DatasyncLocationSmb#tags_all}. |
