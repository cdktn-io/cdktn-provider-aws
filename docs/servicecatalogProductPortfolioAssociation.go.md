...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/servicecatalogproductportfolioassociation"
...
&servicecatalogproductportfolioassociation.ServicecatalogProductPortfolioAssociationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.servicecatalogProductPortfolioAssociation.ServicecatalogProductPortfolioAssociationTimeouts,
}
```
