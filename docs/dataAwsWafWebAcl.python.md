...
| <code><a href="#@cdktf/provider-aws.dataAwsWafWebAcl.DataAwsWafWebAcl.Initializer.parameter.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/waf_web_acl#name DataAwsWafWebAcl#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsWafWebAcl.DataAwsWafWebAcl.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/waf_web_acl#id DataAwsWafWebAcl#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsWafWebAcl.DataAwsWafWebAclConfig.property.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/waf_web_acl#name DataAwsWafWebAcl#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsWafWebAcl.DataAwsWafWebAclConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/waf_web_acl#id DataAwsWafWebAcl#id}. |
