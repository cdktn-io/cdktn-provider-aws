...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2host"
...
&dataawsec2host.DataAwsEc2HostConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2Host.DataAwsEc2HostTimeouts,
}
```
