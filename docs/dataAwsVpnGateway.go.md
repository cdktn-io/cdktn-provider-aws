...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsvpngateway"
...
&dataawsvpngateway.DataAwsVpnGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsVpnGateway.DataAwsVpnGatewayTimeouts,
}
```
