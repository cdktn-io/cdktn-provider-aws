...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/datazonedomain"
...
&datazonedomain.DatazoneDomainConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.datazoneDomain.DatazoneDomainTimeouts,
}
```
