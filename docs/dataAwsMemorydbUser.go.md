...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsmemorydbuser"
...
| <code><a href="#@cdktn/provider-aws.dataAwsMemorydbUser.DataAwsMemorydbUserConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/memorydb_user#tags DataAwsMemorydbUser#tags}. |
