...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/ec2defaultcreditspecification"
...
&ec2defaultcreditspecification.Ec2DefaultCreditSpecificationConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.ec2DefaultCreditSpecification.Ec2DefaultCreditSpecificationTimeouts,
}
```
