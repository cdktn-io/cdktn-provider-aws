...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/ekscapability"
...
&ekscapability.EksCapabilityConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v24.eksCapability.EksCapabilityTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-aws.eksCapability.EksCapabilityConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/eks_capability#tags EksCapability#tags}. |
