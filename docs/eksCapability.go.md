...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/ekscapability"
...
&ekscapability.EksCapabilityConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.eksCapability.EksCapabilityTimeouts,
}
```
