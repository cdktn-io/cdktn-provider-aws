...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsssmdocument"
...
| <code><a href="#@cdktf/provider-aws.dataAwsSsmDocument.DataAwsSsmDocument.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsSsmDocument.DataAwsSsmDocumentConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
