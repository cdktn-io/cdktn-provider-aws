...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/securityhubmember"
...
| <code><a href="#@cdktn/provider-aws.securityhubMember.SecurityhubMemberConfig.property.invite">Invite</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/securityhub_member#invite SecurityhubMember#invite}. |
