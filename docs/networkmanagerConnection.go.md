...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/networkmanagerconnection"
...
| <code><a href="#@cdktf/provider-aws.networkmanagerConnection.NetworkmanagerConnection.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&networkmanagerconnection.NetworkmanagerConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.networkmanagerConnection.NetworkmanagerConnectionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.networkmanagerConnection.NetworkmanagerConnectionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.networkmanagerConnection.NetworkmanagerConnectionConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/networkmanager_connection#tags NetworkmanagerConnection#tags}. |
