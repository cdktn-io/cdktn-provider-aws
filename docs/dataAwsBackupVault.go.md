...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsbackupvault"
...
| <code><a href="#@cdktn/provider-aws.dataAwsBackupVault.DataAwsBackupVaultConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/backup_vault#tags DataAwsBackupVault#tags}. |
