...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/macie2member"
...
&macie2member.Macie2MemberConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.macie2Member.Macie2MemberTimeouts,
}
```
