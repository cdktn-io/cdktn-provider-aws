...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/oamsinkpolicy"
...
| <code><a href="#@cdktf/provider-aws.oamSinkPolicy.OamSinkPolicy.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&oamsinkpolicy.OamSinkPolicyConfig {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.oamSinkPolicy.OamSinkPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.oamSinkPolicy.OamSinkPolicyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
