...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/lambdainvocation"
...
| <code><a href="#@cdktn/provider-aws.lambdaInvocation.LambdaInvocationConfig.property.triggers">Triggers</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/lambda_invocation#triggers LambdaInvocation#triggers}. |
