...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/route53recoveryreadinesscell"
...
&route53recoveryreadinesscell.Route53RecoveryreadinessCellConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.route53RecoveryreadinessCell.Route53RecoveryreadinessCellTimeouts,
}
```
