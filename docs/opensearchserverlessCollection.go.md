...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/opensearchserverlesscollection"
...
&opensearchserverlesscollection.OpensearchserverlessCollectionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.opensearchserverlessCollection.OpensearchserverlessCollectionTimeouts,
	Type: *string,
}
```
