...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/wafregionalrulegroup"
...
&wafregionalrulegroup.WafregionalRuleGroupActivatedRule {
	Action: github.com/cdktn-io/cdktn-provider-aws-go/aws.wafregionalRuleGroup.WafregionalRuleGroupActivatedRuleAction,
	Priority: *f64,
	RuleId: *string,
	Type: *string,
}
