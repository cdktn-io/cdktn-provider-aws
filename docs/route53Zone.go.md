...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/route53zone"
...
&route53zone.Route53ZoneConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.route53Zone.Route53ZoneTimeouts,
	Vpc: interface{},
}
```
