...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawscustomergateway"
...
&dataawscustomergateway.DataAwsCustomerGatewayConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsCustomerGateway.DataAwsCustomerGatewayTimeouts,
}
```
