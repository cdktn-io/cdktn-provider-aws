...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/rdsreservedinstance"
...
&rdsreservedinstance.RdsReservedInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v21.rdsReservedInstance.RdsReservedInstanceTimeouts,
}
```
