...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/networkmanagertransitgatewaypeering"
...
&networkmanagertransitgatewaypeering.NetworkmanagerTransitGatewayPeeringConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.networkmanagerTransitGatewayPeering.NetworkmanagerTransitGatewayPeeringTimeouts,
}
```
