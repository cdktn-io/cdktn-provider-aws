...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/vpcendpointsubnetassociation"
...
| <code><a href="#@cdktf/provider-aws.vpcEndpointSubnetAssociation.VpcEndpointSubnetAssociation.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&vpcendpointsubnetassociation.VpcEndpointSubnetAssociationConfig {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.vpcEndpointSubnetAssociation.VpcEndpointSubnetAssociationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.vpcEndpointSubnetAssociation.VpcEndpointSubnetAssociationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
