...
| <code><a href="#@cdktn/provider-aws.oamSink.OamSinkConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/oam_sink#tags OamSink#tags}. |
| <code><a href="#@cdktn/provider-aws.oamSink.OamSinkConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/oam_sink#tags_all OamSink#tags_all}. |
