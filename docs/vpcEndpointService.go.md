...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/vpcendpointservice"
...
&vpcendpointservice.VpcEndpointServiceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.vpcEndpointService.VpcEndpointServiceTimeouts,
}
```
