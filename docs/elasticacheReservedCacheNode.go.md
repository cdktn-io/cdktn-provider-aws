...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/elasticachereservedcachenode"
...
&elasticachereservedcachenode.ElasticacheReservedCacheNodeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.elasticacheReservedCacheNode.ElasticacheReservedCacheNodeTimeouts,
}
```
