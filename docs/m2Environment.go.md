...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/m2environment"
...
&m2environment.M2EnvironmentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.m2Environment.M2EnvironmentTimeouts,
}
```
