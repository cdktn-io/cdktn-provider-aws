...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsnetworkinterfaces"
...
&dataawsnetworkinterfaces.DataAwsNetworkInterfacesConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsNetworkInterfaces.DataAwsNetworkInterfacesTimeouts,
}
```
