...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/datazoneformtype"
...
&datazoneformtype.DatazoneFormTypeConfig {
	...
	Region: *string,
	Status: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.datazoneFormType.DatazoneFormTypeTimeouts,
}
```
