...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/sesdomainidentityverification"
...
| <code><a href="#@cdktf/provider-aws.sesDomainIdentityVerification.SesDomainIdentityVerification.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&sesdomainidentityverification.SesDomainIdentityVerificationConfig {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.sesDomainIdentityVerification.SesDomainIdentityVerificationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.sesDomainIdentityVerification.SesDomainIdentityVerificationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
