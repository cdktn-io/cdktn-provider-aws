...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.dataSetId">data_set_id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#data_set_id DataexchangeRevision#data_set_id}. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.comment">comment</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#comment DataexchangeRevision#comment}. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#id DataexchangeRevision#id}. |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.tags">tags</a></code> | <code>typing.Mapping[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#tags DataexchangeRevision#tags}. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.Initializer.parameter.tagsAll">tags_all</a></code> | <code>typing.Mapping[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#tags_all DataexchangeRevision#tags_all}. |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.addMoveTarget">add_move_target</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.hasResourceMove">has_resource_move</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.importFrom">import_from</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveFromId">move_from_id</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveTo">move_to</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveToId">move_to_id</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.resetRegion">reset_region</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.toHclTerraform"></a>
...
##### `add_move_target` <a name="add_move_target" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.addMoveTarget"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.addMoveTarget.parameter.moveTarget"></a>
...
##### `has_resource_move` <a name="has_resource_move" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.hasResourceMove"></a>

```python
def has_resource_move() -> TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `import_from` <a name="import_from" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.importFrom"></a>
...
##### `move_from_id` <a name="move_from_id" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveFromId"></a>
...
##### `move_to` <a name="move_to" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveTo"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveTo.parameter.moveTarget"></a>
...
##### `move_to_id` <a name="move_to_id" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.moveToId"></a>
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a DataexchangeRevision resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.generateConfigForImport"></a>
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.property.region">region</a></code> | <code>str</code> | *No description.* |
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevision.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevisionConfig.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevisionConfig.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevisionConfig.property.comment">comment</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#comment DataexchangeRevision#comment}. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevisionConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#id DataexchangeRevision#id}. |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevisionConfig.property.region">region</a></code> | <code>str</code> | Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference). |
| <code><a href="#@cdktf/provider-aws.dataexchangeRevision.DataexchangeRevisionConfig.property.tags">tags</a></code> | <code>typing.Mapping[str]</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/dataexchange_revision#tags DataexchangeRevision#tags}. |
