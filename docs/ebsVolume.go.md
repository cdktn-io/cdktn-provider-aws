...
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.encrypted">Encrypted</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#encrypted EbsVolume#encrypted}. |
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.finalSnapshot">FinalSnapshot</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#final_snapshot EbsVolume#final_snapshot}. |
...
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.iops">Iops</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#iops EbsVolume#iops}. |
...
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.multiAttachEnabled">MultiAttachEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#multi_attach_enabled EbsVolume#multi_attach_enabled}. |
...
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.size">Size</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#size EbsVolume#size}. |
...
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#tags EbsVolume#tags}. |
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#tags_all EbsVolume#tags_all}. |
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.throughput">Throughput</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#throughput EbsVolume#throughput}. |
...
| <code><a href="#@cdktn/provider-aws.ebsVolume.EbsVolumeConfig.property.volumeInitializationRate">VolumeInitializationRate</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ebs_volume#volume_initialization_rate EbsVolume#volume_initialization_rate}. |
