...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/vpcrouteserverpropagation"
...
&vpcrouteserverpropagation.VpcRouteServerPropagationConfig {
	...
	RouteTableId: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.vpcRouteServerPropagation.VpcRouteServerPropagationTimeouts,
}
```
