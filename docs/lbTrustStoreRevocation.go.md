...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/lbtruststorerevocation"
...
&lbtruststorerevocation.LbTrustStoreRevocationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.lbTrustStoreRevocation.LbTrustStoreRevocationTimeouts,
}
```
