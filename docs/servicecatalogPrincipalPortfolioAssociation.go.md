...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/servicecatalogprincipalportfolioassociation"
...
| <code><a href="#@cdktf/provider-aws.servicecatalogPrincipalPortfolioAssociation.ServicecatalogPrincipalPortfolioAssociation.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&servicecatalogprincipalportfolioassociation.ServicecatalogPrincipalPortfolioAssociationConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.servicecatalogPrincipalPortfolioAssociation.ServicecatalogPrincipalPortfolioAssociationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.servicecatalogPrincipalPortfolioAssociation.ServicecatalogPrincipalPortfolioAssociationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
