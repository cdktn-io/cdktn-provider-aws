...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/redshiftintegration"
...
&redshiftintegration.RedshiftIntegrationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.redshiftIntegration.RedshiftIntegrationTimeouts,
}
```
