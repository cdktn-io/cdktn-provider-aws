...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/kendrafaq"
...
| <code><a href="#@cdktf/provider-aws.kendraFaq.KendraFaq.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&kendrafaq.KendraFaqConfig {
	...
	Name: *string,
	RoleArn: *string,
	S3Path: github.com/cdktf/cdktf-provider-aws-go/aws/v21.kendraFaq.KendraFaqS3Path,
	Description: *string,
	FileFormat: *string,
	Id: *string,
	LanguageCode: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.kendraFaq.KendraFaqTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.kendraFaq.KendraFaqConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.kendraFaq.KendraFaqConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/kendra_faq#tags KendraFaq#tags}. |
| <code><a href="#@cdktf/provider-aws.kendraFaq.KendraFaqConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/kendra_faq#tags_all KendraFaq#tags_all}. |
