...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsconnectinstance"
...
| <code><a href="#@cdktn/provider-aws.dataAwsConnectInstance.DataAwsConnectInstanceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/connect_instance#tags DataAwsConnectInstance#tags}. |
