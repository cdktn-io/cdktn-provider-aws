...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/bedrockagentcorebrowser"
...
&bedrockagentcorebrowser.BedrockagentcoreBrowserConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.bedrockagentcoreBrowser.BedrockagentcoreBrowserTimeouts,
}
```
