...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/neptuneclusterinstance"
...
&neptuneclusterinstance.NeptuneClusterInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.neptuneClusterInstance.NeptuneClusterInstanceTimeouts,
}
```
