...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/dataawselbhostedzoneid"
...
| <code><a href="#@cdktn/provider-aws.dataAwsElbHostedZoneId.DataAwsElbHostedZoneIdConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/elb_hosted_zone_id#id DataAwsElbHostedZoneId#id}. |
