...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawselbhostedzoneid"
...
| <code><a href="#@cdktn/provider-aws.dataAwsElbHostedZoneId.DataAwsElbHostedZoneIdConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/data-sources/elb_hosted_zone_id#id DataAwsElbHostedZoneId#id}. |
