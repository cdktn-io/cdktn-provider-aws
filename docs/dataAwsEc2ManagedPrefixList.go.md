...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2managedprefixlist"
...
&dataawsec2managedprefixlist.DataAwsEc2ManagedPrefixListConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2ManagedPrefixList.DataAwsEc2ManagedPrefixListTimeouts,
}
```
