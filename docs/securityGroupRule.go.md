...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/securitygrouprule"
...
&securitygrouprule.SecurityGroupRuleConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.securityGroupRule.SecurityGroupRuleTimeouts,
}
```
