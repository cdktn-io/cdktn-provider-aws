...
| <code><a href="#@cdktn/provider-aws.dataAwsElb.DataAwsElbConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/data-sources/elb#tags DataAwsElb#tags}. |
