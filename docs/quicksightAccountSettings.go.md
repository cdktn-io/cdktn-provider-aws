...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/quicksightaccountsettings"
...
&quicksightaccountsettings.QuicksightAccountSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.quicksightAccountSettings.QuicksightAccountSettingsTimeouts,
}
```
