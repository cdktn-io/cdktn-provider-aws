...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/securitygroup"
...
&securitygroup.SecurityGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.securityGroup.SecurityGroupTimeouts,
	VpcId: *string,
}
```
