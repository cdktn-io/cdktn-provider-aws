...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/securitygroup"
...
&securitygroup.SecurityGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.securityGroup.SecurityGroupTimeouts,
	VpcId: *string,
}
```
