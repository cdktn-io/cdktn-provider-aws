...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dbclustersnapshot"
...
&dbclustersnapshot.DbClusterSnapshotConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dbClusterSnapshot.DbClusterSnapshotTimeouts,
}
```
