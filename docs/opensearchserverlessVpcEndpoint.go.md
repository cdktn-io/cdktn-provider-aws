...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/opensearchserverlessvpcendpoint"
...
&opensearchserverlessvpcendpoint.OpensearchserverlessVpcEndpointConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v22.opensearchserverlessVpcEndpoint.OpensearchserverlessVpcEndpointTimeouts,
}
```
