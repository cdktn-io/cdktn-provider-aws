...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/route53vpcassociationauthorization"
...
&route53vpcassociationauthorization.Route53VpcAssociationAuthorizationConfig {
	...
	ZoneId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.route53VpcAssociationAuthorization.Route53VpcAssociationAuthorizationTimeouts,
	VpcRegion: *string,
}
```
