...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/transcribemedicalvocabulary"
...
&transcribemedicalvocabulary.TranscribeMedicalVocabularyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.transcribeMedicalVocabulary.TranscribeMedicalVocabularyTimeouts,
}
```
