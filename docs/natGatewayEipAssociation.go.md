...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/natgatewayeipassociation"
...
&natgatewayeipassociation.NatGatewayEipAssociationConfig {
	...
	NatGatewayId: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.natGatewayEipAssociation.NatGatewayEipAssociationTimeouts,
}
```
