...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/configorganizationcustompolicyrule"
...
&configorganizationcustompolicyrule.ConfigOrganizationCustomPolicyRuleConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v25.configOrganizationCustomPolicyRule.ConfigOrganizationCustomPolicyRuleTimeouts,
}
```
