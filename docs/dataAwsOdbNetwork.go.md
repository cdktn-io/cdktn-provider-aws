...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsodbnetwork"
...
| <code><a href="#@cdktn/provider-aws.dataAwsOdbNetwork.DataAwsOdbNetworkConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/odb_network#id DataAwsOdbNetwork#id}. |
