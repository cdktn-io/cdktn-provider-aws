...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawssubnet"
...
&dataawssubnet.DataAwsSubnetConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v24.dataAwsSubnet.DataAwsSubnetTimeouts,
	VpcId: *string,
}
```
