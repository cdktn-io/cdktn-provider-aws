...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawssubnet"
...
&dataawssubnet.DataAwsSubnetConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsSubnet.DataAwsSubnetTimeouts,
	VpcId: *string,
}
```
