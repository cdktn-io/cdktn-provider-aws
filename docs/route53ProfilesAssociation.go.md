...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/route53profilesassociation"
...
&route53profilesassociation.Route53ProfilesAssociationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.route53ProfilesAssociation.Route53ProfilesAssociationTimeouts,
}
```
