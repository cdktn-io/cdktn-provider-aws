...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsconnectbotassociation"
...
| <code><a href="#@cdktf/provider-aws.dataAwsConnectBotAssociation.DataAwsConnectBotAssociation.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dataawsconnectbotassociation.DataAwsConnectBotAssociationConfig {
	...
	InstanceId: *string,
	LexBot: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dataAwsConnectBotAssociation.DataAwsConnectBotAssociationLexBot,
	Id: *string,
	Region: *string,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsConnectBotAssociation.DataAwsConnectBotAssociationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
