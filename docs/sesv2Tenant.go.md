...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/sesv2tenant"
...
| <code><a href="#@cdktn/provider-aws.sesv2Tenant.Sesv2TenantConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/sesv2_tenant#tags Sesv2Tenant#tags}. |
