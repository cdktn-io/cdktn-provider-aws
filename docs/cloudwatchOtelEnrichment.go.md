...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/cloudwatchotelenrichment"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/cloudwatch_otel_enrichment#import import section} in the documentation of this resource for the id to use
...
&cloudwatchotelenrichment.CloudwatchOtelEnrichmentConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v23.cloudwatchOtelEnrichment.CloudwatchOtelEnrichmentTimeouts,
}
```
