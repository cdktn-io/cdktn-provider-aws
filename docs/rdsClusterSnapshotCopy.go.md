...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/rdsclustersnapshotcopy"
...
&rdsclustersnapshotcopy.RdsClusterSnapshotCopyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.rdsClusterSnapshotCopy.RdsClusterSnapshotCopyTimeouts,
}
```
