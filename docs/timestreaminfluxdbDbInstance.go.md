...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/timestreaminfluxdbdbinstance"
...
&timestreaminfluxdbdbinstance.TimestreaminfluxdbDbInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v23.timestreaminfluxdbDbInstance.TimestreaminfluxdbDbInstanceTimeouts,
}
```
