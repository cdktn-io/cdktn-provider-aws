...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsalblistener"
...
&dataawsalblistener.DataAwsAlbListenerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsAlbListener.DataAwsAlbListenerTimeouts,
}
```
