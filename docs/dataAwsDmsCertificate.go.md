...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsdmscertificate"
...
| <code><a href="#@cdktn/provider-aws.dataAwsDmsCertificate.DataAwsDmsCertificateConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/dms_certificate#tags DataAwsDmsCertificate#tags}. |
