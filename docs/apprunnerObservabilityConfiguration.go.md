...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/apprunnerobservabilityconfiguration"
...
&apprunnerobservabilityconfiguration.ApprunnerObservabilityConfigurationConfig {
	...
	TraceConfiguration: github.com/cdktn-io/cdktn-provider-aws-go/aws/v21.apprunnerObservabilityConfiguration.ApprunnerObservabilityConfigurationTraceConfiguration,
}
```
