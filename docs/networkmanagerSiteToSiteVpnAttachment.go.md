...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/networkmanagersitetositevpnattachment"
...
&networkmanagersitetositevpnattachment.NetworkmanagerSiteToSiteVpnAttachmentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.networkmanagerSiteToSiteVpnAttachment.NetworkmanagerSiteToSiteVpnAttachmentTimeouts,
}
```
