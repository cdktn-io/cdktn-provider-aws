...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/rdsinstancestate"
...
&rdsinstancestate.RdsInstanceStateConfig {
	...
	State: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.rdsInstanceState.RdsInstanceStateTimeouts,
}
```
