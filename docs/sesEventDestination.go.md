...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/seseventdestination"
...
| <code><a href="#@cdktf/provider-aws.sesEventDestination.SesEventDestination.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&seseventdestination.SesEventDestinationConfig {
	...
	Enabled: interface{},
	Id: *string,
	KinesisDestination: github.com/cdktf/cdktf-provider-aws-go/aws/v21.sesEventDestination.SesEventDestinationKinesisDestination,
	Region: *string,
	SnsDestination: github.com/cdktf/cdktf-provider-aws-go/aws/v21.sesEventDestination.SesEventDestinationSnsDestination,
}
```
...
| <code><a href="#@cdktf/provider-aws.sesEventDestination.SesEventDestinationConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.sesEventDestination.SesEventDestinationConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/ses_event_destination#enabled SesEventDestination#enabled}. |
