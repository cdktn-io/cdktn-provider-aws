...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/resiliencehubresiliencypolicy"
...
&resiliencehubresiliencypolicy.ResiliencehubResiliencyPolicyConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.resiliencehubResiliencyPolicy.ResiliencehubResiliencyPolicyTimeouts,
}
```
