...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2transitgatewayattachments"
...
&dataawsec2transitgatewayattachments.DataAwsEc2TransitGatewayAttachmentsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2TransitGatewayAttachments.DataAwsEc2TransitGatewayAttachmentsTimeouts,
}
```
