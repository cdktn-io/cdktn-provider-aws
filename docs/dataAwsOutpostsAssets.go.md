...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsoutpostsassets"
...
| <code><a href="#@cdktf/provider-aws.dataAwsOutpostsAssets.DataAwsOutpostsAssets.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsOutpostsAssets.DataAwsOutpostsAssetsConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
