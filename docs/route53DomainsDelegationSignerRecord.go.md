...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/route53domainsdelegationsignerrecord"
...
&route53domainsdelegationsignerrecord.Route53DomainsDelegationSignerRecordConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.route53DomainsDelegationSignerRecord.Route53DomainsDelegationSignerRecordTimeouts,
}
```
