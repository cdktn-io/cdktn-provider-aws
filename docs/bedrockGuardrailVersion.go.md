...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/bedrockguardrailversion"
...
&bedrockguardrailversion.BedrockGuardrailVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.bedrockGuardrailVersion.BedrockGuardrailVersionTimeouts,
}
```
