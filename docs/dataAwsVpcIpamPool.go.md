...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsvpcipampool"
...
&dataawsvpcipampool.DataAwsVpcIpamPoolConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsVpcIpamPool.DataAwsVpcIpamPoolTimeouts,
}
```
