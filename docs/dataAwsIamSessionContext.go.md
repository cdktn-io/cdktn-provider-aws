...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsiamsessioncontext"
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.toHclTerraform">ToHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.toHclTerraform"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a DataAwsIamSessionContext resource upon running "cdktf plan <stack-name>". |
...
###### `scope`<sup>Required</sup> <a name="scope" id="@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.generateConfigForImport.parameter.scope"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.generateConfigForImport.parameter.importFromId"></a>

- *Type:* *string

The id of the existing DataAwsIamSessionContext that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/iam_session_context#import import section} in the documentation of this resource for the id to use

---

###### `provider`<sup>Optional</sup> <a name="provider" id="@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContext.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContextConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContextConfig.property.arn">Arn</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/iam_session_context#arn DataAwsIamSessionContext#arn}. |
| <code><a href="#@cdktf/provider-aws.dataAwsIamSessionContext.DataAwsIamSessionContextConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/iam_session_context#id DataAwsIamSessionContext#id}. |
