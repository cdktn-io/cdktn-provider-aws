...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v21/finspacekxdatabase"
...
&finspacekxdatabase.FinspaceKxDatabaseConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v21.finspaceKxDatabase.FinspaceKxDatabaseTimeouts,
}
```
