...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/iotbillinggroup"
...
| <code><a href="#@cdktn/provider-aws.iotBillingGroup.IotBillingGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/iot_billing_group#tags IotBillingGroup#tags}. |
