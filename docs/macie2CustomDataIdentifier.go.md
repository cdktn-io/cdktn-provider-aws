...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/macie2customdataidentifier"
...
&macie2customdataidentifier.Macie2CustomDataIdentifierConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.macie2CustomDataIdentifier.Macie2CustomDataIdentifierTimeouts,
}
```
