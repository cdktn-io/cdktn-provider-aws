...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/transferhostkey"
...
| <code><a href="#@cdktn/provider-aws.transferHostKey.TransferHostKeyConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/transfer_host_key#tags TransferHostKey#tags}. |
