...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsebsvolume"
...
&dataawsebsvolume.DataAwsEbsVolumeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEbsVolume.DataAwsEbsVolumeTimeouts,
}
```
