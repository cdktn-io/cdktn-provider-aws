...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/dsqlclusterpeering"
...
&dsqlclusterpeering.DsqlClusterPeeringConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.dsqlClusterPeering.DsqlClusterPeeringTimeouts,
}
```
