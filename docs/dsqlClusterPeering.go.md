...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dsqlclusterpeering"
...
&dsqlclusterpeering.DsqlClusterPeeringConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dsqlClusterPeering.DsqlClusterPeeringTimeouts,
}
```
