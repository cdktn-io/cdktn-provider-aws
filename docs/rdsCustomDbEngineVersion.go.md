...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/rdscustomdbengineversion"
...
&rdscustomdbengineversion.RdsCustomDbEngineVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.rdsCustomDbEngineVersion.RdsCustomDbEngineVersionTimeouts,
}
```
