...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/rdscustomdbengineversion"
...
&rdscustomdbengineversion.RdsCustomDbEngineVersionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.rdsCustomDbEngineVersion.RdsCustomDbEngineVersionTimeouts,
}
```
