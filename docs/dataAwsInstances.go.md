...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsinstances"
...
| <code><a href="#@cdktf/provider-aws.dataAwsInstances.DataAwsInstances.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dataawsinstances.DataAwsInstancesConfig {
	...
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.dataAwsInstances.DataAwsInstancesTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.dataAwsInstances.DataAwsInstancesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsInstances.DataAwsInstancesConfig.property.instanceTags">InstanceTags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/instances#instance_tags DataAwsInstances#instance_tags}. |
