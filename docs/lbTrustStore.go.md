...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/lbtruststore"
...
&lbtruststore.LbTrustStoreConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.lbTrustStore.LbTrustStoreTimeouts,
}
```
