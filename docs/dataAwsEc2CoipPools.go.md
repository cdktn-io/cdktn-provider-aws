...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dataawsec2coippools"
...
&dataawsec2coippools.DataAwsEc2CoipPoolsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dataAwsEc2CoipPools.DataAwsEc2CoipPoolsTimeouts,
}
```
