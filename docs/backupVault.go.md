...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/backupvault"
...
&backupvault.BackupVaultConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.backupVault.BackupVaultTimeouts,
}
```
