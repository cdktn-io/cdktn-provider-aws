...
| <code><a href="#@cdktn/provider-aws.dataAwsMskVpcConnection.DataAwsMskVpcConnectionConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/msk_vpc_connection#tags DataAwsMskVpcConnection#tags}. |
