...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/finspacekxdataview"
...
&finspacekxdataview.FinspaceKxDataviewConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.finspaceKxDataview.FinspaceKxDataviewTimeouts,
}
```
