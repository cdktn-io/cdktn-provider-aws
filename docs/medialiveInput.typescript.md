...
| <code><a href="#@cdktn/provider-aws.medialiveInput.MedialiveInputConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/medialive_input#tags MedialiveInput#tags}. |
| <code><a href="#@cdktn/provider-aws.medialiveInput.MedialiveInputConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/medialive_input#tags_all MedialiveInput#tags_all}. |
