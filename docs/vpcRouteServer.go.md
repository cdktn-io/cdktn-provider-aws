...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/vpcrouteserver"
...
&vpcrouteserver.VpcRouteServerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.vpcRouteServer.VpcRouteServerTimeouts,
}
```
