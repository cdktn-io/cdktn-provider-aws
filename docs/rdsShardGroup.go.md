...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/rdsshardgroup"
...
&rdsshardgroup.RdsShardGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.rdsShardGroup.RdsShardGroupTimeouts,
}
```
