...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/locationmap"
...
| <code><a href="#@cdktf/provider-aws.locationMap.LocationMap.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&locationmap.LocationMapConfig {
	...
	Configuration: github.com/cdktf/cdktf-provider-aws-go/aws/v21.locationMap.LocationMapConfiguration,
	MapName: *string,
	Description: *string,
	Id: *string,
	Region: *string,
...
| <code><a href="#@cdktf/provider-aws.locationMap.LocationMapConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.locationMap.LocationMapConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/location_map#tags LocationMap#tags}. |
| <code><a href="#@cdktf/provider-aws.locationMap.LocationMapConfig.property.tagsAll">TagsAll</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/location_map#tags_all LocationMap#tags_all}. |
