...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/redshifteventsubscription"
...
&redshifteventsubscription.RedshiftEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.redshiftEventSubscription.RedshiftEventSubscriptionTimeouts,
}
```
