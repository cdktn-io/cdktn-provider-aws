...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/cloudsearchdomainserviceaccesspolicy"
...
| <code><a href="#@cdktf/provider-aws.cloudsearchDomainServiceAccessPolicy.CloudsearchDomainServiceAccessPolicy.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&cloudsearchdomainserviceaccesspolicy.CloudsearchDomainServiceAccessPolicyConfig {
	...
	Id: *string,
	Region: *string,
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws/v21.cloudsearchDomainServiceAccessPolicy.CloudsearchDomainServiceAccessPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-aws.cloudsearchDomainServiceAccessPolicy.CloudsearchDomainServiceAccessPolicyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
