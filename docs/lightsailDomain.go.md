...
| <code><a href="#@cdktf/provider-aws.lightsailDomain.LightsailDomain.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.lightsailDomain.LightsailDomain.hasResourceMove">HasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.lightsailDomain.LightsailDomain.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.lightsailDomain.LightsailDomain.toHclTerraform"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-aws.lightsailDomain.LightsailDomain.hasResourceMove"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-aws.lightsailDomain.LightsailDomain.moveFromId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.lightsailDomain.LightsailDomain.moveFromId.parameter.id"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-aws.lightsailDomain.LightsailDomain.moveToId"></a>
...
###### `id`<sup>Required</sup> <a name="id" id="@cdktf/provider-aws.lightsailDomain.LightsailDomain.moveToId.parameter.id"></a>
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/lightsail_domain#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.lightsailDomain.LightsailDomainConfig.property.domainName">DomainName</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/lightsail_domain#domain_name LightsailDomain#domain_name}. |
| <code><a href="#@cdktf/provider-aws.lightsailDomain.LightsailDomainConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/lightsail_domain#id LightsailDomain#id}. |
