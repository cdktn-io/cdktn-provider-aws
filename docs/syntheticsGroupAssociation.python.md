...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.Initializer.parameter.connection">connection</a></code> | <code>cdktf.SSHProvisionerConnection \| cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.Initializer.parameter.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.Initializer.parameter.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.Initializer.parameter.canaryArn">canary_arn</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/synthetics_group_association#canary_arn SyntheticsGroupAssociation#canary_arn}. |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.Initializer.parameter.groupName">group_name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/synthetics_group_association#group_name SyntheticsGroupAssociation#group_name}. |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/synthetics_group_association#id SyntheticsGroupAssociation#id}. |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.addMoveTarget">add_move_target</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.hasResourceMove">has_resource_move</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.importFrom">import_from</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveFromId">move_from_id</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveTo">move_to</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveToId">move_to_id</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.resetRegion">reset_region</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.toHclTerraform"></a>
...
##### `add_move_target` <a name="add_move_target" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.addMoveTarget"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.addMoveTarget.parameter.moveTarget"></a>
...
##### `has_resource_move` <a name="has_resource_move" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.hasResourceMove"></a>

```python
def has_resource_move() -> TerraformResourceMoveByTarget | TerraformResourceMoveById
```

##### `import_from` <a name="import_from" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.importFrom"></a>
...
##### `move_from_id` <a name="move_from_id" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveFromId"></a>
...
##### `move_to` <a name="move_to" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveTo"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveTo.parameter.moveTarget"></a>
...
##### `move_to_id` <a name="move_to_id" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.moveToId"></a>
...
##### `reset_region` <a name="reset_region" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTF code for importing a SyntheticsGroupAssociation resource upon running "cdktf plan <stack-name>". |
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.generateConfigForImport"></a>
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.property.regionInput">region_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.property.region">region</a></code> | <code>str</code> | *No description.* |
...
##### `region_input`<sup>Optional</sup> <a name="region_input" id="@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociation.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociationConfig.property.count">count</a></code> | <code>typing.Union[int, float] \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociationConfig.property.provisioners">provisioners</a></code> | <code>typing.List[cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.syntheticsGroupAssociation.SyntheticsGroupAssociationConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/synthetics_group_association#id SyntheticsGroupAssociation#id}. |
