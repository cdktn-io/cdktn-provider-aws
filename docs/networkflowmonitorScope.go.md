...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/networkflowmonitorscope"
...
&networkflowmonitorscope.NetworkflowmonitorScopeConfig {
	...
	Target: interface{},
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.networkflowmonitorScope.NetworkflowmonitorScopeTimeouts,
}
```
