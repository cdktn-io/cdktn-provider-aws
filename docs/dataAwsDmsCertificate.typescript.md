...
| <code><a href="#@cdktn/provider-aws.dataAwsDmsCertificate.DataAwsDmsCertificateConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/dms_certificate#tags DataAwsDmsCertificate#tags}. |
