...
| <code><a href="#@cdktn/provider-aws.dataAwsSnsTopic.DataAwsSnsTopicConfig.property.name">name</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/sns_topic#name DataAwsSnsTopic#name}. |
| <code><a href="#@cdktn/provider-aws.dataAwsSnsTopic.DataAwsSnsTopicConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/sns_topic#id DataAwsSnsTopic#id}. |
...
| <code><a href="#@cdktn/provider-aws.dataAwsSnsTopic.DataAwsSnsTopicConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/sns_topic#tags DataAwsSnsTopic#tags}. |
