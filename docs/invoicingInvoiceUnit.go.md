...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/invoicinginvoiceunit"
...
&invoicinginvoiceunit.InvoicingInvoiceUnitConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.invoicingInvoiceUnit.InvoicingInvoiceUnitTimeouts,
}
```
