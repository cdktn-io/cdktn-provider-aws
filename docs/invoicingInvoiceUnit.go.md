...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/invoicinginvoiceunit"
...
&invoicinginvoiceunit.InvoicingInvoiceUnitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-aws-go/aws.invoicingInvoiceUnit.InvoicingInvoiceUnitTimeouts,
}
```
