...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/docdbeventsubscription"
...
&docdbeventsubscription.DocdbEventSubscriptionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.docdbEventSubscription.DocdbEventSubscriptionTimeouts,
}
```
