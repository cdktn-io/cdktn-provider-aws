...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/vpcrouteserverpeer"
...
&vpcrouteserverpeer.VpcRouteServerPeerConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.vpcRouteServerPeer.VpcRouteServerPeerTimeouts,
}
```
