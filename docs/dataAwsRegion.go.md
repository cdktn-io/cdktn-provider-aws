...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsregion"
...
| <code><a href="#@cdktf/provider-aws.dataAwsRegion.DataAwsRegion.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsRegion.DataAwsRegionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
