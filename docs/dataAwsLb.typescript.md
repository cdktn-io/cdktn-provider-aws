...
| <code><a href="#@cdktn/provider-aws.dataAwsLb.DataAwsLbConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/lb#tags DataAwsLb#tags}. |
