...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/sns_topic_policy#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.snsTopicPolicy.SnsTopicPolicyConfig.property.arn">arn</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/sns_topic_policy#arn SnsTopicPolicy#arn}. |
| <code><a href="#@cdktf/provider-aws.snsTopicPolicy.SnsTopicPolicyConfig.property.policy">policy</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/sns_topic_policy#policy SnsTopicPolicy#policy}. |
| <code><a href="#@cdktf/provider-aws.snsTopicPolicy.SnsTopicPolicyConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/sns_topic_policy#id SnsTopicPolicy#id}. |
