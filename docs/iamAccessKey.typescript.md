...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key aws_iam_access_key}.
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-aws.iamAccessKey.IamAccessKeyConfig.property.user">user</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#user IamAccessKey#user}. |
| <code><a href="#@cdktf/provider-aws.iamAccessKey.IamAccessKeyConfig.property.id">id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#id IamAccessKey#id}. |
| <code><a href="#@cdktf/provider-aws.iamAccessKey.IamAccessKeyConfig.property.pgpKey">pgpKey</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#pgp_key IamAccessKey#pgp_key}. |
| <code><a href="#@cdktf/provider-aws.iamAccessKey.IamAccessKeyConfig.property.status">status</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#status IamAccessKey#status}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#user IamAccessKey#user}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#id IamAccessKey#id}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#pgp_key IamAccessKey#pgp_key}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_access_key#status IamAccessKey#status}.
