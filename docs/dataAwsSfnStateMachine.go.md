...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawssfnstatemachine"
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.toHclTerraform">ToHclTerraform</a></code> | Adds this resource to the terraform JSON output. |
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.resetRegion">ResetRegion</a></code> | *No description.* |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.toHclTerraform"></a>
...
##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.resetRegion"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a DataAwsSfnStateMachine resource upon running "cdktf plan <stack-name>". |
...
##### `GenerateConfigForImport` <a name="GenerateConfigForImport" id="@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.generateConfigForImport"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.property.description">Description</a></code> | <code>*string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.property.revisionId">RevisionId</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.property.regionInput">RegionInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.property.region">Region</a></code> | <code>*string</code> | *No description.* |
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachine.property.regionInput"></a>
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachineConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachineConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/sfn_state_machine#name DataAwsSfnStateMachine#name}. |
| <code><a href="#@cdktf/provider-aws.dataAwsSfnStateMachine.DataAwsSfnStateMachineConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/sfn_state_machine#id DataAwsSfnStateMachine#id}. |
