...
| <code><a href="#@cdktn/provider-aws.fsxBackup.FsxBackupConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/fsx_backup#tags FsxBackup#tags}. |
| <code><a href="#@cdktn/provider-aws.fsxBackup.FsxBackupConfig.property.tagsAll">tagsAll</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/fsx_backup#tags_all FsxBackup#tags_all}. |
