...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v24/dataawsebsvolumes"
...
&dataawsebsvolumes.DataAwsEbsVolumesConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v24.dataAwsEbsVolumes.DataAwsEbsVolumesTimeouts,
}
```
...
| <code><a href="#@cdktn/provider-aws.dataAwsEbsVolumes.DataAwsEbsVolumesConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/data-sources/ebs_volumes#tags DataAwsEbsVolumes#tags}. |
