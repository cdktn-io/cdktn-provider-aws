...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/kinesisvideostream"
...
&kinesisvideostream.KinesisVideoStreamConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.kinesisVideoStream.KinesisVideoStreamTimeouts,
}
```
