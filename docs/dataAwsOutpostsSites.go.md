...
```go
import "github.com/cdktf/cdktf-provider-aws-go/aws/v21/dataawsoutpostssites"
...
| <code><a href="#@cdktf/provider-aws.dataAwsOutpostsSites.DataAwsOutpostsSites.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsOutpostsSites.DataAwsOutpostsSitesConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.dataAwsOutpostsSites.DataAwsOutpostsSitesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/outposts_sites#id DataAwsOutpostsSites#id}. |
