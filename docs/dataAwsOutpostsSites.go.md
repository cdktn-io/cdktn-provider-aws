...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsoutpostssites"
...
| <code><a href="#@cdktn/provider-aws.dataAwsOutpostsSites.DataAwsOutpostsSitesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/outposts_sites#id DataAwsOutpostsSites#id}. |
