...
Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam aws_vpc_ipam}.
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.importFrom">ImportFrom</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.interpolationForAttribute">InterpolationForAttribute</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.resetEnablePrivateGua">ResetEnablePrivateGua</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.resetId">ResetId</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.resetMeteredAccount">ResetMeteredAccount</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.resetRegion">ResetRegion</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.resetTier">ResetTier</a></code> | *No description.* |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-aws.vpcIpam.VpcIpam.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-aws.vpcIpam.VpcIpam.addMoveTarget"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-aws.vpcIpam.VpcIpam.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-aws.vpcIpam.VpcIpam.hasResourceMove"></a>

```csharp
private TerraformResourceMoveByTarget|TerraformResourceMoveById HasResourceMove()
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-aws.vpcIpam.VpcIpam.importFrom"></a>

```csharp
private void ImportFrom(string Id, TerraformProvider Provider = null)
```

###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-aws.vpcIpam.VpcIpam.importFrom.parameter.id"></a>

- *Type:* string

---

###### `Provider`<sup>Optional</sup> <a name="Provider" id="@cdktf/provider-aws.vpcIpam.VpcIpam.importFrom.parameter.provider"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveFromId"></a>
...
###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveFromId.parameter.id"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveTo"></a>
...
###### `MoveTarget`<sup>Required</sup> <a name="MoveTarget" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveTo.parameter.moveTarget"></a>
...
###### `Index`<sup>Optional</sup> <a name="Index" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveTo.parameter.index"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveToId"></a>
...
###### `Id`<sup>Required</sup> <a name="Id" id="@cdktf/provider-aws.vpcIpam.VpcIpam.moveToId.parameter.id"></a>
...
- *Type:* HashiCorp.Cdktf.IResolvable|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegions">VpcIpamOperatingRegions</a>[]
...
##### `ResetEnablePrivateGua` <a name="ResetEnablePrivateGua" id="@cdktf/provider-aws.vpcIpam.VpcIpam.resetEnablePrivateGua"></a>
...
##### `ResetMeteredAccount` <a name="ResetMeteredAccount" id="@cdktf/provider-aws.vpcIpam.VpcIpam.resetMeteredAccount"></a>

```csharp
private void ResetMeteredAccount()
```

##### `ResetRegion` <a name="ResetRegion" id="@cdktf/provider-aws.vpcIpam.VpcIpam.resetRegion"></a>
...
##### `ResetTier` <a name="ResetTier" id="@cdktf/provider-aws.vpcIpam.VpcIpam.resetTier"></a>
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a VpcIpam resource upon running "cdktf plan <stack-name>". |
...
##### `GenerateConfigForImport` <a name="GenerateConfigForImport" id="@cdktf/provider-aws.vpcIpam.VpcIpam.generateConfigForImport"></a>
...
###### `Scope`<sup>Required</sup> <a name="Scope" id="@cdktf/provider-aws.vpcIpam.VpcIpam.generateConfigForImport.parameter.scope"></a>
...
###### `ImportToId`<sup>Required</sup> <a name="ImportToId" id="@cdktf/provider-aws.vpcIpam.VpcIpam.generateConfigForImport.parameter.importToId"></a>
...
###### `ImportFromId`<sup>Required</sup> <a name="ImportFromId" id="@cdktf/provider-aws.vpcIpam.VpcIpam.generateConfigForImport.parameter.importFromId"></a>

- *Type:* string

The id of the existing VpcIpam that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#import import section} in the documentation of this resource for the id to use

---

###### `Provider`<sup>Optional</sup> <a name="Provider" id="@cdktf/provider-aws.vpcIpam.VpcIpam.generateConfigForImport.parameter.provider"></a>
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.connection">Connection</a></code> | <code>HashiCorp.Cdktf.SSHProvisionerConnection\|HashiCorp.Cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.count">Count</a></code> | <code>double\|HashiCorp.Cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.provisioners">Provisioners</a></code> | <code>HashiCorp.Cdktf.FileProvisioner\|HashiCorp.Cdktf.LocalExecProvisioner\|HashiCorp.Cdktf.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.cascadeInput">CascadeInput</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.enablePrivateGuaInput">EnablePrivateGuaInput</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.idInput">IdInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.meteredAccountInput">MeteredAccountInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.operatingRegionsInput">OperatingRegionsInput</a></code> | <code>HashiCorp.Cdktf.IResolvable\|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegions">VpcIpamOperatingRegions</a>[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.regionInput">RegionInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.tierInput">TierInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.timeoutsInput">TimeoutsInput</a></code> | <code>HashiCorp.Cdktf.IResolvable\|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeouts">VpcIpamTimeouts</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.cascade">Cascade</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.description">Description</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.enablePrivateGua">EnablePrivateGua</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.id">Id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.meteredAccount">MeteredAccount</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.region">Region</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpam.property.tier">Tier</a></code> | <code>string</code> | *No description.* |
...
##### `EnablePrivateGuaInput`<sup>Optional</sup> <a name="EnablePrivateGuaInput" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.enablePrivateGuaInput"></a>
...
##### `MeteredAccountInput`<sup>Optional</sup> <a name="MeteredAccountInput" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.meteredAccountInput"></a>
...
##### `RegionInput`<sup>Optional</sup> <a name="RegionInput" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.regionInput"></a>
...
##### `TierInput`<sup>Optional</sup> <a name="TierInput" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.tierInput"></a>
...
- *Type:* HashiCorp.Cdktf.IResolvable|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeouts">VpcIpamTimeouts</a>
...
##### `EnablePrivateGua`<sup>Required</sup> <a name="EnablePrivateGua" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.enablePrivateGua"></a>
...
##### `MeteredAccount`<sup>Required</sup> <a name="MeteredAccount" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.meteredAccount"></a>
...
##### `Region`<sup>Required</sup> <a name="Region" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.region"></a>
...
##### `Tier`<sup>Required</sup> <a name="Tier" id="@cdktf/provider-aws.vpcIpam.VpcIpam.property.tier"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.connection">Connection</a></code> | <code>HashiCorp.Cdktf.SSHProvisionerConnection\|HashiCorp.Cdktf.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.count">Count</a></code> | <code>double\|HashiCorp.Cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.provisioners">Provisioners</a></code> | <code>HashiCorp.Cdktf.FileProvisioner\|HashiCorp.Cdktf.LocalExecProvisioner\|HashiCorp.Cdktf.RemoteExecProvisioner[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.operatingRegions">OperatingRegions</a></code> | <code>HashiCorp.Cdktf.IResolvable\|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegions">VpcIpamOperatingRegions</a>[]</code> | operating_regions block. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.cascade">Cascade</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#cascade VpcIpam#cascade}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.description">Description</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#description VpcIpam#description}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.enablePrivateGua">EnablePrivateGua</a></code> | <code>bool\|HashiCorp.Cdktf.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#enable_private_gua VpcIpam#enable_private_gua}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#id VpcIpam#id}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.meteredAccount">MeteredAccount</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#metered_account VpcIpam#metered_account}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.region">Region</a></code> | <code>string</code> | Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference). |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.tags">Tags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#tags VpcIpam#tags}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.tagsAll">TagsAll</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#tags_all VpcIpam#tags_all}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.tier">Tier</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#tier VpcIpam#tier}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#operating_regions VpcIpam#operating_regions}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#cascade VpcIpam#cascade}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#description VpcIpam#description}.

---

##### `EnablePrivateGua`<sup>Optional</sup> <a name="EnablePrivateGua" id="@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.enablePrivateGua"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#enable_private_gua VpcIpam#enable_private_gua}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#id VpcIpam#id}.
...
##### `MeteredAccount`<sup>Optional</sup> <a name="MeteredAccount" id="@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.meteredAccount"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#metered_account VpcIpam#metered_account}.

---

##### `Region`<sup>Optional</sup> <a name="Region" id="@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.region"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#region VpcIpam#region}
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#tags VpcIpam#tags}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#tags_all VpcIpam#tags_all}.

---

##### `Tier`<sup>Optional</sup> <a name="Tier" id="@cdktf/provider-aws.vpcIpam.VpcIpamConfig.property.tier"></a>
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#tier VpcIpam#tier}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#timeouts VpcIpam#timeouts}
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegions.property.regionName">RegionName</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#region_name VpcIpam#region_name}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#region_name VpcIpam#region_name}.
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeouts.property.create">Create</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#create VpcIpam#create}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeouts.property.delete">Delete</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#delete VpcIpam#delete}. |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeouts.property.update">Update</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#update VpcIpam#update}. |
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#create VpcIpam#create}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#delete VpcIpam#delete}.
...
Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/vpc_ipam#update VpcIpam#update}.
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegionsList.allWithMapKey">AllWithMapKey</a></code> | Creating an iterator for this complex list. |
...
##### `AllWithMapKey` <a name="AllWithMapKey" id="@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegionsList.allWithMapKey"></a>
...
###### `MapKeyAttributeName`<sup>Required</sup> <a name="MapKeyAttributeName" id="@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegionsList.allWithMapKey.parameter.mapKeyAttributeName"></a>
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegionsList.property.internalValue">InternalValue</a></code> | <code>HashiCorp.Cdktf.IResolvable\|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegions">VpcIpamOperatingRegions</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegionsOutputReference.property.internalValue">InternalValue</a></code> | <code>HashiCorp.Cdktf.IResolvable\|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamOperatingRegions">VpcIpamOperatingRegions</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeoutsOutputReference.property.internalValue">InternalValue</a></code> | <code>HashiCorp.Cdktf.IResolvable\|<a href="#@cdktf/provider-aws.vpcIpam.VpcIpamTimeouts">VpcIpamTimeouts</a></code> | *No description.* |
