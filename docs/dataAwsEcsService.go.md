...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v23/dataawsecsservice"
...
| <code><a href="#@cdktn/provider-aws.dataAwsEcsService.DataAwsEcsServiceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/ecs_service#tags DataAwsEcsService#tags}. |
