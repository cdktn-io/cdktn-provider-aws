...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v22/shielddrtaccesslogbucketassociation"
...
&shielddrtaccesslogbucketassociation.ShieldDrtAccessLogBucketAssociationConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws/v22.shieldDrtAccessLogBucketAssociation.ShieldDrtAccessLogBucketAssociationTimeouts,
}
```
