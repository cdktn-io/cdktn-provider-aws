...
```java
import io.cdktn.providers.aws.data_aws_iam_outbound_web_identity_federation.DataAwsIamOutboundWebIdentityFederation;

DataAwsIamOutboundWebIdentityFederation.Builder.create(Construct scope, java.lang.String id)
...
| --- | --- | --- |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.scope">scope</a></code> | <code>software.constructs.Construct</code> | The scope in which to define this construct. |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.id">id</a></code> | <code>java.lang.String</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.provisioners">provisioners</a></code> | <code>java.util.List<io.cdktn.cdktn.FileProvisioner\|io.cdktn.cdktn.LocalExecProvisioner\|io.cdktn.cdktn.RemoteExecProvisioner></code> | *No description.* |
...
##### `dependsOn`<sup>Optional</sup> <a name="dependsOn" id="@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.dependsOn"></a>

- *Type:* java.util.List<io.cdktn.cdktn.ITerraformDependable>

---

##### `forEach`<sup>Optional</sup> <a name="forEach" id="@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.Initializer.parameter.forEach"></a>
...
DataAwsIamOutboundWebIdentityFederation.isConstruct(java.lang.Object x)
```
...
DataAwsIamOutboundWebIdentityFederation.isTerraformElement(java.lang.Object x)
```
...
DataAwsIamOutboundWebIdentityFederation.isTerraformDataSource(java.lang.Object x)
```
...
DataAwsIamOutboundWebIdentityFederation.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId),DataAwsIamOutboundWebIdentityFederation.generateConfigForImport(Construct scope, java.lang.String importToId, java.lang.String importFromId, TerraformProvider provider)
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.node">node</a></code> | <code>software.constructs.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.cdktfStack">cdktfStack</a></code> | <code>io.cdktn.cdktn.TerraformStack</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.fqn">fqn</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.friendlyUniqueId">friendlyUniqueId</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>java.util.Map<java.lang.String, java.lang.Object></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.terraformResourceType">terraformResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>io.cdktn.cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.dependsOn">dependsOn</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.issuerIdentifier">issuerIdentifier</a></code> | <code>java.lang.String</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederation.property.tfResourceType">tfResourceType</a></code> | <code>java.lang.String</code> | *No description.* |
...
```java
import io.cdktn.providers.aws.data_aws_iam_outbound_web_identity_federation.DataAwsIamOutboundWebIdentityFederationConfig;

DataAwsIamOutboundWebIdentityFederationConfig.builder()
//  .connection(SSHProvisionerConnection|WinrmProvisionerConnection)
//  .count(java.lang.Number|TerraformCount)
//  .dependsOn(java.util.List<ITerraformDependable>)
//  .forEach(ITerraformIterator)
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederationConfig.property.connection">connection</a></code> | <code>io.cdktn.cdktn.SSHProvisionerConnection\|io.cdktn.cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederationConfig.property.count">count</a></code> | <code>java.lang.Number\|io.cdktn.cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederationConfig.property.dependsOn">dependsOn</a></code> | <code>java.util.List<io.cdktn.cdktn.ITerraformDependable></code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederationConfig.property.forEach">forEach</a></code> | <code>io.cdktn.cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederationConfig.property.lifecycle">lifecycle</a></code> | <code>io.cdktn.cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-aws.dataAwsIamOutboundWebIdentityFederation.DataAwsIamOutboundWebIdentityFederationConfig.property.provider">provider</a></code> | <code>io.cdktn.cdktn.TerraformProvider</code> | *No description.* |
