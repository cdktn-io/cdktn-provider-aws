...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/dynamodbtablereplica"
...
&dynamodbtablereplica.DynamodbTableReplicaAConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.dynamodbTableReplica.DynamodbTableReplicaTimeouts,
}
```
