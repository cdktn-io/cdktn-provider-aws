...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/v25/dataawsdbinstances"
...
| <code><a href="#@cdktn/provider-aws.dataAwsDbInstances.DataAwsDbInstancesConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/db_instances#tags DataAwsDbInstances#tags}. |
