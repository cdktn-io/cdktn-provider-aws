...
```go
import "github.com/cdktn-io/cdktn-provider-aws-go/aws/eksfargateprofile"
...
&eksfargateprofile.EksFargateProfileConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-aws-go/aws.eksFargateProfile.EksFargateProfileTimeouts,
}
```
