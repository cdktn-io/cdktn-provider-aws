...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/elb_hosted_zone_id
...
export class DataAwsElbHostedZoneId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElbHostedZoneId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/elb_hosted_zone_id#import import section} in the documentation of this resource for the id to use
