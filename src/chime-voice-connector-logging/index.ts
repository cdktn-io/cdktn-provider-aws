...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/chime_voice_connector_logging
...
export class ChimeVoiceConnectorLogging extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimeVoiceConnectorLogging that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/chime_voice_connector_logging#import import section} in the documentation of this resource for the id to use
