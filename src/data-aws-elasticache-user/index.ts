...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/elasticache_user
...
export class DataAwsElasticacheUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticacheUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/elasticache_user#import import section} in the documentation of this resource for the id to use
