...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/elasticache_user
...
export class DataAwsElasticacheUser extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticacheUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/elasticache_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/elasticache_user aws_elasticache_user} Data Source
  *
  * @param scope The scope in which to define this construct
