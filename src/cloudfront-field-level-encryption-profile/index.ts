...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudfront_field_level_encryption_profile
...
export class CloudfrontFieldLevelEncryptionProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontFieldLevelEncryptionProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudfront_field_level_encryption_profile#import import section} in the documentation of this resource for the id to use
