...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshift_subnet_group
...
export class RedshiftSubnetGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftSubnetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshift_subnet_group#import import section} in the documentation of this resource for the id to use
