...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/globalaccelerator_endpoint_group
...
export class GlobalacceleratorEndpointGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalacceleratorEndpointGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/globalaccelerator_endpoint_group#import import section} in the documentation of this resource for the id to use
