...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/globalaccelerator_endpoint_group
...
export class GlobalacceleratorEndpointGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalacceleratorEndpointGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/globalaccelerator_endpoint_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/globalaccelerator_endpoint_group aws_globalaccelerator_endpoint_group} Resource
  *
  * @param scope The scope in which to define this construct
