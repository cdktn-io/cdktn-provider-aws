...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/verifiedaccess_instance
...
export class VerifiedaccessInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedaccessInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/verifiedaccess_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/verifiedaccess_instance aws_verifiedaccess_instance} Resource
  *
  * @param scope The scope in which to define this construct
