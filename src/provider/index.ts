...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs
...
export interface AwsProviderEndpoints {
  ...
  */
  readonly bedrockruntime?: string;
  /**
  * Use this to override the default service endpoint URL
  *
...
export function awsProviderEndpointsToTerraform(struct?: AwsProviderEndpoints | cdktn.IResolvable): any {
  ...
  return {
    ...
    bedrockruntime: cdktn.stringToTerraform(struct!.bedrockruntime),
...
export function awsProviderEndpointsToHclTerraform(struct?: AwsProviderEndpoints | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    bedrockruntime: {
      value: cdktn.stringToHclTerraform(struct!.bedrockruntime),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class AwsProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing AwsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs#import import section} in the documentation of this resource for the id to use
