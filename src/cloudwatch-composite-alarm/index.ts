...
// https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/cloudwatch_composite_alarm
...
export class CloudwatchCompositeAlarm extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchCompositeAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/cloudwatch_composite_alarm#import import section} in the documentation of this resource for the id to use
