...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_cluster
...
export class DataAwsRedshiftCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRedshiftCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_cluster aws_redshift_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
