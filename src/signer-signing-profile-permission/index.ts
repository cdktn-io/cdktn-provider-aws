...
// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/signer_signing_profile_permission
...
export class SignerSigningProfilePermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SignerSigningProfilePermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/signer_signing_profile_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/signer_signing_profile_permission aws_signer_signing_profile_permission} Resource
  *
  * @param scope The scope in which to define this construct
