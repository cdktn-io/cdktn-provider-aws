...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/resiliencehubv2_policy
...
export class Resiliencehubv2Policy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resiliencehubv2Policy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/resiliencehubv2_policy#import import section} in the documentation of this resource for the id to use
