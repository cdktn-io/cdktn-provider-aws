...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/elasticache_cluster
...
export class ElasticacheCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/elasticache_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/elasticache_cluster aws_elasticache_cluster} Resource
  *
  * @param scope The scope in which to define this construct
