...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/cognito_user_pool
...
export class CognitoUserPool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoUserPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/cognito_user_pool#import import section} in the documentation of this resource for the id to use
