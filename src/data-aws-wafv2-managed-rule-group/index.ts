...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/wafv2_managed_rule_group
...
export class DataAwsWafv2ManagedRuleGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafv2ManagedRuleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/wafv2_managed_rule_group#import import section} in the documentation of this resource for the id to use
