...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kms_key_policy
...
export class KmsKeyPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsKeyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kms_key_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kms_key_policy aws_kms_key_policy} Resource
  *
  * @param scope The scope in which to define this construct
