...
// https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/resources/api_gateway_integration
...
export class ApiGatewayIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/resources/api_gateway_integration#import import section} in the documentation of this resource for the id to use
