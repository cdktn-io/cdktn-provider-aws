...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/s3control_multi_region_access_point_routes
...
export class S3ControlMultiRegionAccessPointRoutes extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlMultiRegionAccessPointRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/s3control_multi_region_access_point_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/s3control_multi_region_access_point_routes aws_s3control_multi_region_access_point_routes} Resource
  *
  * @param scope The scope in which to define this construct
