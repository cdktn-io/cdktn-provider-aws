...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/rds_cluster
...
export class RdsCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/rds_cluster#import import section} in the documentation of this resource for the id to use
