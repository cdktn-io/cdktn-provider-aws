...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/rds_cluster
...
export interface RdsClusterConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly warningEventCategories?: string[];
  /**
...
export class RdsCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/rds_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: RdsClusterConfig) {
    ...
    this._warningEventCategories = config.warningEventCategories;
  ...
  */
  ...
  // warning_event_categories - computed: false, optional: true, required: false
  private _warningEventCategories?: string[]; 
  public get warningEventCategories() {
    return cdktn.Fn.tolist(this.getListAttribute('warning_event_categories'));
  }
  public set warningEventCategories(value: string[]) {
    this._warningEventCategories = value;
  }
  public resetWarningEventCategories() {
    this._warningEventCategories = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get warningEventCategoriesInput() {
    return this._warningEventCategories;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      warning_event_categories: cdktn.listMapper(cdktn.stringToTerraform, false)(this._warningEventCategories),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      warning_event_categories: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._warningEventCategories),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
