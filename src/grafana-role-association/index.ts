...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/grafana_role_association
...
export class GrafanaRoleAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaRoleAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/grafana_role_association#import import section} in the documentation of this resource for the id to use
