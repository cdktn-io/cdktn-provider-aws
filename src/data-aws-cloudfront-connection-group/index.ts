...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/cloudfront_connection_group
...
export class DataAwsCloudfrontConnectionGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudfrontConnectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/cloudfront_connection_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/cloudfront_connection_group aws_cloudfront_connection_group} Data Source
  *
  * @param scope The scope in which to define this construct
