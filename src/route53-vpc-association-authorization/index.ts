...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/route53_vpc_association_authorization
...
export class Route53VpcAssociationAuthorization extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53VpcAssociationAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/route53_vpc_association_authorization#import import section} in the documentation of this resource for the id to use
