...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/xray_resource_policy
...
export class XrayResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/xray_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/xray_resource_policy aws_xray_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
