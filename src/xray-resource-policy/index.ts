...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/xray_resource_policy
...
export class XrayResourcePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/xray_resource_policy#import import section} in the documentation of this resource for the id to use
