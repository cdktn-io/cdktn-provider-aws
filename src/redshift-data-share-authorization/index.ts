...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/redshift_data_share_authorization
...
export class RedshiftDataShareAuthorization extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftDataShareAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/redshift_data_share_authorization#import import section} in the documentation of this resource for the id to use
