...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/efs_backup_policy
...
export class EfsBackupPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EfsBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/efs_backup_policy#import import section} in the documentation of this resource for the id to use
