...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/chimesdkvoice_sip_rule
...
export class ChimesdkvoiceSipRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimesdkvoiceSipRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/chimesdkvoice_sip_rule#import import section} in the documentation of this resource for the id to use
