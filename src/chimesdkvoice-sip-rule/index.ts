...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/chimesdkvoice_sip_rule
...
export class ChimesdkvoiceSipRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ChimesdkvoiceSipRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/chimesdkvoice_sip_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/chimesdkvoice_sip_rule aws_chimesdkvoice_sip_rule} Resource
  *
  * @param scope The scope in which to define this construct
