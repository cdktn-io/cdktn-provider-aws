...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/appstream_image
...
export class DataAwsAppstreamImageApplicationsIconS3LocationOutputReference extends cdktn.ComplexObject {
...
export class DataAwsAppstreamImageApplicationsIconS3LocationList extends cdktn.ComplexList {
...
export class DataAwsAppstreamImageApplicationsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsAppstreamImageApplicationsList extends cdktn.ComplexList {
...
export class DataAwsAppstreamImageImagePermissionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsAppstreamImageImagePermissionsList extends cdktn.ComplexList {
...
export class DataAwsAppstreamImageStateChangeReasonOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsAppstreamImageStateChangeReasonList extends cdktn.ComplexList {
...
export class DataAwsAppstreamImage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppstreamImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/appstream_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/appstream_image aws_appstream_image} Data Source
  *
  * @param scope The scope in which to define this construct
