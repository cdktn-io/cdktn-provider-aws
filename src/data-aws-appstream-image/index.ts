...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/appstream_image
...
export class DataAwsAppstreamImage extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppstreamImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/appstream_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/appstream_image aws_appstream_image} Data Source
  *
  * @param scope The scope in which to define this construct
