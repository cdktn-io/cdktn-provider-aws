...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/api_gateway_documentation_part
...
export class ApiGatewayDocumentationPart extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayDocumentationPart that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/api_gateway_documentation_part#import import section} in the documentation of this resource for the id to use
