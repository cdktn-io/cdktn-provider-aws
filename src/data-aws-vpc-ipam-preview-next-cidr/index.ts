...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/vpc_ipam_preview_next_cidr
...
export class DataAwsVpcIpamPreviewNextCidr extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpamPreviewNextCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/vpc_ipam_preview_next_cidr#import import section} in the documentation of this resource for the id to use
