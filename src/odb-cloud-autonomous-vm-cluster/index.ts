...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/odb_cloud_autonomous_vm_cluster
...
export class OdbCloudAutonomousVmCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudAutonomousVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/odb_cloud_autonomous_vm_cluster#import import section} in the documentation of this resource for the id to use
