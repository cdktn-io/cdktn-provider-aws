...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/config_configuration_aggregator
...
export class ConfigConfigurationAggregator extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigConfigurationAggregator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/config_configuration_aggregator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/config_configuration_aggregator aws_config_configuration_aggregator} Resource
  *
  * @param scope The scope in which to define this construct
