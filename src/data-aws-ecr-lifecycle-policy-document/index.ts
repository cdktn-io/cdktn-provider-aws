...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/ecr_lifecycle_policy_document
...
export class DataAwsEcrLifecyclePolicyDocument extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcrLifecyclePolicyDocument that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/ecr_lifecycle_policy_document#import import section} in the documentation of this resource for the id to use
