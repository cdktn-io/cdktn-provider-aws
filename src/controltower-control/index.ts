...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/controltower_control
...
export class ControltowerControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ControltowerControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/controltower_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/controltower_control aws_controltower_control} Resource
  *
  * @param scope The scope in which to define this construct
