...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/vpc_endpoint_associations
...
export class DataAwsVpcEndpointAssociationsAssociationsDnsEntryOutputReference extends cdktn.ComplexObject {
...
export class DataAwsVpcEndpointAssociationsAssociationsDnsEntryList extends cdktn.ComplexList {
...
export class DataAwsVpcEndpointAssociationsAssociationsPrivateDnsEntryOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsVpcEndpointAssociationsAssociationsPrivateDnsEntryList extends cdktn.ComplexList {
...
export class DataAwsVpcEndpointAssociationsAssociationsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsVpcEndpointAssociationsAssociationsList extends cdktn.ComplexList {
...
export class DataAwsVpcEndpointAssociations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcEndpointAssociations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/vpc_endpoint_associations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/vpc_endpoint_associations aws_vpc_endpoint_associations} Data Source
  *
  * @param scope The scope in which to define this construct
