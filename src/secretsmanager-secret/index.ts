...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/secretsmanager_secret
...
export class SecretsmanagerSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsmanagerSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/secretsmanager_secret#import import section} in the documentation of this resource for the id to use
