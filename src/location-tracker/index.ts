...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/location_tracker
...
export class LocationTracker extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationTracker that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/location_tracker#import import section} in the documentation of this resource for the id to use
