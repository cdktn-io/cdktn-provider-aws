...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/quicksight_group
...
export class QuicksightGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/quicksight_group#import import section} in the documentation of this resource for the id to use
