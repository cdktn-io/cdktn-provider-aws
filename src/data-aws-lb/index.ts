...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/lb
...
export class DataAwsLb extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/lb#import import section} in the documentation of this resource for the id to use
