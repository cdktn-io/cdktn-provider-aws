...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/alb_listener
...
export interface DataAwsAlbListenerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/alb_listener#read DataAwsAlbListener#read}
  */
...
export class DataAwsAlbListener extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAlbListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/alb_listener#import import section} in the documentation of this resource for the id to use
