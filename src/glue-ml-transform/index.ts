...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/glue_ml_transform
...
export class GlueMlTransform extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueMlTransform that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/glue_ml_transform#import import section} in the documentation of this resource for the id to use
