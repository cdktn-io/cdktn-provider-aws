...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ami
...
export class Ami extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ami that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/ami#import import section} in the documentation of this resource for the id to use
