...
// https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/vpc_endpoint_connection_accepter
...
export class VpcEndpointConnectionAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointConnectionAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/vpc_endpoint_connection_accepter#import import section} in the documentation of this resource for the id to use
