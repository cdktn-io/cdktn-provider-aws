...
// https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/resources/efs_file_system_policy
...
export class EfsFileSystemPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EfsFileSystemPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/resources/efs_file_system_policy#import import section} in the documentation of this resource for the id to use
