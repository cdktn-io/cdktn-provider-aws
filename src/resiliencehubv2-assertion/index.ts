...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/resiliencehubv2_assertion
...
export class Resiliencehubv2Assertion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resiliencehubv2Assertion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/resiliencehubv2_assertion#import import section} in the documentation of this resource for the id to use
