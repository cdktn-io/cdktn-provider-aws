...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/datazone_glossary_term
...
export class DatazoneGlossaryTerm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneGlossaryTerm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/datazone_glossary_term#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/datazone_glossary_term aws_datazone_glossary_term} Resource
  *
  * @param scope The scope in which to define this construct
