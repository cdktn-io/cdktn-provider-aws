...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/codecommit_approval_rule_template_association
...
export class CodecommitApprovalRuleTemplateAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodecommitApprovalRuleTemplateAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/codecommit_approval_rule_template_association#import import section} in the documentation of this resource for the id to use
