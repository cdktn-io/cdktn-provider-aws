...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/vpn_concentrator
...
export class VpnConcentrator extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnConcentrator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/vpn_concentrator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/vpn_concentrator aws_vpn_concentrator} Resource
  *
  * @param scope The scope in which to define this construct
