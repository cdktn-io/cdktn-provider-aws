...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/apigatewayv2_api
...
export class DataAwsApigatewayv2Api extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApigatewayv2Api that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/apigatewayv2_api#import import section} in the documentation of this resource for the id to use
