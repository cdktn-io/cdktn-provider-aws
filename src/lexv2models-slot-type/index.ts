...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_slot_type
...
export class Lexv2ModelsSlotType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Lexv2ModelsSlotType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_slot_type#import import section} in the documentation of this resource for the id to use
