...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/key_pair
...
export class DataAwsKeyPair extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKeyPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/key_pair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/key_pair aws_key_pair} Data Source
  *
  * @param scope The scope in which to define this construct
