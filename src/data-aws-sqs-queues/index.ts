...
// https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/sqs_queues
...
export class DataAwsSqsQueues extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSqsQueues that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/sqs_queues#import import section} in the documentation of this resource for the id to use
