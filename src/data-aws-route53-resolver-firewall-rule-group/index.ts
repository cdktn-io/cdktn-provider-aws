...
// https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/route53_resolver_firewall_rule_group
...
export class DataAwsRoute53ResolverFirewallRuleGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53ResolverFirewallRuleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/route53_resolver_firewall_rule_group#import import section} in the documentation of this resource for the id to use
