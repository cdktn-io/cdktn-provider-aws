...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/finspace_kx_cluster
...
export class FinspaceKxCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FinspaceKxCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/finspace_kx_cluster#import import section} in the documentation of this resource for the id to use
