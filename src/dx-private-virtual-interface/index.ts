...
export class DxPrivateVirtualInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DxPrivateVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/dx_private_virtual_interface#import import section} in the documentation of this resource for the id to use
