...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudwatch_dashboard
...
export class CloudwatchDashboard extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudwatch_dashboard#import import section} in the documentation of this resource for the id to use
