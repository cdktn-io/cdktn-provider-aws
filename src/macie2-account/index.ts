...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/macie2_account
...
export class Macie2Account extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Macie2Account that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/macie2_account#import import section} in the documentation of this resource for the id to use
