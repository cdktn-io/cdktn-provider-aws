...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/cloudfront_log_delivery_canonical_user_id
...
export class DataAwsCloudfrontLogDeliveryCanonicalUserId extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudfrontLogDeliveryCanonicalUserId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/cloudfront_log_delivery_canonical_user_id#import import section} in the documentation of this resource for the id to use
