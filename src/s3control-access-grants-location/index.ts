...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/s3control_access_grants_location
...
export class S3ControlAccessGrantsLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlAccessGrantsLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/s3control_access_grants_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/s3control_access_grants_location aws_s3control_access_grants_location} Resource
  *
  * @param scope The scope in which to define this construct
