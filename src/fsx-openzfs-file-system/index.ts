...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/fsx_openzfs_file_system
...
export class FsxOpenzfsFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FsxOpenzfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/fsx_openzfs_file_system#import import section} in the documentation of this resource for the id to use
