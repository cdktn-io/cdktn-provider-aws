...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/ecs_task_definition
...
export class DataAwsEcsTaskDefinition extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcsTaskDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/ecs_task_definition#import import section} in the documentation of this resource for the id to use
