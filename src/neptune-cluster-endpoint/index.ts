...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/neptune_cluster_endpoint
...
export class NeptuneClusterEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NeptuneClusterEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/neptune_cluster_endpoint#import import section} in the documentation of this resource for the id to use
