...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/default_network_acl
...
export class DefaultNetworkAcl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultNetworkAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/default_network_acl#import import section} in the documentation of this resource for the id to use
