...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/kendra_faq
...
export class DataAwsKendraFaq extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKendraFaq that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/kendra_faq#import import section} in the documentation of this resource for the id to use
