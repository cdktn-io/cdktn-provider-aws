...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/iam_role_policy_attachments_exclusive
...
export class IamRolePolicyAttachmentsExclusive extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRolePolicyAttachmentsExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/iam_role_policy_attachments_exclusive#import import section} in the documentation of this resource for the id to use
