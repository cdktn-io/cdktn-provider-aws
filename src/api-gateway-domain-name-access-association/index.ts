...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/api_gateway_domain_name_access_association
...
export class ApiGatewayDomainNameAccessAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayDomainNameAccessAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/api_gateway_domain_name_access_association#import import section} in the documentation of this resource for the id to use
