...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/cloudformation_stack_set
...
export class CloudformationStackSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudformationStackSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/cloudformation_stack_set#import import section} in the documentation of this resource for the id to use
