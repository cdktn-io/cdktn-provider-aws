...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/cloud9_environment_membership
...
export class Cloud9EnvironmentMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Cloud9EnvironmentMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/cloud9_environment_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/cloud9_environment_membership aws_cloud9_environment_membership} Resource
  *
  * @param scope The scope in which to define this construct
