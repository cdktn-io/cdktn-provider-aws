...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/glue_partition_index
...
export class GluePartitionIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GluePartitionIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/glue_partition_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/glue_partition_index aws_glue_partition_index} Resource
  *
  * @param scope The scope in which to define this construct
