...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/keyspaces_keyspace
...
export class KeyspacesKeyspace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyspacesKeyspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/keyspaces_keyspace#import import section} in the documentation of this resource for the id to use
