...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/ssoadmin_application_providers
...
export class DataAwsSsoadminApplicationProviders extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsoadminApplicationProviders that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/ssoadmin_application_providers#import import section} in the documentation of this resource for the id to use
