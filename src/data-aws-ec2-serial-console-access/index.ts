...
// https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/ec2_serial_console_access
...
export class DataAwsEc2SerialConsoleAccess extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2SerialConsoleAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/ec2_serial_console_access#import import section} in the documentation of this resource for the id to use
