...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/dx_locations
...
export class DataAwsDxLocations extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDxLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/dx_locations#import import section} in the documentation of this resource for the id to use
