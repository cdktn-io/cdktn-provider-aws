...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/redshift_idc_application
...
export class RedshiftIdcApplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftIdcApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/redshift_idc_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/redshift_idc_application aws_redshift_idc_application} Resource
  *
  * @param scope The scope in which to define this construct
