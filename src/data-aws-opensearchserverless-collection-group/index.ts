...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/opensearchserverless_collection_group
...
export class DataAwsOpensearchserverlessCollectionGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOpensearchserverlessCollectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/opensearchserverless_collection_group#import import section} in the documentation of this resource for the id to use
