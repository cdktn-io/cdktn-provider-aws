...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/s3tables_table_policy
...
export class S3TablesTablePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3TablesTablePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/s3tables_table_policy#import import section} in the documentation of this resource for the id to use
