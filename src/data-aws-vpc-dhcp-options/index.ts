...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/vpc_dhcp_options
...
export class DataAwsVpcDhcpOptions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcDhcpOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/vpc_dhcp_options#import import section} in the documentation of this resource for the id to use
