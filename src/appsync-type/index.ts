...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/appsync_type
...
export class AppsyncType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/appsync_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/appsync_type aws_appsync_type} Resource
  *
  * @param scope The scope in which to define this construct
