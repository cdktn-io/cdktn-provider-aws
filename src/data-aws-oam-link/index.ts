...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/oam_link
...
export class DataAwsOamLink extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOamLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/oam_link#import import section} in the documentation of this resource for the id to use
