...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/regions
...
export class DataAwsRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/regions aws_regions} Data Source
  *
  * @param scope The scope in which to define this construct
