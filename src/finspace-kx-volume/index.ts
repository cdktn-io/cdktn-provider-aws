...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/finspace_kx_volume
...
export class FinspaceKxVolume extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FinspaceKxVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/finspace_kx_volume#import import section} in the documentation of this resource for the id to use
