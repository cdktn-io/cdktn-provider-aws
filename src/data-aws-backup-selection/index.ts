...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/backup_selection
...
export class DataAwsBackupSelection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBackupSelection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/backup_selection#import import section} in the documentation of this resource for the id to use
