...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dynamodb_global_secondary_index
...
export class DynamodbGlobalSecondaryIndex extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbGlobalSecondaryIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dynamodb_global_secondary_index#import import section} in the documentation of this resource for the id to use
