...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/servicecatalog_product
...
export class ServicecatalogProduct extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicecatalogProduct that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/servicecatalog_product#import import section} in the documentation of this resource for the id to use
