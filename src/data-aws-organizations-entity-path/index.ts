...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/organizations_entity_path
...
export class DataAwsOrganizationsEntityPath extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsEntityPath that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/organizations_entity_path#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/organizations_entity_path aws_organizations_entity_path} Data Source
  *
  * @param scope The scope in which to define this construct
