...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/ecs_express_gateway_service
...
export class EcsExpressGatewayService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsExpressGatewayService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/ecs_express_gateway_service#import import section} in the documentation of this resource for the id to use
