...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/workspaces_workspace
...
export class DataAwsWorkspacesWorkspace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWorkspacesWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/workspaces_workspace#import import section} in the documentation of this resource for the id to use
