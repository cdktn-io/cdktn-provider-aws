...
// https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/ebs_default_kms_key
...
export class DataAwsEbsDefaultKmsKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEbsDefaultKmsKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/ebs_default_kms_key#import import section} in the documentation of this resource for the id to use
