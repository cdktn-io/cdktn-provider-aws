...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/vpc_ipam_pool
...
export class DataAwsVpcIpamPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpamPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/vpc_ipam_pool#import import section} in the documentation of this resource for the id to use
