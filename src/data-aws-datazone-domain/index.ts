...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/datazone_domain
...
export class DataAwsDatazoneDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDatazoneDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/data-sources/datazone_domain#import import section} in the documentation of this resource for the id to use
