...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/emr_studio_session_mapping
...
export class EmrStudioSessionMapping extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrStudioSessionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/emr_studio_session_mapping#import import section} in the documentation of this resource for the id to use
