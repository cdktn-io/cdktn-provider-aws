...
// https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/xray_indexing_rule
...
export interface XrayIndexingRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/xray_indexing_rule#name XrayIndexingRule#name}
  */
...
export interface XrayIndexingRuleRuleProbabilistic {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/xray_indexing_rule#desired_sampling_percentage XrayIndexingRule#desired_sampling_percentage}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/xray_indexing_rule aws_xray_indexing_rule}
*/
export class XrayIndexingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayIndexingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/xray_indexing_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.53.0/docs/resources/xray_indexing_rule aws_xray_indexing_rule} Resource
  *
  * @param scope The scope in which to define this construct
