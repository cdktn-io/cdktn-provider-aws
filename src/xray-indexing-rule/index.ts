...
// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/xray_indexing_rule
...
export interface XrayIndexingRuleConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/xray_indexing_rule#name XrayIndexingRule#name}
  */
...
export interface XrayIndexingRuleRuleProbabilistic {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/xray_indexing_rule#desired_sampling_percentage XrayIndexingRule#desired_sampling_percentage}
  */
...
export class XrayIndexingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayIndexingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/xray_indexing_rule#import import section} in the documentation of this resource for the id to use
