...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/xray_indexing_rule
...
export class XrayIndexingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing XrayIndexingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/xray_indexing_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/xray_indexing_rule aws_xray_indexing_rule} Resource
  *
  * @param scope The scope in which to define this construct
