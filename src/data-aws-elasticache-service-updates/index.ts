...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/elasticache_service_updates
...
export class DataAwsElasticacheServiceUpdates extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticacheServiceUpdates that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/elasticache_service_updates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/elasticache_service_updates aws_elasticache_service_updates} Data Source
  *
  * @param scope The scope in which to define this construct
