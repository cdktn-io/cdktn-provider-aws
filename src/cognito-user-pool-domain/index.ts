...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/cognito_user_pool_domain
...
export class CognitoUserPoolDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoUserPoolDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/cognito_user_pool_domain#import import section} in the documentation of this resource for the id to use
