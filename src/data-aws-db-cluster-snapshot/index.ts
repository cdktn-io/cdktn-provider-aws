...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/db_cluster_snapshot
...
export class DataAwsDbClusterSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbClusterSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/db_cluster_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/db_cluster_snapshot aws_db_cluster_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
