...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/appmesh_virtual_router
...
export class AppmeshVirtualRouter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppmeshVirtualRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/appmesh_virtual_router#import import section} in the documentation of this resource for the id to use
