...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/caller_identity
...
export class DataAwsCallerIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCallerIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/caller_identity#import import section} in the documentation of this resource for the id to use
