...
// https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/dax_cluster
...
export class DaxCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DaxCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/resources/dax_cluster#import import section} in the documentation of this resource for the id to use
