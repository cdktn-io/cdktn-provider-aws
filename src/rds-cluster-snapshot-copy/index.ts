...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/rds_cluster_snapshot_copy
...
export class RdsClusterSnapshotCopy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsClusterSnapshotCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/rds_cluster_snapshot_copy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/rds_cluster_snapshot_copy aws_rds_cluster_snapshot_copy} Resource
  *
  * @param scope The scope in which to define this construct
