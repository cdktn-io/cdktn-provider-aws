...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/vpc_block_public_access_exclusion
...
export class VpcBlockPublicAccessExclusion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcBlockPublicAccessExclusion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/vpc_block_public_access_exclusion#import import section} in the documentation of this resource for the id to use
