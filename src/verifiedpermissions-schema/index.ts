...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/verifiedpermissions_schema
...
export class VerifiedpermissionsSchema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VerifiedpermissionsSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/verifiedpermissions_schema#import import section} in the documentation of this resource for the id to use
