...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/data-sources/timestreamwrite_table
...
export class DataAwsTimestreamwriteTable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsTimestreamwriteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/data-sources/timestreamwrite_table#import import section} in the documentation of this resource for the id to use
