...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/timestreamwrite_table
...
export class DataAwsTimestreamwriteTable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsTimestreamwriteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/timestreamwrite_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/timestreamwrite_table aws_timestreamwrite_table} Data Source
  *
  * @param scope The scope in which to define this construct
