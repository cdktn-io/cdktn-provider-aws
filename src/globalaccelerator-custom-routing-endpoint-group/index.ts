...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/globalaccelerator_custom_routing_endpoint_group
...
export class GlobalacceleratorCustomRoutingEndpointGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalacceleratorCustomRoutingEndpointGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/globalaccelerator_custom_routing_endpoint_group#import import section} in the documentation of this resource for the id to use
