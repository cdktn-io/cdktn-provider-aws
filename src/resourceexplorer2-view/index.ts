...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/resourceexplorer2_view
...
export class Resourceexplorer2View extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resourceexplorer2View that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/resourceexplorer2_view#import import section} in the documentation of this resource for the id to use
