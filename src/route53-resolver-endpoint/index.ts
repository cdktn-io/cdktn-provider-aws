...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/route53_resolver_endpoint
...
export class Route53ResolverEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ResolverEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/route53_resolver_endpoint#import import section} in the documentation of this resource for the id to use
