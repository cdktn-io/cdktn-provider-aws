...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/sagemaker_human_task_ui
...
export class SagemakerHumanTaskUi extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerHumanTaskUi that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/sagemaker_human_task_ui#import import section} in the documentation of this resource for the id to use
