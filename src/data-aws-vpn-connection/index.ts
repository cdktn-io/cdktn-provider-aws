...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/vpn_connection
...
export class DataAwsVpnConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpnConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/vpn_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/vpn_connection aws_vpn_connection} Data Source
  *
  * @param scope The scope in which to define this construct
