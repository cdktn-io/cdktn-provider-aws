...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/data-sources/secretsmanager_secret_versions
...
export class DataAwsSecretsmanagerSecretVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSecretsmanagerSecretVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/data-sources/secretsmanager_secret_versions#import import section} in the documentation of this resource for the id to use
