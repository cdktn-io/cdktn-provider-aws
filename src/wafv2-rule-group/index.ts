...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/wafv2_rule_group
...
export class Wafv2RuleGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2RuleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/wafv2_rule_group#import import section} in the documentation of this resource for the id to use
