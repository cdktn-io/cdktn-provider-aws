...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/cur_report_definition
...
export class CurReportDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CurReportDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/cur_report_definition#import import section} in the documentation of this resource for the id to use
