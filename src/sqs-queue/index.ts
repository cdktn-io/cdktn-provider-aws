...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/sqs_queue
...
export class SqsQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqsQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/sqs_queue#import import section} in the documentation of this resource for the id to use
