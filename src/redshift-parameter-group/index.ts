...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshift_parameter_group
...
export class RedshiftParameterGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/redshift_parameter_group#import import section} in the documentation of this resource for the id to use
