...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/neptune_global_cluster
...
export class NeptuneGlobalCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NeptuneGlobalCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/neptune_global_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/neptune_global_cluster aws_neptune_global_cluster} Resource
  *
  * @param scope The scope in which to define this construct
