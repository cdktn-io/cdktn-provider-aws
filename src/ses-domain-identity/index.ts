...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ses_domain_identity
...
export class SesDomainIdentity extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesDomainIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/ses_domain_identity#import import section} in the documentation of this resource for the id to use
