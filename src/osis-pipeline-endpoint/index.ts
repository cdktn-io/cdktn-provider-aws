...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/osis_pipeline_endpoint
...
export class OsisPipelineEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OsisPipelineEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/osis_pipeline_endpoint#import import section} in the documentation of this resource for the id to use
