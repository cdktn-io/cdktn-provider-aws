...
// https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/arczonalshift_autoshift_observer_notification_status
...
export class ArczonalshiftAutoshiftObserverNotificationStatus extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ArczonalshiftAutoshiftObserverNotificationStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/arczonalshift_autoshift_observer_notification_status#import import section} in the documentation of this resource for the id to use
