...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/guardduty_organization_configuration_feature
...
export class GuarddutyOrganizationConfigurationFeature extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyOrganizationConfigurationFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/guardduty_organization_configuration_feature#import import section} in the documentation of this resource for the id to use
