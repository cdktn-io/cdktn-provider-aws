...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/quicksight_data_source
...
export class QuicksightDataSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/quicksight_data_source#import import section} in the documentation of this resource for the id to use
