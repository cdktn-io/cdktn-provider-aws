...
// https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/data-sources/ce_cost_category
...
export class DataAwsCeCostCategory extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCeCostCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/data-sources/ce_cost_category#import import section} in the documentation of this resource for the id to use
