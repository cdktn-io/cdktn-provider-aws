...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/datazone_environment_profile
...
export class DatazoneEnvironmentProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneEnvironmentProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/datazone_environment_profile#import import section} in the documentation of this resource for the id to use
