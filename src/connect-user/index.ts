...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/connect_user
...
export class ConnectUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/connect_user#import import section} in the documentation of this resource for the id to use
