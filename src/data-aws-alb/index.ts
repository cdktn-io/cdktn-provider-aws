...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/alb
...
export class DataAwsAlb extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAlb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/alb#import import section} in the documentation of this resource for the id to use
