...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/controltower_baseline
...
export class ControltowerBaseline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ControltowerBaseline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/controltower_baseline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/controltower_baseline aws_controltower_baseline} Resource
  *
  * @param scope The scope in which to define this construct
