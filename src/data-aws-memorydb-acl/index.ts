...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/memorydb_acl
...
export class DataAwsMemorydbAcl extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMemorydbAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/memorydb_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/memorydb_acl aws_memorydb_acl} Data Source
  *
  * @param scope The scope in which to define this construct
