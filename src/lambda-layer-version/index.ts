...
// https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/lambda_layer_version
...
export class LambdaLayerVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaLayerVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/lambda_layer_version#import import section} in the documentation of this resource for the id to use
