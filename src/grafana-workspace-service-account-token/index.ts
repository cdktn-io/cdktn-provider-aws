...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/grafana_workspace_service_account_token
...
export class GrafanaWorkspaceServiceAccountToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrafanaWorkspaceServiceAccountToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/grafana_workspace_service_account_token#import import section} in the documentation of this resource for the id to use
