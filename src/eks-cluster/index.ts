...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/eks_cluster
...
export class EksCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EksCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/eks_cluster#import import section} in the documentation of this resource for the id to use
