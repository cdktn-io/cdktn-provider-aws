...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/datasync_agent
...
export class DatasyncAgent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/datasync_agent#import import section} in the documentation of this resource for the id to use
