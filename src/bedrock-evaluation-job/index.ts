...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/bedrock_evaluation_job
...
export class BedrockEvaluationJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockEvaluationJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/bedrock_evaluation_job#import import section} in the documentation of this resource for the id to use
