...
export interface BedrockEvaluationJobInferenceConfigModelBedrockModelPerformanceConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/bedrock_evaluation_job#latency BedrockEvaluationJob#latency}
  */
...
export class BedrockEvaluationJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockEvaluationJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/bedrock_evaluation_job#import import section} in the documentation of this resource for the id to use
