...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/redshiftserverless_namespace
...
export class RedshiftserverlessNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftserverlessNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/redshiftserverless_namespace#import import section} in the documentation of this resource for the id to use
