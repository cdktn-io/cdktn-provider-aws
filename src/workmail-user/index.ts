...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/workmail_user
...
export class WorkmailUser extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkmailUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/workmail_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/workmail_user aws_workmail_user} Resource
  *
  * @param scope The scope in which to define this construct
