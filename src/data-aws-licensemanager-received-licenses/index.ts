...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/licensemanager_received_licenses
...
export class DataAwsLicensemanagerReceivedLicenses extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLicensemanagerReceivedLicenses that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/licensemanager_received_licenses#import import section} in the documentation of this resource for the id to use
