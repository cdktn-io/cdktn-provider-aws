...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshiftserverless_usage_limit
...
export class RedshiftserverlessUsageLimit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftserverlessUsageLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/redshiftserverless_usage_limit#import import section} in the documentation of this resource for the id to use
