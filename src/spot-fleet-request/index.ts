...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/spot_fleet_request
...
export class SpotFleetRequest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpotFleetRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/spot_fleet_request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/spot_fleet_request aws_spot_fleet_request} Resource
  *
  * @param scope The scope in which to define this construct
