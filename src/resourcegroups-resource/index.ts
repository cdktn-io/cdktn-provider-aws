...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/resourcegroups_resource
...
export class ResourcegroupsResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcegroupsResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/resourcegroups_resource#import import section} in the documentation of this resource for the id to use
