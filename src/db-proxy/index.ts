...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/db_proxy
...
export class DbProxy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/db_proxy#import import section} in the documentation of this resource for the id to use
