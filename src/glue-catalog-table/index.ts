...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/glue_catalog_table
...
export class GlueCatalogTableStorageDescriptorOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // additional_locations - computed: true, optional: true, required: false
...
export class GlueCatalogTableViewDefinitionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // sub_object_version_ids - computed: true, optional: true, required: false
  ...
  // sub_objects - computed: true, optional: true, required: false
...
export class GlueCatalogTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueCatalogTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/glue_catalog_table#import import section} in the documentation of this resource for the id to use
