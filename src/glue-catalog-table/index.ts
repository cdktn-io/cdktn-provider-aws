...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/glue_catalog_table
...
export class GlueCatalogTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueCatalogTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/glue_catalog_table#import import section} in the documentation of this resource for the id to use
