...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/data-sources/ebs_volume
...
export class DataAwsEbsVolume extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEbsVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/data-sources/ebs_volume#import import section} in the documentation of this resource for the id to use
