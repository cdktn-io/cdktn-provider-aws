...
export interface Lexv2ModelsIntentConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#bot_id Lexv2ModelsIntent#bot_id}
  */
  readonly botId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#bot_version Lexv2ModelsIntent#bot_version}
  */
  readonly botVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#description Lexv2ModelsIntent#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#locale_id Lexv2ModelsIntent#locale_id}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#parent_intent_signature Lexv2ModelsIntent#parent_intent_signature}
  */
  readonly parentIntentSignature?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#region Lexv2ModelsIntent#region}
  */
  readonly region?: string;
  /**
  * closing_setting block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#closing_setting Lexv2ModelsIntent#closing_setting}
  */
  readonly closingSetting?: Lexv2ModelsIntentClosingSetting[] | cdktn.IResolvable;
  /**
  * confirmation_setting block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#confirmation_setting Lexv2ModelsIntent#confirmation_setting}
  */
  readonly confirmationSetting?: Lexv2ModelsIntentConfirmationSetting[] | cdktn.IResolvable;
  /**
  * dialog_code_hook block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#dialog_code_hook Lexv2ModelsIntent#dialog_code_hook}
  */
  readonly dialogCodeHook?: Lexv2ModelsIntentDialogCodeHook[] | cdktn.IResolvable;
  /**
  * fulfillment_code_hook block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#fulfillment_code_hook Lexv2ModelsIntent#fulfillment_code_hook}
  */
  readonly fulfillmentCodeHook?: Lexv2ModelsIntentFulfillmentCodeHook[] | cdktn.IResolvable;
  /**
  * initial_response_setting block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#initial_response_setting Lexv2ModelsIntent#initial_response_setting}
  */
  readonly initialResponseSetting?: Lexv2ModelsIntentInitialResponseSetting[] | cdktn.IResolvable;
  /**
  * input_context block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#input_context Lexv2ModelsIntent#input_context}
  */
  readonly inputContext?: Lexv2ModelsIntentInputContext[] | cdktn.IResolvable;
  /**
  * kendra_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#kendra_configuration Lexv2ModelsIntent#kendra_configuration}
  */
  readonly kendraConfiguration?: Lexv2ModelsIntentKendraConfiguration[] | cdktn.IResolvable;
  /**
  * output_context block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#output_context Lexv2ModelsIntent#output_context}
  */
  readonly outputContext?: Lexv2ModelsIntentOutputContext[] | cdktn.IResolvable;
  /**
  * qna_intent_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#qna_intent_configuration Lexv2ModelsIntent#qna_intent_configuration}
  */
  readonly qnaIntentConfiguration?: Lexv2ModelsIntentQnaIntentConfiguration[] | cdktn.IResolvable;
  /**
  * sample_utterance block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#sample_utterance Lexv2ModelsIntent#sample_utterance}
  */
  readonly sampleUtterance?: Lexv2ModelsIntentSampleUtterance[] | cdktn.IResolvable;
  /**
  * slot_priority block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#slot_priority Lexv2ModelsIntent#slot_priority}
  */
  readonly slotPriority?: Lexv2ModelsIntentSlotPriority[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#timeouts Lexv2ModelsIntent#timeouts}
  */
  readonly timeouts?: Lexv2ModelsIntentTimeouts;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent aws_lexv2models_intent}
*/
export class Lexv2ModelsIntent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Lexv2ModelsIntent that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/lexv2models_intent aws_lexv2models_intent} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: Lexv2ModelsIntentConfig) {
    ...
    this._qnaIntentConfiguration.internalValue = config.qnaIntentConfiguration;
  ...
  // qna_intent_configuration - computed: false, optional: true, required: false
  private _qnaIntentConfiguration = new Lexv2ModelsIntentQnaIntentConfigurationList(this, "qna_intent_configuration", false);
  public get qnaIntentConfiguration() {
    return this._qnaIntentConfiguration;
  }
  public putQnaIntentConfiguration(value: Lexv2ModelsIntentQnaIntentConfiguration[] | cdktn.IResolvable) {
    this._qnaIntentConfiguration.internalValue = value;
  }
  public resetQnaIntentConfiguration() {
    this._qnaIntentConfiguration.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get qnaIntentConfigurationInput() {
    return this._qnaIntentConfiguration.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      qna_intent_configuration: cdktn.listMapper(lexv2ModelsIntentQnaIntentConfigurationToTerraform, true)(this._qnaIntentConfiguration.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      qna_intent_configuration: {
        value: cdktn.listMapperHcl(lexv2ModelsIntentQnaIntentConfigurationToHclTerraform, true)(this._qnaIntentConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Lexv2ModelsIntentQnaIntentConfigurationList",
      },
      sample_utterance: {
