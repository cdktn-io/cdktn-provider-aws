...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/auditmanager_framework_share
...
export class AuditmanagerFrameworkShare extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditmanagerFrameworkShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/auditmanager_framework_share#import import section} in the documentation of this resource for the id to use
