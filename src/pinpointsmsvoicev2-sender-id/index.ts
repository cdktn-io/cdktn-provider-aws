...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/pinpointsmsvoicev2_sender_id
...
export class Pinpointsmsvoicev2SenderId extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Pinpointsmsvoicev2SenderId that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/pinpointsmsvoicev2_sender_id#import import section} in the documentation of this resource for the id to use
