...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/docdb_cluster_instance
...
export class DocdbClusterInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbClusterInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/docdb_cluster_instance#import import section} in the documentation of this resource for the id to use
