...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/rds_reserved_instance
...
export class RdsReservedInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsReservedInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/rds_reserved_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/rds_reserved_instance aws_rds_reserved_instance} Resource
  *
  * @param scope The scope in which to define this construct
