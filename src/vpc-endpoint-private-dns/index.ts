...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/vpc_endpoint_private_dns
...
export class VpcEndpointPrivateDns extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointPrivateDns that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/vpc_endpoint_private_dns#import import section} in the documentation of this resource for the id to use
