...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ecs_daemon
...
export interface EcsDaemonConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly deploymentConfiguration?: EcsDaemonDeploymentConfiguration[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: EcsDaemonTimeouts;
}
...
export class EcsDaemonDeploymentConfigurationAlarmsList extends cdktn.ComplexList {
  public internalValue? : EcsDaemonDeploymentConfigurationAlarms[] | cdktn.IResolvable
  ...
  */
  public get(index: number): EcsDaemonDeploymentConfigurationAlarmsOutputReference {
    return new EcsDaemonDeploymentConfigurationAlarmsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface EcsDaemonDeploymentConfiguration {
  ...
  */
  readonly alarms?: EcsDaemonDeploymentConfigurationAlarms[] | cdktn.IResolvable;
}
...
export function ecsDaemonDeploymentConfigurationToTerraform(struct?: EcsDaemonDeploymentConfiguration | cdktn.IResolvable): any {
  ...
  return {
    ...
    alarms: cdktn.listMapper(ecsDaemonDeploymentConfigurationAlarmsToTerraform, true)(struct!.alarms),
  }
}
...
export function ecsDaemonDeploymentConfigurationToHclTerraform(struct?: EcsDaemonDeploymentConfiguration | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    alarms: {
      value: cdktn.listMapperHcl(ecsDaemonDeploymentConfigurationAlarmsToHclTerraform, true)(struct!.alarms),
      isBlock: true,
      type: "list",
      storageClassType: "EcsDaemonDeploymentConfigurationAlarmsList",
    },
  };
...
export class EcsDaemonDeploymentConfigurationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _alarms = new EcsDaemonDeploymentConfigurationAlarmsList(this, "alarms", false);
  public get alarms() {
    return this._alarms;
  }
  public putAlarms(value: EcsDaemonDeploymentConfigurationAlarms[] | cdktn.IResolvable) {
...
export class EcsDaemonDeploymentConfigurationList extends cdktn.ComplexList {
  public internalValue? : EcsDaemonDeploymentConfiguration[] | cdktn.IResolvable
  ...
  */
  public get(index: number): EcsDaemonDeploymentConfigurationOutputReference {
    return new EcsDaemonDeploymentConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface EcsDaemonTimeouts {
  /**
...
export function ecsDaemonTimeoutsToTerraform(struct?: EcsDaemonTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function ecsDaemonTimeoutsToHclTerraform(struct?: EcsDaemonTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class EcsDaemonTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): EcsDaemonTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: EcsDaemonTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class EcsDaemon extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsDaemon that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ecs_daemon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ecs_daemon aws_ecs_daemon} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _deploymentConfiguration = new EcsDaemonDeploymentConfigurationList(this, "deployment_configuration", false);
  public get deploymentConfiguration() {
    return this._deploymentConfiguration;
  }
  public putDeploymentConfiguration(value: EcsDaemonDeploymentConfiguration[] | cdktn.IResolvable) {
  ...
  private _timeouts = new EcsDaemonTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: EcsDaemonTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      deployment_configuration: cdktn.listMapper(ecsDaemonDeploymentConfigurationToTerraform, true)(this._deploymentConfiguration.internalValue),
      timeouts: ecsDaemonTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      deployment_configuration: {
        value: cdktn.listMapperHcl(ecsDaemonDeploymentConfigurationToHclTerraform, true)(this._deploymentConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "EcsDaemonDeploymentConfigurationList",
      },
      timeouts: {
        value: ecsDaemonTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EcsDaemonTimeouts",
      },
    };
