...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/ecs_daemon
...
export class EcsDaemon extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsDaemon that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/ecs_daemon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/ecs_daemon aws_ecs_daemon} Resource
  *
  * @param scope The scope in which to define this construct
