...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/redshift_scheduled_action
...
export class RedshiftScheduledAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftScheduledAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/redshift_scheduled_action#import import section} in the documentation of this resource for the id to use
