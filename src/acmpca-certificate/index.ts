...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/acmpca_certificate
...
export class AcmpcaCertificate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmpcaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/acmpca_certificate#import import section} in the documentation of this resource for the id to use
