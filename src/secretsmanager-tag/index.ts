...
export class SecretsmanagerTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsmanagerTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/secretsmanager_tag#import import section} in the documentation of this resource for the id to use
