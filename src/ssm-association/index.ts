...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/ssm_association
...
export class SsmAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/ssm_association#import import section} in the documentation of this resource for the id to use
