...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/networkmanager_attachment_accepter
...
export class NetworkmanagerAttachmentAccepter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerAttachmentAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/networkmanager_attachment_accepter#import import section} in the documentation of this resource for the id to use
