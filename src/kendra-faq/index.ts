...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/kendra_faq
...
export class KendraFaq extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraFaq that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/kendra_faq#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/kendra_faq aws_kendra_faq} Resource
  *
  * @param scope The scope in which to define this construct
