...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/kendra_faq
...
export class KendraFaq extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraFaq that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/kendra_faq#import import section} in the documentation of this resource for the id to use
