...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/datasync_location_hdfs
...
export class DatasyncLocationHdfs extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasyncLocationHdfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/datasync_location_hdfs#import import section} in the documentation of this resource for the id to use
