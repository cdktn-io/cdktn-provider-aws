...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/rds_shard_group
...
export class RdsShardGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsShardGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/rds_shard_group#import import section} in the documentation of this resource for the id to use
