...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/iam_account_alias
...
export class IamAccountAlias extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamAccountAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/iam_account_alias#import import section} in the documentation of this resource for the id to use
