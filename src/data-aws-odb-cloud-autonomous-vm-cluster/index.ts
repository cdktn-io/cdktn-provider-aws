...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/odb_cloud_autonomous_vm_cluster
...
export class DataAwsOdbCloudAutonomousVmCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbCloudAutonomousVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/odb_cloud_autonomous_vm_cluster#import import section} in the documentation of this resource for the id to use
