...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/wafregional_xss_match_set
...
export class WafregionalXssMatchSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalXssMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/wafregional_xss_match_set#import import section} in the documentation of this resource for the id to use
