...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/ec2_instance_metadata_defaults
...
export class Ec2InstanceMetadataDefaults extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2InstanceMetadataDefaults that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/ec2_instance_metadata_defaults#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/ec2_instance_metadata_defaults aws_ec2_instance_metadata_defaults} Resource
  *
  * @param scope The scope in which to define this construct
