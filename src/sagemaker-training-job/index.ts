...
// https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/sagemaker_training_job
...
export class SagemakerTrainingJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerTrainingJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/sagemaker_training_job#import import section} in the documentation of this resource for the id to use
