...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/apprunner_deployment
...
export class ApprunnerDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApprunnerDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/apprunner_deployment#import import section} in the documentation of this resource for the id to use
