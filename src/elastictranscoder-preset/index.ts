...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/elastictranscoder_preset
...
export class ElastictranscoderPreset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElastictranscoderPreset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/elastictranscoder_preset#import import section} in the documentation of this resource for the id to use
