...
// https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/ecr_registry_scanning_configuration
...
export class EcrRegistryScanningConfiguration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrRegistryScanningConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/ecr_registry_scanning_configuration#import import section} in the documentation of this resource for the id to use
