...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/data-sources/appintegrations_event_integration
...
export class DataAwsAppintegrationsEventIntegration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppintegrationsEventIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/data-sources/appintegrations_event_integration#import import section} in the documentation of this resource for the id to use
