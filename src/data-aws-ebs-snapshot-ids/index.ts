...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/ebs_snapshot_ids
...
export class DataAwsEbsSnapshotIds extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEbsSnapshotIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/ebs_snapshot_ids#import import section} in the documentation of this resource for the id to use
