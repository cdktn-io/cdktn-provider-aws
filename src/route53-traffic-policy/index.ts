...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/route53_traffic_policy
...
export class Route53TrafficPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53TrafficPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/route53_traffic_policy#import import section} in the documentation of this resource for the id to use
