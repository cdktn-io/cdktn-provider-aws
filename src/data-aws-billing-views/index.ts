...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/billing_views
...
export class DataAwsBillingViews extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBillingViews that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/billing_views#import import section} in the documentation of this resource for the id to use
