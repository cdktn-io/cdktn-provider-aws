...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/msk_kafka_version
...
export class DataAwsMskKafkaVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMskKafkaVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/msk_kafka_version#import import section} in the documentation of this resource for the id to use
