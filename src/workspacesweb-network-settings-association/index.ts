...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/workspacesweb_network_settings_association
...
export class WorkspaceswebNetworkSettingsAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceswebNetworkSettingsAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/workspacesweb_network_settings_association#import import section} in the documentation of this resource for the id to use
