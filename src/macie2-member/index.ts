...
// https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/macie2_member
...
export class Macie2Member extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Macie2Member that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/resources/macie2_member#import import section} in the documentation of this resource for the id to use
