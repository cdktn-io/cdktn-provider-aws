...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/eks_cluster_auth
...
export class DataAwsEksClusterAuth extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEksClusterAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/eks_cluster_auth#import import section} in the documentation of this resource for the id to use
