...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/odb_gi_versions
...
export class DataAwsOdbGiVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbGiVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/odb_gi_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/odb_gi_versions aws_odb_gi_versions} Data Source
  *
  * @param scope The scope in which to define this construct
