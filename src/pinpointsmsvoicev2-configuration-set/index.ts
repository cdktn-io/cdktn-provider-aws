...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/pinpointsmsvoicev2_configuration_set
...
export class Pinpointsmsvoicev2ConfigurationSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pinpointsmsvoicev2ConfigurationSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/pinpointsmsvoicev2_configuration_set#import import section} in the documentation of this resource for the id to use
