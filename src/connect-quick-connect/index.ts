...
// https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/connect_quick_connect
...
export class ConnectQuickConnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectQuickConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/connect_quick_connect#import import section} in the documentation of this resource for the id to use
