...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/elastic_beanstalk_application
...
export class ElasticBeanstalkApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticBeanstalkApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/elastic_beanstalk_application#import import section} in the documentation of this resource for the id to use
