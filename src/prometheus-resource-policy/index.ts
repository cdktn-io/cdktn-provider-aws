...
// https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/prometheus_resource_policy
...
export interface PrometheusResourcePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function prometheusResourcePolicyTimeoutsToTerraform(struct?: PrometheusResourcePolicyTimeouts | cdktf.IResolvable): any {
...
export function prometheusResourcePolicyTimeoutsToHclTerraform(struct?: PrometheusResourcePolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PrometheusResourcePolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PrometheusResourcePolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PrometheusResourcePolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class PrometheusResourcePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/prometheus_resource_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aws_prometheus_resource_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/prometheus_resource_policy aws_prometheus_resource_policy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      revision_id: {
        value: cdktf.stringToHclTerraform(this._revisionId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
