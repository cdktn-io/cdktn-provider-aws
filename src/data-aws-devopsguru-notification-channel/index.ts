...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/devopsguru_notification_channel
...
export class DataAwsDevopsguruNotificationChannel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDevopsguruNotificationChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/devopsguru_notification_channel#import import section} in the documentation of this resource for the id to use
