...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/networkmanager_prefix_list_association
...
export class NetworkmanagerPrefixListAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerPrefixListAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/networkmanager_prefix_list_association#import import section} in the documentation of this resource for the id to use
