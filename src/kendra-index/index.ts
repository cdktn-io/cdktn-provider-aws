...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/kendra_index
...
export class KendraIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/kendra_index#import import section} in the documentation of this resource for the id to use
