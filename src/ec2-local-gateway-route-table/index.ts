...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ec2_local_gateway_route_table
...
export class Ec2LocalGatewayRouteTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2LocalGatewayRouteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/ec2_local_gateway_route_table#import import section} in the documentation of this resource for the id to use
