...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dms_replication_task
...
export class DmsReplicationTask extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsReplicationTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dms_replication_task#import import section} in the documentation of this resource for the id to use
