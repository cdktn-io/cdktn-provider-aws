...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/s3_bucket_object_lock_configuration
...
export class S3BucketObjectLockConfigurationA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketObjectLockConfigurationA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/s3_bucket_object_lock_configuration#import import section} in the documentation of this resource for the id to use
