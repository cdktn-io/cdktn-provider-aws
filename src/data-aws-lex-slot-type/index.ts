...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/data-sources/lex_slot_type
...
export class DataAwsLexSlotType extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLexSlotType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/data-sources/lex_slot_type#import import section} in the documentation of this resource for the id to use
