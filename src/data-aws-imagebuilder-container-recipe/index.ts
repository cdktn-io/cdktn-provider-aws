...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/imagebuilder_container_recipe
...
export class DataAwsImagebuilderContainerRecipe extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsImagebuilderContainerRecipe that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/imagebuilder_container_recipe#import import section} in the documentation of this resource for the id to use
