...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/data-sources/lakeformation_resource
...
export class DataAwsLakeformationResource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLakeformationResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/data-sources/lakeformation_resource#import import section} in the documentation of this resource for the id to use
