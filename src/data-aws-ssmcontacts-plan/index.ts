...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ssmcontacts_plan
...
export interface DataAwsSsmcontactsPlanConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ssmcontacts_plan#contact_id DataAwsSsmcontactsPlan#contact_id}
  */
  readonly contactId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ssmcontacts_plan#id DataAwsSsmcontactsPlan#id}
  *
...
export class DataAwsSsmcontactsPlanStageTargetChannelTargetInfoOutputReference extends cdktn.ComplexObject {
...
export class DataAwsSsmcontactsPlanStageTargetChannelTargetInfoList extends cdktn.ComplexList {
...
export class DataAwsSsmcontactsPlanStageTargetContactTargetInfoOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsSsmcontactsPlanStageTargetContactTargetInfoList extends cdktn.ComplexList {
...
export class DataAwsSsmcontactsPlanStageTargetOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsSsmcontactsPlanStageTargetList extends cdktn.ComplexList {
...
export class DataAwsSsmcontactsPlanStageOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsSsmcontactsPlanStageList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ssmcontacts_plan aws_ssmcontacts_plan}
*/
export class DataAwsSsmcontactsPlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmcontactsPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ssmcontacts_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ssmcontacts_plan aws_ssmcontacts_plan} Data Source
  *
  * @param scope The scope in which to define this construct
