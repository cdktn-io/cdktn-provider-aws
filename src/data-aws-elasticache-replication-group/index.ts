...
// https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/elasticache_replication_group
...
export class DataAwsElasticacheReplicationGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticacheReplicationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/elasticache_replication_group#import import section} in the documentation of this resource for the id to use
