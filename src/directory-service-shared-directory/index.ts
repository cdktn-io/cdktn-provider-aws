...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/directory_service_shared_directory
...
export class DirectoryServiceSharedDirectory extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceSharedDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/directory_service_shared_directory#import import section} in the documentation of this resource for the id to use
