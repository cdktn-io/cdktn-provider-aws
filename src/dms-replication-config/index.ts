...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/dms_replication_config
...
export class DmsReplicationConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsReplicationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/dms_replication_config#import import section} in the documentation of this resource for the id to use
