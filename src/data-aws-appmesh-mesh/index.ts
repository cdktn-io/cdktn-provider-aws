...
// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/appmesh_mesh
...
export class DataAwsAppmeshMesh extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAppmeshMesh that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/data-sources/appmesh_mesh#import import section} in the documentation of this resource for the id to use
