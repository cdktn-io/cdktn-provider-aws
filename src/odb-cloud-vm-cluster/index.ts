...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/odb_cloud_vm_cluster
...
export class OdbCloudVmCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/odb_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
