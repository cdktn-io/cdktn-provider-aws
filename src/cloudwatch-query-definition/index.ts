...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/cloudwatch_query_definition
...
export class CloudwatchQueryDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchQueryDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/cloudwatch_query_definition#import import section} in the documentation of this resource for the id to use
