...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/ivschat_room
...
export class IvschatRoom extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IvschatRoom that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/ivschat_room#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/ivschat_room aws_ivschat_room} Resource
  *
  * @param scope The scope in which to define this construct
