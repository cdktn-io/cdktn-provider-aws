...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/apigatewayv2_integration_response
...
export class Apigatewayv2IntegrationResponse extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Apigatewayv2IntegrationResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/apigatewayv2_integration_response#import import section} in the documentation of this resource for the id to use
