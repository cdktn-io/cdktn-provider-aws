...
// https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/data-sources/connect_lambda_function_association
...
export class DataAwsConnectLambdaFunctionAssociation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsConnectLambdaFunctionAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/data-sources/connect_lambda_function_association#import import section} in the documentation of this resource for the id to use
