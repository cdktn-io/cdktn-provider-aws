...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/location_map
...
export class LocationMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/location_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/location_map aws_location_map} Resource
  *
  * @param scope The scope in which to define this construct
