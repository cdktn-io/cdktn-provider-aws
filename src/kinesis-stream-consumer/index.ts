...
// https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/kinesis_stream_consumer
...
export class KinesisStreamConsumer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisStreamConsumer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/kinesis_stream_consumer#import import section} in the documentation of this resource for the id to use
