...
// https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/data-sources/synthetics_runtime_version
...
export class DataAwsSyntheticsRuntimeVersion extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSyntheticsRuntimeVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/data-sources/synthetics_runtime_version#import import section} in the documentation of this resource for the id to use
