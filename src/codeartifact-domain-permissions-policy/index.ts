...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/codeartifact_domain_permissions_policy
...
export class CodeartifactDomainPermissionsPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeartifactDomainPermissionsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/codeartifact_domain_permissions_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/codeartifact_domain_permissions_policy aws_codeartifact_domain_permissions_policy} Resource
  *
  * @param scope The scope in which to define this construct
