...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/elasticache_user
...
export class ElasticacheUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/elasticache_user#import import section} in the documentation of this resource for the id to use
