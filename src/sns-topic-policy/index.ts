...
// https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/sns_topic_policy
...
export class SnsTopicPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnsTopicPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/sns_topic_policy#import import section} in the documentation of this resource for the id to use
