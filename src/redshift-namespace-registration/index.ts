...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/redshift_namespace_registration
...
export class RedshiftNamespaceRegistration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftNamespaceRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/redshift_namespace_registration#import import section} in the documentation of this resource for the id to use
