...
// https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/location_geofence_collection
...
export class LocationGeofenceCollection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationGeofenceCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/location_geofence_collection#import import section} in the documentation of this resource for the id to use
