...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/dynamodb_global_table
...
export class DynamodbGlobalTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbGlobalTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/dynamodb_global_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/dynamodb_global_table aws_dynamodb_global_table} Resource
  *
  * @param scope The scope in which to define this construct
