...
// https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/efs_file_system
...
export class DataAwsEfsFileSystem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/efs_file_system#import import section} in the documentation of this resource for the id to use
