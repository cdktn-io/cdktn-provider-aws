...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/cognito_user_pool_client
...
export class DataAwsCognitoUserPoolClient extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCognitoUserPoolClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/cognito_user_pool_client#import import section} in the documentation of this resource for the id to use
