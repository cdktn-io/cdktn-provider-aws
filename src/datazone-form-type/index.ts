...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/datazone_form_type
...
export class DatazoneFormType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneFormType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/datazone_form_type#import import section} in the documentation of this resource for the id to use
