...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/dms_replication_instance
...
export class DataAwsDmsReplicationInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDmsReplicationInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/dms_replication_instance#import import section} in the documentation of this resource for the id to use
