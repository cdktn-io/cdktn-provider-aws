...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/wafv2_rule_group
...
export class DataAwsWafv2RuleGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafv2RuleGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/wafv2_rule_group#import import section} in the documentation of this resource for the id to use
