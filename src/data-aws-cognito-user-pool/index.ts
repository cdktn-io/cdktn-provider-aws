...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/cognito_user_pool
...
export class DataAwsCognitoUserPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCognitoUserPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/cognito_user_pool#import import section} in the documentation of this resource for the id to use
