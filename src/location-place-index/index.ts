...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/location_place_index
...
export class LocationPlaceIndex extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationPlaceIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/location_place_index#import import section} in the documentation of this resource for the id to use
