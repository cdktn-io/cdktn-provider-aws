...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/s3vectors_vector_bucket
...
export class S3VectorsVectorBucket extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3VectorsVectorBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/s3vectors_vector_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/s3vectors_vector_bucket aws_s3vectors_vector_bucket} Resource
  *
  * @param scope The scope in which to define this construct
