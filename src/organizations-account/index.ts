...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/organizations_account
...
export class OrganizationsAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/organizations_account#import import section} in the documentation of this resource for the id to use
