...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/s3_bucket_server_side_encryption_configuration
...
export function s3BucketServerSideEncryptionConfigurationRuleAToTerraform(struct?: S3BucketServerSideEncryptionConfigurationRuleA | cdktf.IResolvable): any {
  ...
  return {
    blocked_encryption_types: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.blockedEncryptionTypes),
...
export function s3BucketServerSideEncryptionConfigurationRuleAToHclTerraform(struct?: S3BucketServerSideEncryptionConfigurationRuleA | cdktf.IResolvable): any {
  ...
  const attrs = {
    blocked_encryption_types: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.blockedEncryptionTypes),
      isBlock: false,
      type: "list",
...
export class S3BucketServerSideEncryptionConfigurationRuleAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // blocked_encryption_types - computed: false, optional: true, required: false
...
export class S3BucketServerSideEncryptionConfigurationA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketServerSideEncryptionConfigurationA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/s3_bucket_server_side_encryption_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/s3_bucket_server_side_encryption_configuration aws_s3_bucket_server_side_encryption_configuration} Resource
  *
  * @param scope The scope in which to define this construct
