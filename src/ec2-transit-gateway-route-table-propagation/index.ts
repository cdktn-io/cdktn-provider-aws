...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/ec2_transit_gateway_route_table_propagation
...
export class Ec2TransitGatewayRouteTablePropagation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TransitGatewayRouteTablePropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/ec2_transit_gateway_route_table_propagation#import import section} in the documentation of this resource for the id to use
