...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sesv2_account_suppression_attributes
...
export class Sesv2AccountSuppressionAttributes extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2AccountSuppressionAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/sesv2_account_suppression_attributes#import import section} in the documentation of this resource for the id to use
