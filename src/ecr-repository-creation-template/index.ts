...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ecr_repository_creation_template
...
export class EcrRepositoryCreationTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrRepositoryCreationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ecr_repository_creation_template#import import section} in the documentation of this resource for the id to use
