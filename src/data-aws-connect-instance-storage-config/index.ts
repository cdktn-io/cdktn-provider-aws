...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/connect_instance_storage_config
...
export class DataAwsConnectInstanceStorageConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsConnectInstanceStorageConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/connect_instance_storage_config#import import section} in the documentation of this resource for the id to use
