...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appsync_datasource
...
export class AppsyncDatasource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsyncDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/appsync_datasource#import import section} in the documentation of this resource for the id to use
