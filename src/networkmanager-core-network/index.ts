...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/networkmanager_core_network
...
export class NetworkmanagerCoreNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerCoreNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/networkmanager_core_network#import import section} in the documentation of this resource for the id to use
