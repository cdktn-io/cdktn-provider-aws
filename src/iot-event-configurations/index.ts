...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/iot_event_configurations
...
export class IotEventConfigurations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotEventConfigurations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/iot_event_configurations#import import section} in the documentation of this resource for the id to use
