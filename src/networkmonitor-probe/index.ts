...
// https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/networkmonitor_probe
...
export class NetworkmonitorProbe extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmonitorProbe that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/networkmonitor_probe#import import section} in the documentation of this resource for the id to use
