...
// https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/servicequotas_service_quota
...
export class ServicequotasServiceQuota extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicequotasServiceQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/servicequotas_service_quota#import import section} in the documentation of this resource for the id to use
