...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ec2_transit_gateway_default_route_table_propagation
...
export class Ec2TransitGatewayDefaultRouteTablePropagation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TransitGatewayDefaultRouteTablePropagation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ec2_transit_gateway_default_route_table_propagation#import import section} in the documentation of this resource for the id to use
