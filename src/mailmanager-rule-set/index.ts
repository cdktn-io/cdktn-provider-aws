...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/mailmanager_rule_set
...
export class MailmanagerRuleSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MailmanagerRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/mailmanager_rule_set#import import section} in the documentation of this resource for the id to use
