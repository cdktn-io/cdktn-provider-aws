...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/waf_size_constraint_set
...
export class WafSizeConstraintSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafSizeConstraintSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/waf_size_constraint_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/waf_size_constraint_set aws_waf_size_constraint_set} Resource
  *
  * @param scope The scope in which to define this construct
