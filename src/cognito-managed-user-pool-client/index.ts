...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/cognito_managed_user_pool_client
...
export class CognitoManagedUserPoolClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CognitoManagedUserPoolClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/cognito_managed_user_pool_client#import import section} in the documentation of this resource for the id to use
