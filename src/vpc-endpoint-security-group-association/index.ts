...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/vpc_endpoint_security_group_association
...
export class VpcEndpointSecurityGroupAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndpointSecurityGroupAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/vpc_endpoint_security_group_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/vpc_endpoint_security_group_association aws_vpc_endpoint_security_group_association} Resource
  *
  * @param scope The scope in which to define this construct
