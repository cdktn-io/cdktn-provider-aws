...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/nat_gateway_eip_association
...
export class NatGatewayEipAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NatGatewayEipAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/nat_gateway_eip_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/nat_gateway_eip_association aws_nat_gateway_eip_association} Resource
  *
  * @param scope The scope in which to define this construct
