...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/waf_rate_based_rule
...
export class DataAwsWafRateBasedRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafRateBasedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/waf_rate_based_rule#import import section} in the documentation of this resource for the id to use
