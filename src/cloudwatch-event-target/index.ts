...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudwatch_event_target
...
export class CloudwatchEventTarget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchEventTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudwatch_event_target#import import section} in the documentation of this resource for the id to use
