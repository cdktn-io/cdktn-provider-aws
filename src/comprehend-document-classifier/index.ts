...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/comprehend_document_classifier
...
export class ComprehendDocumentClassifier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComprehendDocumentClassifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/comprehend_document_classifier#import import section} in the documentation of this resource for the id to use
