...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/quicksight_user
...
export class QuicksightUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/quicksight_user#import import section} in the documentation of this resource for the id to use
