...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/ec2_client_vpn_authorization_rule
...
export class Ec2ClientVpnAuthorizationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ClientVpnAuthorizationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/ec2_client_vpn_authorization_rule#import import section} in the documentation of this resource for the id to use
