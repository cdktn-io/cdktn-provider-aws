...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/vpc_ipam_resource_discovery_association
...
export class VpcIpamResourceDiscoveryAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamResourceDiscoveryAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/vpc_ipam_resource_discovery_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/vpc_ipam_resource_discovery_association aws_vpc_ipam_resource_discovery_association} Resource
  *
  * @param scope The scope in which to define this construct
