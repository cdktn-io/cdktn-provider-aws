...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/s3vectors_index
...
export interface S3VectorsIndexEncryptionConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/s3vectors_index#kms_key_arn S3VectorsIndex#kms_key_arn}
  */
  readonly kmsKeyArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/s3vectors_index#sse_type S3VectorsIndex#sse_type}
  */
...
export class S3VectorsIndex extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3VectorsIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/s3vectors_index#import import section} in the documentation of this resource for the id to use
