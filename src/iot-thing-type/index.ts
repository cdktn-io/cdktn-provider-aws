...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/iot_thing_type
...
export class IotThingType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotThingType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/iot_thing_type#import import section} in the documentation of this resource for the id to use
