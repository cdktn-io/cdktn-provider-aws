...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/amplify_app
...
export class AmplifyApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AmplifyApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/amplify_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/amplify_app aws_amplify_app} Resource
  *
  * @param scope The scope in which to define this construct
