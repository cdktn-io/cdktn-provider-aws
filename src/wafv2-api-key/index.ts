...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/wafv2_api_key
...
export class Wafv2ApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Wafv2ApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/wafv2_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/wafv2_api_key aws_wafv2_api_key} Resource
  *
  * @param scope The scope in which to define this construct
