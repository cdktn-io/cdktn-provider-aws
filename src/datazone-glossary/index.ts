...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/datazone_glossary
...
export class DatazoneGlossary extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneGlossary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/datazone_glossary#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/datazone_glossary aws_datazone_glossary} Resource
  *
  * @param scope The scope in which to define this construct
