...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/datazone_glossary
...
export class DatazoneGlossary extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneGlossary that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/datazone_glossary#import import section} in the documentation of this resource for the id to use
