...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kendra_experience
...
export class KendraExperience extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KendraExperience that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kendra_experience#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kendra_experience aws_kendra_experience} Resource
  *
  * @param scope The scope in which to define this construct
