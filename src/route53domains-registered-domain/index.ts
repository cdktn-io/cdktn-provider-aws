...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/route53domains_registered_domain
...
export class Route53DomainsRegisteredDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53DomainsRegisteredDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/route53domains_registered_domain#import import section} in the documentation of this resource for the id to use
