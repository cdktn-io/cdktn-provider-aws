...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/finspace_kx_dataview
...
export class FinspaceKxDataview extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FinspaceKxDataview that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/finspace_kx_dataview#import import section} in the documentation of this resource for the id to use
