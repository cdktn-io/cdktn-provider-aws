...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/identitystore_group
...
export class DataAwsIdentitystoreGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIdentitystoreGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/data-sources/identitystore_group#import import section} in the documentation of this resource for the id to use
