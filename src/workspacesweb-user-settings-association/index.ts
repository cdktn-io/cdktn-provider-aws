...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/workspacesweb_user_settings_association
...
export class WorkspaceswebUserSettingsAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceswebUserSettingsAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/workspacesweb_user_settings_association#import import section} in the documentation of this resource for the id to use
