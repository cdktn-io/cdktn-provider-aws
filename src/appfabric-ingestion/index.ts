...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/appfabric_ingestion
...
export class AppfabricIngestion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppfabricIngestion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/appfabric_ingestion#import import section} in the documentation of this resource for the id to use
