...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/sagemaker_hub
...
export class SagemakerHub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/sagemaker_hub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/sagemaker_hub aws_sagemaker_hub} Resource
  *
  * @param scope The scope in which to define this construct
