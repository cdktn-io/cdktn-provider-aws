...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/opensearchserverless_collection_groups
...
export class DataAwsOpensearchserverlessCollectionGroups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOpensearchserverlessCollectionGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/opensearchserverless_collection_groups#import import section} in the documentation of this resource for the id to use
