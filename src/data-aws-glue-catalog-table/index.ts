...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/glue_catalog_table
...
export class DataAwsGlueCatalogTable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlueCatalogTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/glue_catalog_table#import import section} in the documentation of this resource for the id to use
