...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ec2_capacity_block_offering
...
export class DataAwsEc2CapacityBlockOffering extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2CapacityBlockOffering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ec2_capacity_block_offering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ec2_capacity_block_offering aws_ec2_capacity_block_offering} Data Source
  *
  * @param scope The scope in which to define this construct
