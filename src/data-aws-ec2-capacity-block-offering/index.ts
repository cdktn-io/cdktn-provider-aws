...
// https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/ec2_capacity_block_offering
...
export class DataAwsEc2CapacityBlockOffering extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2CapacityBlockOffering that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/ec2_capacity_block_offering#import import section} in the documentation of this resource for the id to use
