...
// https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/ec2_public_ipv4_pool
...
export class DataAwsEc2PublicIpv4Pool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2PublicIpv4Pool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/ec2_public_ipv4_pool#import import section} in the documentation of this resource for the id to use
