...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/inspector2_member_association
...
export class Inspector2MemberAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Inspector2MemberAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/inspector2_member_association#import import section} in the documentation of this resource for the id to use
