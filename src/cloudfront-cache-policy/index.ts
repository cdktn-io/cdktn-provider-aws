...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/cloudfront_cache_policy
...
export class CloudfrontCachePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontCachePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/cloudfront_cache_policy#import import section} in the documentation of this resource for the id to use
