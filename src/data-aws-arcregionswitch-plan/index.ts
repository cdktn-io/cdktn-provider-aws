...
// https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/arcregionswitch_plan
...
export class DataAwsArcregionswitchPlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsArcregionswitchPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/arcregionswitch_plan#import import section} in the documentation of this resource for the id to use
