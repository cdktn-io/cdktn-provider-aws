...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkmanager_connect_attachment
...
export class NetworkmanagerConnectAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerConnectAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/networkmanager_connect_attachment#import import section} in the documentation of this resource for the id to use
