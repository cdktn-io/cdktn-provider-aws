...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/sagemaker_flow_definition
...
export class SagemakerFlowDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerFlowDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/sagemaker_flow_definition#import import section} in the documentation of this resource for the id to use
