...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/cloudwatch_event_endpoint
...
export class CloudwatchEventEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchEventEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/cloudwatch_event_endpoint#import import section} in the documentation of this resource for the id to use
