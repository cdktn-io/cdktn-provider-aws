...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/s3control_access_points
...
export class DataAwsS3ControlAccessPoints extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsS3ControlAccessPoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/s3control_access_points#import import section} in the documentation of this resource for the id to use
