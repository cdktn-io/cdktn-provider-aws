...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/iam_saml_provider
...
export class IamSamlProvider extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamSamlProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/iam_saml_provider#import import section} in the documentation of this resource for the id to use
