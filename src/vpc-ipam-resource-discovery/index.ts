...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_ipam_resource_discovery
...
export interface VpcIpamResourceDiscoveryOrganizationalUnitExclusion {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_ipam_resource_discovery#organizations_entity_path VpcIpamResourceDiscovery#organizations_entity_path}
  */
...
export class VpcIpamResourceDiscovery extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamResourceDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_ipam_resource_discovery#import import section} in the documentation of this resource for the id to use
