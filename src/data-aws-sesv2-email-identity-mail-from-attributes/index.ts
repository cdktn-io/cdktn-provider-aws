...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/sesv2_email_identity_mail_from_attributes
...
export class DataAwsSesv2EmailIdentityMailFromAttributes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSesv2EmailIdentityMailFromAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/data-sources/sesv2_email_identity_mail_from_attributes#import import section} in the documentation of this resource for the id to use
