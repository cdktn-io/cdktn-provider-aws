...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/service_discovery_instance
...
export class ServiceDiscoveryInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDiscoveryInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/service_discovery_instance#import import section} in the documentation of this resource for the id to use
