...
// https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_group_policy_attachments_exclusive
...
export class IamGroupPolicyAttachmentsExclusive extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroupPolicyAttachmentsExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/iam_group_policy_attachments_exclusive#import import section} in the documentation of this resource for the id to use
