...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/iam_group_policy_attachments_exclusive
...
export class IamGroupPolicyAttachmentsExclusive extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroupPolicyAttachmentsExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/iam_group_policy_attachments_exclusive#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/iam_group_policy_attachments_exclusive aws_iam_group_policy_attachments_exclusive} Resource
  *
  * @param scope The scope in which to define this construct
