...
// https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/glue_catalog
...
export class DataAwsGlueCatalog extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlueCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/glue_catalog#import import section} in the documentation of this resource for the id to use
