...
// https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/medialive_input
...
export interface DataAwsMedialiveInputConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/medialive_input#id DataAwsMedialiveInput#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/medialive_input#region DataAwsMedialiveInput#region}
  */
...
export class DataAwsMedialiveInputDestinationsVpcOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsMedialiveInputDestinationsVpc | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsMedialiveInputDestinationsVpc | undefined) {
    if (value === undefined) {
...
export class DataAwsMedialiveInputDestinationsVpcList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsMedialiveInputDestinationsVpcOutputReference {
    return new DataAwsMedialiveInputDestinationsVpcOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsMedialiveInputDestinationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsMedialiveInputDestinations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsMedialiveInputDestinations | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _vpc = new DataAwsMedialiveInputDestinationsVpcList(this, "vpc", false);
  public get vpc() {
    return this._vpc;
  }
}
...
export class DataAwsMedialiveInputDestinationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsMedialiveInputDestinationsOutputReference {
    return new DataAwsMedialiveInputDestinationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsMedialiveInputInputDevicesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsMedialiveInputInputDevices | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsMedialiveInputInputDevices | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsMedialiveInputInputDevicesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsMedialiveInputInputDevicesOutputReference {
    return new DataAwsMedialiveInputInputDevicesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsMedialiveInputMediaConnectFlowsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsMedialiveInputMediaConnectFlows | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsMedialiveInputMediaConnectFlows | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsMedialiveInputMediaConnectFlowsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsMedialiveInputMediaConnectFlowsOutputReference {
    return new DataAwsMedialiveInputMediaConnectFlowsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsMedialiveInputSourcesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAwsMedialiveInputSources | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsMedialiveInputSources | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsMedialiveInputSourcesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAwsMedialiveInputSourcesOutputReference {
    return new DataAwsMedialiveInputSourcesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/medialive_input aws_medialive_input}
*/
export class DataAwsMedialiveInput extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMedialiveInput that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/medialive_input#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/medialive_input aws_medialive_input} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _destinations = new DataAwsMedialiveInputDestinationsList(this, "destinations", false);
  ...
  private _inputDevices = new DataAwsMedialiveInputInputDevicesList(this, "input_devices", false);
  ...
  private _mediaConnectFlows = new DataAwsMedialiveInputMediaConnectFlowsList(this, "media_connect_flows", false);
  ...
  private _sources = new DataAwsMedialiveInputSourcesList(this, "sources", false);
  public get sources() {
