...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/waf_xss_match_set
...
export class WafXssMatchSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafXssMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/waf_xss_match_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/waf_xss_match_set aws_waf_xss_match_set} Resource
  *
  * @param scope The scope in which to define this construct
