...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/redshift_cluster_snapshot
...
export class RedshiftClusterSnapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftClusterSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/redshift_cluster_snapshot#import import section} in the documentation of this resource for the id to use
