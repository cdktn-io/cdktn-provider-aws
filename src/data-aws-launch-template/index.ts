...
// https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/launch_template
...
export class DataAwsLaunchTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLaunchTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.40.0/docs/data-sources/launch_template#import import section} in the documentation of this resource for the id to use
