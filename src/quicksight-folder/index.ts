...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/quicksight_folder
...
export class QuicksightFolder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/quicksight_folder#import import section} in the documentation of this resource for the id to use
