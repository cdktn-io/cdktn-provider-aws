...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudsearch_domain
...
export class CloudsearchDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudsearchDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudsearch_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudsearch_domain aws_cloudsearch_domain} Resource
  *
  * @param scope The scope in which to define this construct
