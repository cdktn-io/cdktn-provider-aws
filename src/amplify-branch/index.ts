...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/amplify_branch
...
export class AmplifyBranch extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AmplifyBranch that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/amplify_branch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/amplify_branch aws_amplify_branch} Resource
  *
  * @param scope The scope in which to define this construct
