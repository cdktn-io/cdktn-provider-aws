...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ssoadmin_application_access_scope
...
export class SsoadminApplicationAccessScope extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoadminApplicationAccessScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ssoadmin_application_access_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/ssoadmin_application_access_scope aws_ssoadmin_application_access_scope} Resource
  *
  * @param scope The scope in which to define this construct
