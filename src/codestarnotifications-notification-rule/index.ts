...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/codestarnotifications_notification_rule
...
export class CodestarnotificationsNotificationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodestarnotificationsNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/codestarnotifications_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/codestarnotifications_notification_rule aws_codestarnotifications_notification_rule} Resource
  *
  * @param scope The scope in which to define this construct
