...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/ce_cost_category
...
export class CeCostCategory extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CeCostCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/ce_cost_category#import import section} in the documentation of this resource for the id to use
