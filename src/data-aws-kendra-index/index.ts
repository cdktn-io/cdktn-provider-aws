...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/kendra_index
...
export class DataAwsKendraIndex extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKendraIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/kendra_index#import import section} in the documentation of this resource for the id to use
