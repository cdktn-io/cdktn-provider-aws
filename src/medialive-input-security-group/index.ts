...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/medialive_input_security_group
...
export interface MedialiveInputSecurityGroupWhitelistRules {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/medialive_input_security_group#cidr MedialiveInputSecurityGroup#cidr}
  */
...
export class MedialiveInputSecurityGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MedialiveInputSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/medialive_input_security_group#import import section} in the documentation of this resource for the id to use
