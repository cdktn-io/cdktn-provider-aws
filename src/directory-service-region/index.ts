...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/directory_service_region
...
export class DirectoryServiceRegion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/directory_service_region#import import section} in the documentation of this resource for the id to use
