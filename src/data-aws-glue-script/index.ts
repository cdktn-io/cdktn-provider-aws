...
// https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/glue_script
...
export class DataAwsGlueScript extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlueScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/glue_script#import import section} in the documentation of this resource for the id to use
