...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/ec2_secondary_network
...
export class Ec2SecondaryNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SecondaryNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/ec2_secondary_network#import import section} in the documentation of this resource for the id to use
