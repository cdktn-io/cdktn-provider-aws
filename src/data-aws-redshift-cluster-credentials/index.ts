...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/data-sources/redshift_cluster_credentials
...
export class DataAwsRedshiftClusterCredentials extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRedshiftClusterCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/data-sources/redshift_cluster_credentials#import import section} in the documentation of this resource for the id to use
