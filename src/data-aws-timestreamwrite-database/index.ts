...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/timestreamwrite_database
...
export class DataAwsTimestreamwriteDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsTimestreamwriteDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/timestreamwrite_database#import import section} in the documentation of this resource for the id to use
