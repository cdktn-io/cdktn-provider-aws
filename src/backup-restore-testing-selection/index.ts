...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/backup_restore_testing_selection
...
export class BackupRestoreTestingSelection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupRestoreTestingSelection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/backup_restore_testing_selection#import import section} in the documentation of this resource for the id to use
