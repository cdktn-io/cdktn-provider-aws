...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/iot_thing_group_membership
...
export class IotThingGroupMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IotThingGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/iot_thing_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/iot_thing_group_membership aws_iot_thing_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
