...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/sagemaker_model_card_export_job
...
export class SagemakerModelCardExportJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SagemakerModelCardExportJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/sagemaker_model_card_export_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/sagemaker_model_card_export_job aws_sagemaker_model_card_export_job} Resource
  *
  * @param scope The scope in which to define this construct
