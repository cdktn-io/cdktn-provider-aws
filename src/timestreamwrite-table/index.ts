...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/timestreamwrite_table
...
export class TimestreamwriteTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TimestreamwriteTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/timestreamwrite_table#import import section} in the documentation of this resource for the id to use
