...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/imagebuilder_workflow
...
export class ImagebuilderWorkflow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ImagebuilderWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/imagebuilder_workflow#import import section} in the documentation of this resource for the id to use
