...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/dynamodb_table
...
export class DataAwsDynamodbTable extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDynamodbTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/dynamodb_table#import import section} in the documentation of this resource for the id to use
