...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/odb_iam_role_association
...
export class DataAwsOdbIamRoleAssociation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbIamRoleAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/data-sources/odb_iam_role_association#import import section} in the documentation of this resource for the id to use
