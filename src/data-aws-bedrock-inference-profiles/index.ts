...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/bedrock_inference_profiles
...
export class DataAwsBedrockInferenceProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBedrockInferenceProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/bedrock_inference_profiles#import import section} in the documentation of this resource for the id to use
