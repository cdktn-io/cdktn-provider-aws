...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/kendra_thesaurus
...
export class DataAwsKendraThesaurus extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKendraThesaurus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/kendra_thesaurus#import import section} in the documentation of this resource for the id to use
