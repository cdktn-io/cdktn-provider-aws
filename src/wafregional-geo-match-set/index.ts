...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/wafregional_geo_match_set
...
export class WafregionalGeoMatchSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalGeoMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/wafregional_geo_match_set#import import section} in the documentation of this resource for the id to use
