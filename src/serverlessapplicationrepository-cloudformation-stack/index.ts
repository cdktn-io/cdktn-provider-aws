...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/serverlessapplicationrepository_cloudformation_stack
...
export class ServerlessapplicationrepositoryCloudformationStack extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServerlessapplicationrepositoryCloudformationStack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/serverlessapplicationrepository_cloudformation_stack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/serverlessapplicationrepository_cloudformation_stack aws_serverlessapplicationrepository_cloudformation_stack} Resource
  *
  * @param scope The scope in which to define this construct
