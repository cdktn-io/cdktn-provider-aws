...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/lb_trust_store
...
export class DataAwsLbTrustStore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLbTrustStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/lb_trust_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/lb_trust_store aws_lb_trust_store} Data Source
  *
  * @param scope The scope in which to define this construct
