...
// https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/redshift_usage_limit
...
export class RedshiftUsageLimit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftUsageLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/redshift_usage_limit#import import section} in the documentation of this resource for the id to use
