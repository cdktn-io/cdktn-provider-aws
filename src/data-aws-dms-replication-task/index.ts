...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/dms_replication_task
...
export class DataAwsDmsReplicationTask extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDmsReplicationTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/dms_replication_task#import import section} in the documentation of this resource for the id to use
