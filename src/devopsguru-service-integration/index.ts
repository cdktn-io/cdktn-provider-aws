...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/devopsguru_service_integration
...
export class DevopsguruServiceIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevopsguruServiceIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/devopsguru_service_integration#import import section} in the documentation of this resource for the id to use
