...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/data-sources/apigatewayv2_export
...
export class DataAwsApigatewayv2Export extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApigatewayv2Export that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/data-sources/apigatewayv2_export#import import section} in the documentation of this resource for the id to use
