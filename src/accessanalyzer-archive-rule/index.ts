...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/accessanalyzer_archive_rule
...
export class AccessanalyzerArchiveRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessanalyzerArchiveRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/accessanalyzer_archive_rule#import import section} in the documentation of this resource for the id to use
