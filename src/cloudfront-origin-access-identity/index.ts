...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/cloudfront_origin_access_identity
...
export class CloudfrontOriginAccessIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontOriginAccessIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/cloudfront_origin_access_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/cloudfront_origin_access_identity aws_cloudfront_origin_access_identity} Resource
  *
  * @param scope The scope in which to define this construct
