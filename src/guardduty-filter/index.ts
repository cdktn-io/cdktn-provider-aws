...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/guardduty_filter
...
export class GuarddutyFilter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GuarddutyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/guardduty_filter#import import section} in the documentation of this resource for the id to use
