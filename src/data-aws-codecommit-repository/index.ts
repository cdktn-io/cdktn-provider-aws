...
// https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/codecommit_repository
...
export class DataAwsCodecommitRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCodecommitRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/codecommit_repository#import import section} in the documentation of this resource for the id to use
