...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/networkmanager_devices
...
export class DataAwsNetworkmanagerDevices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsNetworkmanagerDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/networkmanager_devices#import import section} in the documentation of this resource for the id to use
