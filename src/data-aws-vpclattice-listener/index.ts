...
// https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/vpclattice_listener
...
export class DataAwsVpclatticeListener extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpclatticeListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
