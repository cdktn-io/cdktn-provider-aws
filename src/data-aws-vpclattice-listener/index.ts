...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/vpclattice_listener
...
export class DataAwsVpclatticeListener extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpclatticeListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/vpclattice_listener aws_vpclattice_listener} Data Source
  *
  * @param scope The scope in which to define this construct
