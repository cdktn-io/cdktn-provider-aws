...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/notifications_notification_hub
...
export class NotificationsNotificationHub extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationsNotificationHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/notifications_notification_hub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/notifications_notification_hub aws_notifications_notification_hub} Resource
  *
  * @param scope The scope in which to define this construct
