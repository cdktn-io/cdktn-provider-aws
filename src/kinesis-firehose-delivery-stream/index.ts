...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/kinesis_firehose_delivery_stream
...
export class KinesisFirehoseDeliveryStream extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisFirehoseDeliveryStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/kinesis_firehose_delivery_stream#import import section} in the documentation of this resource for the id to use
