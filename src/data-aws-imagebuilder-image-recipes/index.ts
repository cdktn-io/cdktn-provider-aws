...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/imagebuilder_image_recipes
...
export class DataAwsImagebuilderImageRecipes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsImagebuilderImageRecipes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/imagebuilder_image_recipes#import import section} in the documentation of this resource for the id to use
