...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/datazone_environment_blueprint_configuration
...
export class DatazoneEnvironmentBlueprintConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneEnvironmentBlueprintConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/datazone_environment_blueprint_configuration#import import section} in the documentation of this resource for the id to use
