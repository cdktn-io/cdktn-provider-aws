...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/workmail_group
...
export class WorkmailGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkmailGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/workmail_group#import import section} in the documentation of this resource for the id to use
