...
// https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/storagegateway_cached_iscsi_volume
...
export class StoragegatewayCachedIscsiVolume extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StoragegatewayCachedIscsiVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.56.0/docs/resources/storagegateway_cached_iscsi_volume#import import section} in the documentation of this resource for the id to use
