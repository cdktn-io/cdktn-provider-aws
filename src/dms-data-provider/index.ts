...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dms_data_provider
...
export class DmsDataProvider extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsDataProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/dms_data_provider#import import section} in the documentation of this resource for the id to use
