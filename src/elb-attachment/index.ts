...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/elb_attachment
...
export class ElbAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElbAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/elb_attachment#import import section} in the documentation of this resource for the id to use
