...
// https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/mq_broker_engine_types
...
export class DataAwsMqBrokerEngineTypes extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMqBrokerEngineTypes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/mq_broker_engine_types#import import section} in the documentation of this resource for the id to use
