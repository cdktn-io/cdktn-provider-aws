...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/ssm_resource_data_sync
...
export class SsmResourceDataSync extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmResourceDataSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/ssm_resource_data_sync#import import section} in the documentation of this resource for the id to use
