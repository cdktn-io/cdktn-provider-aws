...
export class DataAwsWafregionalRateBasedRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafregionalRateBasedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/wafregional_rate_based_rule#import import section} in the documentation of this resource for the id to use
