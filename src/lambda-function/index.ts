...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/lambda_function
...
export class LambdaFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LambdaFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/resources/lambda_function#import import section} in the documentation of this resource for the id to use
