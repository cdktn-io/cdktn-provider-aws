...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/iam_user_policies_exclusive
...
export class IamUserPoliciesExclusive extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamUserPoliciesExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/iam_user_policies_exclusive#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/iam_user_policies_exclusive aws_iam_user_policies_exclusive} Resource
  *
  * @param scope The scope in which to define this construct
