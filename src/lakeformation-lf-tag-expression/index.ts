...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lakeformation_lf_tag_expression
...
export class LakeformationLfTagExpression extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LakeformationLfTagExpression that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/lakeformation_lf_tag_expression#import import section} in the documentation of this resource for the id to use
