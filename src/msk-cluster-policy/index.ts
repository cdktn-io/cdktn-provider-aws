...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/msk_cluster_policy
...
export interface MskClusterPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/msk_cluster_policy#cluster_arn MskClusterPolicy#cluster_arn}
  */
  readonly clusterArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/msk_cluster_policy#id MskClusterPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/msk_cluster_policy#policy MskClusterPolicy#policy}
  */
...
export class MskClusterPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskClusterPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/msk_cluster_policy#import import section} in the documentation of this resource for the id to use
