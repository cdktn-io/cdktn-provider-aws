...
// https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/msk_cluster_policy
...
export class MskClusterPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MskClusterPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/msk_cluster_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/msk_cluster_policy aws_msk_cluster_policy} Resource
  *
  * @param scope The scope in which to define this construct
