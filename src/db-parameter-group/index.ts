...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/db_parameter_group
...
export class DbParameterGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/db_parameter_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/db_parameter_group aws_db_parameter_group} Resource
  *
  * @param scope The scope in which to define this construct
