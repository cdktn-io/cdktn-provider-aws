...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/db_parameter_group
...
export class DbParameterGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/db_parameter_group#import import section} in the documentation of this resource for the id to use
