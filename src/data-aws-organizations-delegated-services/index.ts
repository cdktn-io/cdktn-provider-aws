...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/organizations_delegated_services
...
export class DataAwsOrganizationsDelegatedServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsDelegatedServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/organizations_delegated_services#import import section} in the documentation of this resource for the id to use
