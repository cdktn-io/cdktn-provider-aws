...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/ec2_transit_gateway_multicast_domain
...
export class DataAwsEc2TransitGatewayMulticastDomain extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2TransitGatewayMulticastDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/ec2_transit_gateway_multicast_domain#import import section} in the documentation of this resource for the id to use
