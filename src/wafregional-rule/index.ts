...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/wafregional_rule
...
export class WafregionalRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/wafregional_rule#import import section} in the documentation of this resource for the id to use
