...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/pinpoint_apns_sandbox_channel
...
export class PinpointApnsSandboxChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PinpointApnsSandboxChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/pinpoint_apns_sandbox_channel#import import section} in the documentation of this resource for the id to use
