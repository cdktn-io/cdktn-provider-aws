...
// https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/iam_session_context
...
export class DataAwsIamSessionContext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamSessionContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/iam_session_context#import import section} in the documentation of this resource for the id to use
