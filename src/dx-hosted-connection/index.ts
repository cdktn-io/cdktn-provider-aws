...
// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dx_hosted_connection
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dx_hosted_connection aws_dx_hosted_connection}
*/
export class DxHostedConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DxHostedConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dx_hosted_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/resources/dx_hosted_connection aws_dx_hosted_connection} Resource
  *
  * @param scope The scope in which to define this construct
