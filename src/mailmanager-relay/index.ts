...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/mailmanager_relay
...
export class MailmanagerRelay extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MailmanagerRelay that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/mailmanager_relay#import import section} in the documentation of this resource for the id to use
