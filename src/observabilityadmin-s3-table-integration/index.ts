...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/observabilityadmin_s3_table_integration
...
export class ObservabilityadminS3TableIntegration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ObservabilityadminS3TableIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/observabilityadmin_s3_table_integration#import import section} in the documentation of this resource for the id to use
