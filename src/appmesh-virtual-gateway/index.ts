...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/appmesh_virtual_gateway
...
export class AppmeshVirtualGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppmeshVirtualGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/appmesh_virtual_gateway#import import section} in the documentation of this resource for the id to use
