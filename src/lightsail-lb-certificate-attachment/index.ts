...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/lightsail_lb_certificate_attachment
...
export class LightsailLbCertificateAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailLbCertificateAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/lightsail_lb_certificate_attachment#import import section} in the documentation of this resource for the id to use
