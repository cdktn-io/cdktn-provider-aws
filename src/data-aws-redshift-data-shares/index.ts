...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_data_shares
...
export interface DataAwsRedshiftDataSharesConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_data_shares#region DataAwsRedshiftDataShares#region}
  */
...
export class DataAwsRedshiftDataSharesDataSharesOutputReference extends cdktn.ComplexObject {
...
export class DataAwsRedshiftDataSharesDataSharesList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_data_shares aws_redshift_data_shares}
*/
export class DataAwsRedshiftDataShares extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRedshiftDataShares that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_data_shares#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/redshift_data_shares aws_redshift_data_shares} Data Source
  *
  * @param scope The scope in which to define this construct
