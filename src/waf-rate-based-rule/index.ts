...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/waf_rate_based_rule
...
export class WafRateBasedRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafRateBasedRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/waf_rate_based_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/waf_rate_based_rule aws_waf_rate_based_rule} Resource
  *
  * @param scope The scope in which to define this construct
