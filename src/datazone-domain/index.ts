...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/datazone_domain
...
export class DatazoneDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatazoneDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/datazone_domain#import import section} in the documentation of this resource for the id to use
