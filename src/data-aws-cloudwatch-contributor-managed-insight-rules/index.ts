...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/cloudwatch_contributor_managed_insight_rules
...
export class DataAwsCloudwatchContributorManagedInsightRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCloudwatchContributorManagedInsightRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/cloudwatch_contributor_managed_insight_rules#import import section} in the documentation of this resource for the id to use
