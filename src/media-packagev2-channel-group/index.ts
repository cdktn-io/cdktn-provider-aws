...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/media_packagev2_channel_group
...
export class MediaPackagev2ChannelGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaPackagev2ChannelGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/media_packagev2_channel_group#import import section} in the documentation of this resource for the id to use
