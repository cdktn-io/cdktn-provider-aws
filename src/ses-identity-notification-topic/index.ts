...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/ses_identity_notification_topic
...
export class SesIdentityNotificationTopic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SesIdentityNotificationTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/ses_identity_notification_topic#import import section} in the documentation of this resource for the id to use
