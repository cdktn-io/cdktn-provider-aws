...
// https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/ec2_local_gateway_route_table_virtual_interface_group_association
...
export class Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2LocalGatewayRouteTableVirtualInterfaceGroupAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.52.0/docs/resources/ec2_local_gateway_route_table_virtual_interface_group_association#import import section} in the documentation of this resource for the id to use
