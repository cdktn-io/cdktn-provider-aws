...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/servicequotas_template_association
...
export class ServicequotasTemplateAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicequotasTemplateAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/servicequotas_template_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/servicequotas_template_association aws_servicequotas_template_association} Resource
  *
  * @param scope The scope in which to define this construct
