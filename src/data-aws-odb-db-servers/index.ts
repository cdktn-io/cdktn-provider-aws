...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/odb_db_servers
...
export class DataAwsOdbDbServers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbDbServers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/odb_db_servers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/data-sources/odb_db_servers aws_odb_db_servers} Data Source
  *
  * @param scope The scope in which to define this construct
