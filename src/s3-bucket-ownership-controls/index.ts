...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/s3_bucket_ownership_controls
...
export class S3BucketOwnershipControls extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3BucketOwnershipControls that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/s3_bucket_ownership_controls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/s3_bucket_ownership_controls aws_s3_bucket_ownership_controls} Resource
  *
  * @param scope The scope in which to define this construct
