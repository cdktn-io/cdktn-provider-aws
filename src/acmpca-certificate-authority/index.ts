...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/acmpca_certificate_authority
...
export class AcmpcaCertificateAuthority extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AcmpcaCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/acmpca_certificate_authority#import import section} in the documentation of this resource for the id to use
