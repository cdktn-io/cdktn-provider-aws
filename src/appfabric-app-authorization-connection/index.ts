...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appfabric_app_authorization_connection
...
export class AppfabricAppAuthorizationConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppfabricAppAuthorizationConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appfabric_app_authorization_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/appfabric_app_authorization_connection aws_appfabric_app_authorization_connection} Resource
  *
  * @param scope The scope in which to define this construct
