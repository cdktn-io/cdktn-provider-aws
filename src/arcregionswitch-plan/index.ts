...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/arcregionswitch_plan
...
export class ArcregionswitchPlan extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ArcregionswitchPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/arcregionswitch_plan#import import section} in the documentation of this resource for the id to use
