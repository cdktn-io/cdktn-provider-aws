...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper
...
export interface PrometheusScraperConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly exporter?: PrometheusScraperExporter[] | cdktn.IResolvable;
  /**
...
export interface PrometheusScraperDestinationCloudwatch {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper#dataset_arn PrometheusScraper#dataset_arn}
  */
  readonly datasetArn: string;
}

export function prometheusScraperDestinationCloudwatchToTerraform(struct?: PrometheusScraperDestinationCloudwatch | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function prometheusScraperDestinationCloudwatchToHclTerraform(struct?: PrometheusScraperDestinationCloudwatch | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class PrometheusScraperDestinationCloudwatchOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): PrometheusScraperDestinationCloudwatch | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PrometheusScraperDestinationCloudwatch | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PrometheusScraperDestinationCloudwatchList extends cdktn.ComplexList {
  public internalValue? : PrometheusScraperDestinationCloudwatch[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PrometheusScraperDestinationCloudwatchOutputReference {
    return new PrometheusScraperDestinationCloudwatchOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PrometheusScraperDestination {
  ...
  */
  readonly cloudwatch?: PrometheusScraperDestinationCloudwatch[] | cdktn.IResolvable;
}
...
export function prometheusScraperDestinationToTerraform(struct?: PrometheusScraperDestination | cdktn.IResolvable): any {
  ...
  return {
    ...
    cloudwatch: cdktn.listMapper(prometheusScraperDestinationCloudwatchToTerraform, true)(struct!.cloudwatch),
  }
}
...
export function prometheusScraperDestinationToHclTerraform(struct?: PrometheusScraperDestination | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    cloudwatch: {
      value: cdktn.listMapperHcl(prometheusScraperDestinationCloudwatchToHclTerraform, true)(struct!.cloudwatch),
      isBlock: true,
      type: "list",
      storageClassType: "PrometheusScraperDestinationCloudwatchList",
    },
  };
...
export class PrometheusScraperDestinationOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _cloudwatch = new PrometheusScraperDestinationCloudwatchList(this, "cloudwatch", false);
  public get cloudwatch() {
    return this._cloudwatch;
  }
  public putCloudwatch(value: PrometheusScraperDestinationCloudwatch[] | cdktn.IResolvable) {
...
export interface PrometheusScraperExporterOpensearch {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper#domain_arn PrometheusScraper#domain_arn}
  */
  readonly domainArn: string;
}

export function prometheusScraperExporterOpensearchToTerraform(struct?: PrometheusScraperExporterOpensearch | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function prometheusScraperExporterOpensearchToHclTerraform(struct?: PrometheusScraperExporterOpensearch | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class PrometheusScraperExporterOpensearchOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): PrometheusScraperExporterOpensearch | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PrometheusScraperExporterOpensearch | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PrometheusScraperExporterOpensearchList extends cdktn.ComplexList {
  public internalValue? : PrometheusScraperExporterOpensearch[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PrometheusScraperExporterOpensearchOutputReference {
    return new PrometheusScraperExporterOpensearchOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PrometheusScraperExporter {
  /**
  * opensearch block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper#opensearch PrometheusScraper#opensearch}
  */
  readonly opensearch?: PrometheusScraperExporterOpensearch[] | cdktn.IResolvable;
}

export function prometheusScraperExporterToTerraform(struct?: PrometheusScraperExporter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    opensearch: cdktn.listMapper(prometheusScraperExporterOpensearchToTerraform, true)(struct!.opensearch),
  }
}


export function prometheusScraperExporterToHclTerraform(struct?: PrometheusScraperExporter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    opensearch: {
      value: cdktn.listMapperHcl(prometheusScraperExporterOpensearchToHclTerraform, true)(struct!.opensearch),
      isBlock: true,
      type: "list",
      storageClassType: "PrometheusScraperExporterOpensearchList",
    },
  };
...
export class PrometheusScraperExporterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): PrometheusScraperExporter | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PrometheusScraperExporter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _opensearch = new PrometheusScraperExporterOpensearchList(this, "opensearch", false);
  public get opensearch() {
    return this._opensearch;
  }
  public putOpensearch(value: PrometheusScraperExporterOpensearch[] | cdktn.IResolvable) {
...
export class PrometheusScraperExporterList extends cdktn.ComplexList {
  public internalValue? : PrometheusScraperExporter[] | cdktn.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): PrometheusScraperExporterOutputReference {
    return new PrometheusScraperExporterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface PrometheusScraperRoleConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper#source_role_arn PrometheusScraper#source_role_arn}
  */
  readonly sourceRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper#target_role_arn PrometheusScraper#target_role_arn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper aws_prometheus_scraper}
*/
export class PrometheusScraper extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrometheusScraper that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/prometheus_scraper aws_prometheus_scraper} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _exporter = new PrometheusScraperExporterList(this, "exporter", false);
  public get exporter() {
    return this._exporter;
  }
  public putExporter(value: PrometheusScraperExporter[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      exporter: cdktn.listMapper(prometheusScraperExporterToTerraform, true)(this._exporter.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      exporter: {
        value: cdktn.listMapperHcl(prometheusScraperExporterToHclTerraform, true)(this._exporter.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PrometheusScraperExporterList",
      },
      role_configuration: {
