...
export class NetworkmanagerAttachmentRoutingPolicyLabel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerAttachmentRoutingPolicyLabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/networkmanager_attachment_routing_policy_label#import import section} in the documentation of this resource for the id to use
