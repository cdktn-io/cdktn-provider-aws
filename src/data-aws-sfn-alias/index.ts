...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/sfn_alias
...
export class DataAwsSfnAlias extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSfnAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/sfn_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/sfn_alias aws_sfn_alias} Data Source
  *
  * @param scope The scope in which to define this construct
