...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/odb_cloud_exadata_infrastructure
...
export class OdbCloudExadataInfrastructure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OdbCloudExadataInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/odb_cloud_exadata_infrastructure#import import section} in the documentation of this resource for the id to use
