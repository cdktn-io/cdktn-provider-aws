...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/config_organization_custom_rule
...
export class ConfigOrganizationCustomRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigOrganizationCustomRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/config_organization_custom_rule#import import section} in the documentation of this resource for the id to use
