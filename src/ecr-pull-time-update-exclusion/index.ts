...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ecr_pull_time_update_exclusion
...
export class EcrPullTimeUpdateExclusion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcrPullTimeUpdateExclusion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/ecr_pull_time_update_exclusion#import import section} in the documentation of this resource for the id to use
