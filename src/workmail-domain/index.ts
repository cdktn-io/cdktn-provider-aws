...
// https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/workmail_domain
...
export class WorkmailDomain extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkmailDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/resources/workmail_domain#import import section} in the documentation of this resource for the id to use
