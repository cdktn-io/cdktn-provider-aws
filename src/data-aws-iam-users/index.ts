...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/iam_users
...
export class DataAwsIamUsers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/data-sources/iam_users#import import section} in the documentation of this resource for the id to use
