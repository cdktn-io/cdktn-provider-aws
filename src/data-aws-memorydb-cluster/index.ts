...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/data-sources/memorydb_cluster
...
export class DataAwsMemorydbCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMemorydbCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/data-sources/memorydb_cluster#import import section} in the documentation of this resource for the id to use
