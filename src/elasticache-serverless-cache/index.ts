...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/elasticache_serverless_cache
...
export class ElasticacheServerlessCache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheServerlessCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/elasticache_serverless_cache#import import section} in the documentation of this resource for the id to use
