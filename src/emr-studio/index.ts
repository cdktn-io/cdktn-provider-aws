...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/emr_studio
...
export class EmrStudio extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmrStudio that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/emr_studio#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/emr_studio aws_emr_studio} Resource
  *
  * @param scope The scope in which to define this construct
