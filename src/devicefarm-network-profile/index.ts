...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/devicefarm_network_profile
...
export class DevicefarmNetworkProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DevicefarmNetworkProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/devicefarm_network_profile#import import section} in the documentation of this resource for the id to use
