...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/alb_target_group
...
export class DataAwsAlbTargetGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAlbTargetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/alb_target_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/alb_target_group aws_alb_target_group} Data Source
  *
  * @param scope The scope in which to define this construct
