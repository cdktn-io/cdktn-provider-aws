...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/alb_target_group
...
export class DataAwsAlbTargetGroupHealthCheckOutputReference extends cdktn.ComplexObject {
...
export class DataAwsAlbTargetGroupHealthCheckList extends cdktn.ComplexList {
...
export class DataAwsAlbTargetGroupStickinessOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsAlbTargetGroupStickinessList extends cdktn.ComplexList {
...
export function dataAwsAlbTargetGroupTimeoutsToTerraform(struct?: DataAwsAlbTargetGroupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsAlbTargetGroupTimeoutsToHclTerraform(struct?: DataAwsAlbTargetGroupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsAlbTargetGroupTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsAlbTargetGroupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataAwsAlbTargetGroupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAwsAlbTargetGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAlbTargetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/alb_target_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/alb_target_group aws_alb_target_group} Data Source
  *
  * @param scope The scope in which to define this construct
