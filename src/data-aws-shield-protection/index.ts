...
// https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/shield_protection
...
export class DataAwsShieldProtection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsShieldProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/shield_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/data-sources/shield_protection aws_shield_protection} Data Source
  *
  * @param scope The scope in which to define this construct
