...
// https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/ec2_serial_console_access
...
export class Ec2SerialConsoleAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2SerialConsoleAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/resources/ec2_serial_console_access#import import section} in the documentation of this resource for the id to use
