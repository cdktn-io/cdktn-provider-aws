...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/db_snapshot_copy
...
export class DbSnapshotCopy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DbSnapshotCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/db_snapshot_copy#import import section} in the documentation of this resource for the id to use
