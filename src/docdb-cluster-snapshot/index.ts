...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/docdb_cluster_snapshot
...
export class DocdbClusterSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocdbClusterSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/docdb_cluster_snapshot#import import section} in the documentation of this resource for the id to use
