...
// https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect
...
export interface DataAwsConnectQuickConnectConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#id DataAwsConnectQuickConnect#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#instance_id DataAwsConnectQuickConnect#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#name DataAwsConnectQuickConnect#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#quick_connect_id DataAwsConnectQuickConnect#quick_connect_id}
  */
  readonly quickConnectId?: string;
  /**
  * Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the [provider configuration](https://registry.terraform.io/providers/hashicorp/aws/latest/docs#aws-configuration-reference).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#region DataAwsConnectQuickConnect#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#tags DataAwsConnectQuickConnect#tags}
  */
...
export class DataAwsConnectQuickConnectQuickConnectConfigPhoneConfigOutputReference extends cdktn.ComplexObject {
...
export class DataAwsConnectQuickConnectQuickConnectConfigPhoneConfigList extends cdktn.ComplexList {
...
export class DataAwsConnectQuickConnectQuickConnectConfigQueueConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsConnectQuickConnectQuickConnectConfigQueueConfigList extends cdktn.ComplexList {
...
export class DataAwsConnectQuickConnectQuickConnectConfigUserConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsConnectQuickConnectQuickConnectConfigUserConfigList extends cdktn.ComplexList {
...
export class DataAwsConnectQuickConnectQuickConnectConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsConnectQuickConnectQuickConnectConfigList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect aws_connect_quick_connect}
*/
export class DataAwsConnectQuickConnect extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsConnectQuickConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.34.0/docs/data-sources/connect_quick_connect aws_connect_quick_connect} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      quick_connect_id: cdktn.stringToTerraform(this._quickConnectId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      quick_connect_id: {
        value: cdktn.stringToHclTerraform(this._quickConnectId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
