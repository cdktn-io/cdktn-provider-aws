...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/security_group
...
export class SecurityGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/security_group#import import section} in the documentation of this resource for the id to use
