...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/route53recoverycontrolconfig_cluster
...
export class Route53RecoverycontrolconfigCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53RecoverycontrolconfigCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/route53recoverycontrolconfig_cluster#import import section} in the documentation of this resource for the id to use
