...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/quicksight_role_custom_permission
...
export class QuicksightRoleCustomPermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightRoleCustomPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/quicksight_role_custom_permission#import import section} in the documentation of this resource for the id to use
