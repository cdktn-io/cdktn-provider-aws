...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/elb
...
export class Elb extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Elb that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/resources/elb#import import section} in the documentation of this resource for the id to use
