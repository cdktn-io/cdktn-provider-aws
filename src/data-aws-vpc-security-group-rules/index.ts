...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/vpc_security_group_rules
...
export class DataAwsVpcSecurityGroupRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcSecurityGroupRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/vpc_security_group_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/vpc_security_group_rules aws_vpc_security_group_rules} Data Source
  *
  * @param scope The scope in which to define this construct
