...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/data-sources/ec2_spot_price
...
export class DataAwsEc2SpotPrice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2SpotPrice that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/data-sources/ec2_spot_price#import import section} in the documentation of this resource for the id to use
