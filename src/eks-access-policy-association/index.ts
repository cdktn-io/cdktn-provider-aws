...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/eks_access_policy_association
...
export class EksAccessPolicyAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EksAccessPolicyAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/eks_access_policy_association#import import section} in the documentation of this resource for the id to use
