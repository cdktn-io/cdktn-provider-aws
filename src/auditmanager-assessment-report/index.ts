...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/auditmanager_assessment_report
...
export class AuditmanagerAssessmentReport extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditmanagerAssessmentReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/auditmanager_assessment_report#import import section} in the documentation of this resource for the id to use
