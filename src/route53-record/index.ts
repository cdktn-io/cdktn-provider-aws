...
// https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/route53_record
...
export class Route53Record extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53Record that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.14.1/docs/resources/route53_record#import import section} in the documentation of this resource for the id to use
