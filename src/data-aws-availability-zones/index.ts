...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/availability_zones
...
export class DataAwsAvailabilityZones extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAvailabilityZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/data-sources/availability_zones#import import section} in the documentation of this resource for the id to use
