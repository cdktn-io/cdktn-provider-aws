...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/odb_cloud_vm_clusters
...
export class DataAwsOdbCloudVmClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOdbCloudVmClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/odb_cloud_vm_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/odb_cloud_vm_clusters aws_odb_cloud_vm_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
