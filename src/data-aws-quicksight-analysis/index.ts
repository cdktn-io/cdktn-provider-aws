...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/quicksight_analysis
...
export class DataAwsQuicksightAnalysis extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsQuicksightAnalysis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/quicksight_analysis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/data-sources/quicksight_analysis aws_quicksight_analysis} Data Source
  *
  * @param scope The scope in which to define this construct
