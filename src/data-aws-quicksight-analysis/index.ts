...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/quicksight_analysis
...
export class DataAwsQuicksightAnalysis extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsQuicksightAnalysis that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/quicksight_analysis#import import section} in the documentation of this resource for the id to use
