...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/iam_role_policies_exclusive
...
export class IamRolePoliciesExclusive extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRolePoliciesExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/iam_role_policies_exclusive#import import section} in the documentation of this resource for the id to use
