...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/wafregional_rule
...
export class DataAwsWafregionalRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafregionalRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/wafregional_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/wafregional_rule aws_wafregional_rule} Data Source
  *
  * @param scope The scope in which to define this construct
