...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/transfer_user
...
export class TransferUser extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/transfer_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/transfer_user aws_transfer_user} Resource
  *
  * @param scope The scope in which to define this construct
