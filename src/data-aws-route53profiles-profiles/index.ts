...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/data-sources/route53profiles_profiles
...
export class DataAwsRoute53ProfilesProfiles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRoute53ProfilesProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/data-sources/route53profiles_profiles#import import section} in the documentation of this resource for the id to use
