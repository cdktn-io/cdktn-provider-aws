...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/rds_cluster
...
export class DataAwsRdsCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRdsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/rds_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/rds_cluster aws_rds_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
