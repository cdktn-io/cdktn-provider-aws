...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/transfer_web_app
...
export class TransferWebApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/transfer_web_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/transfer_web_app aws_transfer_web_app} Resource
  *
  * @param scope The scope in which to define this construct
