...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/opensearch_outbound_connection
...
export class OpensearchOutboundConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchOutboundConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/opensearch_outbound_connection#import import section} in the documentation of this resource for the id to use
