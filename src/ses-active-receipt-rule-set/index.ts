...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/ses_active_receipt_rule_set
...
export class SesActiveReceiptRuleSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesActiveReceiptRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/ses_active_receipt_rule_set#import import section} in the documentation of this resource for the id to use
