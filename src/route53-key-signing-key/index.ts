...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/route53_key_signing_key
...
export class Route53KeySigningKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53KeySigningKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/route53_key_signing_key#import import section} in the documentation of this resource for the id to use
