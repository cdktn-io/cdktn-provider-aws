...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/ecs_service
...
export interface DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfiguration {
}

export function dataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationToTerraform(struct?: DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationToHclTerraform(struct?: DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationOutputReference {
    return new DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAwsEcsServiceDeploymentConfigurationLifecycleHookOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _timeoutConfiguration = new DataAwsEcsServiceDeploymentConfigurationLifecycleHookTimeoutConfigurationList(this, "timeout_configuration", false);
...
export class DataAwsEcsService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/ecs_service#import import section} in the documentation of this resource for the id to use
