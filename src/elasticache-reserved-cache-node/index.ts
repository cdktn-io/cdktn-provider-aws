...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/elasticache_reserved_cache_node
...
export class ElasticacheReservedCacheNode extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticacheReservedCacheNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/elasticache_reserved_cache_node#import import section} in the documentation of this resource for the id to use
