...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/autoscaling_group_tag
...
export class AutoscalingGroupTagA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AutoscalingGroupTagA that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/autoscaling_group_tag#import import section} in the documentation of this resource for the id to use
