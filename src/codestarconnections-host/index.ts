...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/codestarconnections_host
...
export class CodestarconnectionsHost extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodestarconnectionsHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/codestarconnections_host#import import section} in the documentation of this resource for the id to use
