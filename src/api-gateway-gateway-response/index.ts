...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/api_gateway_gateway_response
...
export class ApiGatewayGatewayResponse extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayGatewayResponse that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/api_gateway_gateway_response#import import section} in the documentation of this resource for the id to use
