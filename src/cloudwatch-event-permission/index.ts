...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudwatch_event_permission
...
export class CloudwatchEventPermission extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchEventPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudwatch_event_permission#import import section} in the documentation of this resource for the id to use
