...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/appmesh_mesh
...
export class AppmeshMesh extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppmeshMesh that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/appmesh_mesh#import import section} in the documentation of this resource for the id to use
