...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/redshiftserverless_custom_domain_association
...
export class RedshiftserverlessCustomDomainAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftserverlessCustomDomainAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/redshiftserverless_custom_domain_association#import import section} in the documentation of this resource for the id to use
