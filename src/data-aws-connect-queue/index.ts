...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/connect_queue
...
export class DataAwsConnectQueue extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsConnectQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/connect_queue#import import section} in the documentation of this resource for the id to use
