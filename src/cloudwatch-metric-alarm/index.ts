...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudwatch_metric_alarm
...
export interface CloudwatchMetricAlarmConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly warmUpConfiguration?: CloudwatchMetricAlarmWarmUpConfiguration;
}
...
export interface CloudwatchMetricAlarmWarmUpConfiguration {
  /**
...
export function cloudwatchMetricAlarmWarmUpConfigurationToTerraform(struct?: CloudwatchMetricAlarmWarmUpConfigurationOutputReference | CloudwatchMetricAlarmWarmUpConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function cloudwatchMetricAlarmWarmUpConfigurationToHclTerraform(struct?: CloudwatchMetricAlarmWarmUpConfigurationOutputReference | CloudwatchMetricAlarmWarmUpConfiguration): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class CloudwatchMetricAlarmWarmUpConfigurationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): CloudwatchMetricAlarmWarmUpConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: CloudwatchMetricAlarmWarmUpConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  // only_start_evaluating_after_warm_up_period_ends - computed: false, optional: true, required: false
  ...
  // warm_up_period_duration_in_minutes - computed: false, optional: false, required: true
...
export class CloudwatchMetricAlarm extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchMetricAlarm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudwatch_metric_alarm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // warm_up_configuration - computed: false, optional: true, required: false
  private _warmUpConfiguration = new CloudwatchMetricAlarmWarmUpConfigurationOutputReference(this, "warm_up_configuration");
  public get warmUpConfiguration() {
    return this._warmUpConfiguration;
  }
  public putWarmUpConfiguration(value: CloudwatchMetricAlarmWarmUpConfiguration) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      warm_up_configuration: cloudwatchMetricAlarmWarmUpConfigurationToTerraform(this._warmUpConfiguration.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      warm_up_configuration: {
        value: cloudwatchMetricAlarmWarmUpConfigurationToHclTerraform(this._warmUpConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "CloudwatchMetricAlarmWarmUpConfigurationList",
      },
    };
