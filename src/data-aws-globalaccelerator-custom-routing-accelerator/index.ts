...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/globalaccelerator_custom_routing_accelerator
...
export class DataAwsGlobalacceleratorCustomRoutingAccelerator extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGlobalacceleratorCustomRoutingAccelerator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/globalaccelerator_custom_routing_accelerator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/globalaccelerator_custom_routing_accelerator aws_globalaccelerator_custom_routing_accelerator} Data Source
  *
  * @param scope The scope in which to define this construct
