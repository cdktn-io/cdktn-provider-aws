...
export class DataAwsEc2ServiceLinkVirtualInterface extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2ServiceLinkVirtualInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/ec2_service_link_virtual_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/ec2_service_link_virtual_interface aws_ec2_service_link_virtual_interface} Data Source
  *
  * @param scope The scope in which to define this construct
