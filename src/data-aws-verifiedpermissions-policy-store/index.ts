...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/verifiedpermissions_policy_store
...
export class DataAwsVerifiedpermissionsPolicyStore extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVerifiedpermissionsPolicyStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/verifiedpermissions_policy_store#import import section} in the documentation of this resource for the id to use
