...
// https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dynamodb_table_item
...
export class DynamodbTableItem extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamodbTableItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.61.0/docs/resources/dynamodb_table_item#import import section} in the documentation of this resource for the id to use
