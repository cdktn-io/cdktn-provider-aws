...
// https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/inspector_assessment_target
...
export class InspectorAssessmentTarget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InspectorAssessmentTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/inspector_assessment_target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.23.0/docs/resources/inspector_assessment_target aws_inspector_assessment_target} Resource
  *
  * @param scope The scope in which to define this construct
