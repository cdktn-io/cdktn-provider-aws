...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/s3_bucket
...
export class S3Bucket extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3Bucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/s3_bucket#import import section} in the documentation of this resource for the id to use
