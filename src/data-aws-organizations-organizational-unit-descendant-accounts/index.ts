...
// https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/organizations_organizational_unit_descendant_accounts
...
export class DataAwsOrganizationsOrganizationalUnitDescendantAccounts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsOrganizationalUnitDescendantAccounts that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/organizations_organizational_unit_descendant_accounts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/data-sources/organizations_organizational_unit_descendant_accounts aws_organizations_organizational_unit_descendant_accounts} Data Source
  *
  * @param scope The scope in which to define this construct
