...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/vpn_gateway_attachment
...
export class VpnGatewayAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/resources/vpn_gateway_attachment#import import section} in the documentation of this resource for the id to use
