...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/macie2_findings_filter
...
export class Macie2FindingsFilter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Macie2FindingsFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/macie2_findings_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/macie2_findings_filter aws_macie2_findings_filter} Resource
  *
  * @param scope The scope in which to define this construct
