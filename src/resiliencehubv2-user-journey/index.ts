...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/resiliencehubv2_user_journey
...
export class Resiliencehubv2UserJourney extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resiliencehubv2UserJourney that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/resiliencehubv2_user_journey#import import section} in the documentation of this resource for the id to use
