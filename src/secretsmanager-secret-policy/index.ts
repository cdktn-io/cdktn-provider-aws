...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/secretsmanager_secret_policy
...
export class SecretsmanagerSecretPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsmanagerSecretPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/secretsmanager_secret_policy#import import section} in the documentation of this resource for the id to use
