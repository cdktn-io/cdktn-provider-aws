...
// https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/cloudwatch_log_resource_policy
...
export class CloudwatchLogResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudwatchLogResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/resources/cloudwatch_log_resource_policy#import import section} in the documentation of this resource for the id to use
