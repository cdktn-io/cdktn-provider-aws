...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/connect_user_hierarchy_group
...
export class ConnectUserHierarchyGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectUserHierarchyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/connect_user_hierarchy_group#import import section} in the documentation of this resource for the id to use
