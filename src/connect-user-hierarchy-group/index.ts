...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/connect_user_hierarchy_group
...
export class ConnectUserHierarchyGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectUserHierarchyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/connect_user_hierarchy_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/connect_user_hierarchy_group aws_connect_user_hierarchy_group} Resource
  *
  * @param scope The scope in which to define this construct
