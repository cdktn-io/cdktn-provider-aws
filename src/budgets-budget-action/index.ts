...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/budgets_budget_action
...
export class BudgetsBudgetAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BudgetsBudgetAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/budgets_budget_action#import import section} in the documentation of this resource for the id to use
