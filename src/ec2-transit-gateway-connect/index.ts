...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/ec2_transit_gateway_connect
...
export class Ec2TransitGatewayConnect extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TransitGatewayConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/ec2_transit_gateway_connect#import import section} in the documentation of this resource for the id to use
