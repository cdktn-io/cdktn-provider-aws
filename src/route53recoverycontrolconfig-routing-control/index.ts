...
// https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/route53recoverycontrolconfig_routing_control
...
export class Route53RecoverycontrolconfigRoutingControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53RecoverycontrolconfigRoutingControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.49.0/docs/resources/route53recoverycontrolconfig_routing_control#import import section} in the documentation of this resource for the id to use
