...
// https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/devicefarm_project
...
export class DevicefarmProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevicefarmProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/devicefarm_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/devicefarm_project aws_devicefarm_project} Resource
  *
  * @param scope The scope in which to define this construct
