...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/redshift_producer_data_shares
...
export class DataAwsRedshiftProducerDataShares extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsRedshiftProducerDataShares that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/data-sources/redshift_producer_data_shares#import import section} in the documentation of this resource for the id to use
