...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/uxc_account_customizations
...
export class UxcAccountCustomizations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing UxcAccountCustomizations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/uxc_account_customizations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/uxc_account_customizations aws_uxc_account_customizations} Resource
  *
  * @param scope The scope in which to define this construct
