...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/prometheus_default_scraper_configuration
...
export class DataAwsPrometheusDefaultScraperConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsPrometheusDefaultScraperConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/prometheus_default_scraper_configuration#import import section} in the documentation of this resource for the id to use
