...
export class DataAwsElasticBeanstalkHostedZone extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsElasticBeanstalkHostedZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/elastic_beanstalk_hosted_zone#import import section} in the documentation of this resource for the id to use
