...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/ecs_daemon_task_definition
...
export class EcsDaemonTaskDefinition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsDaemonTaskDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/ecs_daemon_task_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/ecs_daemon_task_definition aws_ecs_daemon_task_definition} Resource
  *
  * @param scope The scope in which to define this construct
