...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/vpc_ipam_preview_next_cidr
...
export class VpcIpamPreviewNextCidr extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamPreviewNextCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/vpc_ipam_preview_next_cidr#import import section} in the documentation of this resource for the id to use
