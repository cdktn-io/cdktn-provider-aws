...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/ec2_client_vpn_endpoint
...
export class DataAwsEc2ClientVpnEndpoint extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEc2ClientVpnEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/ec2_client_vpn_endpoint#import import section} in the documentation of this resource for the id to use
