...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/lightsail_distribution
...
export class LightsailDistribution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LightsailDistribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/lightsail_distribution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/lightsail_distribution aws_lightsail_distribution} Resource
  *
  * @param scope The scope in which to define this construct
