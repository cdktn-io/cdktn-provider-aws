...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/sesv2_dedicated_ip_pool
...
export class DataAwsSesv2DedicatedIpPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSesv2DedicatedIpPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/data-sources/sesv2_dedicated_ip_pool#import import section} in the documentation of this resource for the id to use
