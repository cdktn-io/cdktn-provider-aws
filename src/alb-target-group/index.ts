...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/alb_target_group
...
export class AlbTargetGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlbTargetGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/alb_target_group#import import section} in the documentation of this resource for the id to use
