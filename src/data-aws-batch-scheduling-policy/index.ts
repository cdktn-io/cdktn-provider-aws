...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/batch_scheduling_policy
...
export class DataAwsBatchSchedulingPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBatchSchedulingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/data-sources/batch_scheduling_policy#import import section} in the documentation of this resource for the id to use
