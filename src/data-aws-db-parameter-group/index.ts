...
export class DataAwsDbParameterGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbParameterGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/db_parameter_group#import import section} in the documentation of this resource for the id to use
