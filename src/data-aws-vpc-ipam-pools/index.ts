...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/vpc_ipam_pools
...
export class DataAwsVpcIpamPools extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsVpcIpamPools that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/vpc_ipam_pools#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/data-sources/vpc_ipam_pools aws_vpc_ipam_pools} Data Source
  *
  * @param scope The scope in which to define this construct
