...
// https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_security_group_egress_rule
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_security_group_egress_rule aws_vpc_security_group_egress_rule}
*/
export class VpcSecurityGroupEgressRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcSecurityGroupEgressRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_security_group_egress_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.39.0/docs/resources/vpc_security_group_egress_rule aws_vpc_security_group_egress_rule} Resource
  *
  * @param scope The scope in which to define this construct
