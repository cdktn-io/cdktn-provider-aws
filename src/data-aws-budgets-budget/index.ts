...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/budgets_budget
...
export class DataAwsBudgetsBudget extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsBudgetsBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/data-sources/budgets_budget#import import section} in the documentation of this resource for the id to use
