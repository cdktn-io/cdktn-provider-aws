...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/codepipeline_webhook
...
export class CodepipelineWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CodepipelineWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/codepipeline_webhook#import import section} in the documentation of this resource for the id to use
