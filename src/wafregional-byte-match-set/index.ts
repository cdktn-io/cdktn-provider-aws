...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/wafregional_byte_match_set
...
export class WafregionalByteMatchSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalByteMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/wafregional_byte_match_set#import import section} in the documentation of this resource for the id to use
