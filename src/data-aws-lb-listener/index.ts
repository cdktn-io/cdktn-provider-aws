...
// https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/data-sources/lb_listener
...
export class DataAwsLbListener extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLbListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.47.0/docs/data-sources/lb_listener#import import section} in the documentation of this resource for the id to use
