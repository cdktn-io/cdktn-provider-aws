...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/ec2_transit_gateway_multicast_group_source
...
export class Ec2TransitGatewayMulticastGroupSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2TransitGatewayMulticastGroupSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/ec2_transit_gateway_multicast_group_source#import import section} in the documentation of this resource for the id to use
