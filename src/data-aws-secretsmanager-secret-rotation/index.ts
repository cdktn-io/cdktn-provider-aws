...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/secretsmanager_secret_rotation
...
export class DataAwsSecretsmanagerSecretRotation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSecretsmanagerSecretRotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/secretsmanager_secret_rotation#import import section} in the documentation of this resource for the id to use
