...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/data-sources/grafana_workspace
...
export class DataAwsGrafanaWorkspace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsGrafanaWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/data-sources/grafana_workspace#import import section} in the documentation of this resource for the id to use
