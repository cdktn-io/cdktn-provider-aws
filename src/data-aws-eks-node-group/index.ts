...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group
...
export interface DataAwsEksNodeGroupConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group#cluster_name DataAwsEksNodeGroup#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group#id DataAwsEksNodeGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group#node_group_name DataAwsEksNodeGroup#node_group_name}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group#tags DataAwsEksNodeGroup#tags}
  */
...
export class DataAwsEksNodeGroupLaunchTemplateOutputReference extends cdktn.ComplexObject {
...
export class DataAwsEksNodeGroupLaunchTemplateList extends cdktn.ComplexList {
...
export class DataAwsEksNodeGroupRemoteAccessOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEksNodeGroupRemoteAccessList extends cdktn.ComplexList {
...
export class DataAwsEksNodeGroupResourcesAutoscalingGroupsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEksNodeGroupResourcesAutoscalingGroupsList extends cdktn.ComplexList {
...
export class DataAwsEksNodeGroupResourcesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEksNodeGroupResourcesList extends cdktn.ComplexList {
...
export class DataAwsEksNodeGroupScalingConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEksNodeGroupScalingConfigList extends cdktn.ComplexList {
...
export class DataAwsEksNodeGroupTaintsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEksNodeGroupTaintsList extends cdktn.ComplexList {
...
export interface DataAwsEksNodeGroupUpdateConfig {
}

export function dataAwsEksNodeGroupUpdateConfigToTerraform(struct?: DataAwsEksNodeGroupUpdateConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEksNodeGroupUpdateConfigToHclTerraform(struct?: DataAwsEksNodeGroupUpdateConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsEksNodeGroupUpdateConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsEksNodeGroupUpdateConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsEksNodeGroupUpdateConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsEksNodeGroupUpdateConfigList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAwsEksNodeGroupUpdateConfigOutputReference {
    return new DataAwsEksNodeGroupUpdateConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataAwsEksNodeGroupWarmPoolConfig {
}

export function dataAwsEksNodeGroupWarmPoolConfigToTerraform(struct?: DataAwsEksNodeGroupWarmPoolConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataAwsEksNodeGroupWarmPoolConfigToHclTerraform(struct?: DataAwsEksNodeGroupWarmPoolConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataAwsEksNodeGroupWarmPoolConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAwsEksNodeGroupWarmPoolConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAwsEksNodeGroupWarmPoolConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAwsEksNodeGroupWarmPoolConfigList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAwsEksNodeGroupWarmPoolConfigOutputReference {
    return new DataAwsEksNodeGroupWarmPoolConfigOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group aws_eks_node_group}
*/
export class DataAwsEksNodeGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEksNodeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/data-sources/eks_node_group aws_eks_node_group} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _updateConfig = new DataAwsEksNodeGroupUpdateConfigList(this, "update_config", false);
  ...
  private _warmPoolConfig = new DataAwsEksNodeGroupWarmPoolConfigList(this, "warm_pool_config", false);
