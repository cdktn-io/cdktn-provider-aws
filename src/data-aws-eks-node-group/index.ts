...
export class DataAwsEksNodeGroupUpdateConfigOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
...
export class DataAwsEksNodeGroupUpdateConfigList extends cdktf.ComplexList {
