...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/kms_secrets
...
export class DataAwsKmsSecrets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKmsSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/kms_secrets#import import section} in the documentation of this resource for the id to use
