...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/mq_broker_instance_type_offerings
...
export class DataAwsMqBrokerInstanceTypeOfferings extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMqBrokerInstanceTypeOfferings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/data-sources/mq_broker_instance_type_offerings#import import section} in the documentation of this resource for the id to use
