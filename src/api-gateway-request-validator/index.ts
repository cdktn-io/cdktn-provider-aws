...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_request_validator
...
export class ApiGatewayRequestValidator extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayRequestValidator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/api_gateway_request_validator#import import section} in the documentation of this resource for the id to use
