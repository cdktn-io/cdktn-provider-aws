...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/vpc_block_public_access_options
...
export class VpcBlockPublicAccessOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcBlockPublicAccessOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/resources/vpc_block_public_access_options#import import section} in the documentation of this resource for the id to use
