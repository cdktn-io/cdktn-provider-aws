...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/codeconnections_host
...
export class CodeconnectionsHost extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodeconnectionsHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/resources/codeconnections_host#import import section} in the documentation of this resource for the id to use
