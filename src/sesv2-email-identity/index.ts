...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/sesv2_email_identity
...
export class Sesv2EmailIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2EmailIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/sesv2_email_identity#import import section} in the documentation of this resource for the id to use
