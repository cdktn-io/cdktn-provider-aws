...
// https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/securityhub_account_v2
...
export class SecurityhubAccountV2 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityhubAccountV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.58.0/docs/resources/securityhub_account_v2#import import section} in the documentation of this resource for the id to use
