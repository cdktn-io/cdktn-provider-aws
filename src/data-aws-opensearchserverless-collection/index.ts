...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/opensearchserverless_collection
...
export class DataAwsOpensearchserverlessCollection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOpensearchserverlessCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/opensearchserverless_collection#import import section} in the documentation of this resource for the id to use
