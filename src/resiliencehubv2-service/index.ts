...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/resiliencehubv2_service
...
export class Resiliencehubv2Service extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resiliencehubv2Service that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/resiliencehubv2_service#import import section} in the documentation of this resource for the id to use
