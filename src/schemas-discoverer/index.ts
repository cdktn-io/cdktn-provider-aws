...
export class SchemasDiscoverer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemasDiscoverer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/resources/schemas_discoverer#import import section} in the documentation of this resource for the id to use
