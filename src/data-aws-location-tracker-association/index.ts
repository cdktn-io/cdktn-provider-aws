...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/location_tracker_association
...
export class DataAwsLocationTrackerAssociation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationTrackerAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/location_tracker_association#import import section} in the documentation of this resource for the id to use
