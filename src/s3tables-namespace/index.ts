...
// https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/s3tables_namespace
...
export class S3TablesNamespace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3TablesNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.65.0/docs/resources/s3tables_namespace#import import section} in the documentation of this resource for the id to use
