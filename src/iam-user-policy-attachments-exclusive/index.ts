...
// https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/iam_user_policy_attachments_exclusive
...
export class IamUserPolicyAttachmentsExclusive extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamUserPolicyAttachmentsExclusive that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/iam_user_policy_attachments_exclusive#import import section} in the documentation of this resource for the id to use
