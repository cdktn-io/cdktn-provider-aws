...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudfront_connection_group
...
export class CloudfrontConnectionGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontConnectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudfront_connection_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/cloudfront_connection_group aws_cloudfront_connection_group} Resource
  *
  * @param scope The scope in which to define this construct
