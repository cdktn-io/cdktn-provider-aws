...
// https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/wafregional_ipset
...
export class DataAwsWafregionalIpset extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsWafregionalIpset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/data-sources/wafregional_ipset#import import section} in the documentation of this resource for the id to use
