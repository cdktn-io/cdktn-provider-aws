...
// https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/route53domains_domain
...
export class Route53DomainsDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53DomainsDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.16.0/docs/resources/route53domains_domain#import import section} in the documentation of this resource for the id to use
