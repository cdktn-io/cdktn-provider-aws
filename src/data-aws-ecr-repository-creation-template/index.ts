...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/ecr_repository_creation_template
...
export class DataAwsEcrRepositoryCreationTemplate extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcrRepositoryCreationTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/data-sources/ecr_repository_creation_template#import import section} in the documentation of this resource for the id to use
