...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/ssmquicksetup_configuration_manager
...
export class SsmquicksetupConfigurationManager extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmquicksetupConfigurationManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/ssmquicksetup_configuration_manager#import import section} in the documentation of this resource for the id to use
