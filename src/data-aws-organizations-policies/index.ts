...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/organizations_policies
...
export class DataAwsOrganizationsPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/data-sources/organizations_policies#import import section} in the documentation of this resource for the id to use
