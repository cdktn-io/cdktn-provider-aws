...
// https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_connection
...
export interface DxConnectionRateLimiterStatus {
}

export function dxConnectionRateLimiterStatusToTerraform(struct?: DxConnectionRateLimiterStatus): any {
...
export function dxConnectionRateLimiterStatusToHclTerraform(struct?: DxConnectionRateLimiterStatus): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DxConnectionRateLimiterStatusOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DxConnectionRateLimiterStatus | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DxConnectionRateLimiterStatus | undefined) {
    if (value === undefined) {
...
export class DxConnectionRateLimiterStatusList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DxConnectionRateLimiterStatusOutputReference {
    return new DxConnectionRateLimiterStatusOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DxConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DxConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.63.0/docs/resources/dx_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _rateLimiterStatus = new DxConnectionRateLimiterStatusList(this, "rate_limiter_status", false);
