...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/bedrock_guardrail
...
export class BedrockGuardrail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockGuardrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/bedrock_guardrail#import import section} in the documentation of this resource for the id to use
