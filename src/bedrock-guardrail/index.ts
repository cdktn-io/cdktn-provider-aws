...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/bedrock_guardrail
...
export class BedrockGuardrail extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BedrockGuardrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/bedrock_guardrail#import import section} in the documentation of this resource for the id to use
