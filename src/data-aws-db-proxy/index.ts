...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/db_proxy
...
export class DataAwsDbProxy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/db_proxy#import import section} in the documentation of this resource for the id to use
