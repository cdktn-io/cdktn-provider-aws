...
// https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/ecrpublic_authorization_token
...
export class DataAwsEcrpublicAuthorizationToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEcrpublicAuthorizationToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/ecrpublic_authorization_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.18.0/docs/data-sources/ecrpublic_authorization_token aws_ecrpublic_authorization_token} Data Source
  *
  * @param scope The scope in which to define this construct
