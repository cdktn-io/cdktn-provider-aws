...
// https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/availability_zone
...
export class DataAwsAvailabilityZone extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAvailabilityZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.64.0/docs/data-sources/availability_zone#import import section} in the documentation of this resource for the id to use
