...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudfront_distribution_tenant
...
export class CloudfrontDistributionTenant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfrontDistributionTenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/cloudfront_distribution_tenant#import import section} in the documentation of this resource for the id to use
