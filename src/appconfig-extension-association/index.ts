...
// https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appconfig_extension_association
...
export class AppconfigExtensionAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppconfigExtensionAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appconfig_extension_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/appconfig_extension_association aws_appconfig_extension_association} Resource
  *
  * @param scope The scope in which to define this construct
