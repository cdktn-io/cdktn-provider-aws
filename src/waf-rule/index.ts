...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/waf_rule
...
export class WafRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/waf_rule#import import section} in the documentation of this resource for the id to use
