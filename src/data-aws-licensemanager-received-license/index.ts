...
// https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/licensemanager_received_license
...
export class DataAwsLicensemanagerReceivedLicense extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLicensemanagerReceivedLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.38.0/docs/data-sources/licensemanager_received_license#import import section} in the documentation of this resource for the id to use
