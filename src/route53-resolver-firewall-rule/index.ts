...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/route53_resolver_firewall_rule
...
export class Route53ResolverFirewallRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ResolverFirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/route53_resolver_firewall_rule#import import section} in the documentation of this resource for the id to use
