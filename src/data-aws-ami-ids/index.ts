...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ami_ids
...
export class DataAwsAmiIds extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAmiIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ami_ids#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/ami_ids aws_ami_ids} Data Source
  *
  * @param scope The scope in which to define this construct
