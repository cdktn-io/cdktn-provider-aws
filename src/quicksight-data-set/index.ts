...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/quicksight_data_set
...
export class QuicksightDataSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing QuicksightDataSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/quicksight_data_set#import import section} in the documentation of this resource for the id to use
