...
// https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/codepipeline
...
export class Codepipeline extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Codepipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.33.0/docs/resources/codepipeline#import import section} in the documentation of this resource for the id to use
