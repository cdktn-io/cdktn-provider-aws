...
// https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/glue_partition
...
export class GluePartition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GluePartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/glue_partition#import import section} in the documentation of this resource for the id to use
