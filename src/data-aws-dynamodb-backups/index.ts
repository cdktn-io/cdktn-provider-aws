...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/dynamodb_backups
...
export class DataAwsDynamodbBackups extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsDynamodbBackups that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/dynamodb_backups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/dynamodb_backups aws_dynamodb_backups} Data Source
  *
  * @param scope The scope in which to define this construct
