...
export class Sesv2Tenant extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Sesv2Tenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.62.0/docs/resources/sesv2_tenant#import import section} in the documentation of this resource for the id to use
