...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/gamelift_build
...
export class GameliftBuild extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GameliftBuild that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/gamelift_build#import import section} in the documentation of this resource for the id to use
