...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/ssmincidents_response_plan
...
export class DataAwsSsmincidentsResponsePlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsmincidentsResponsePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/ssmincidents_response_plan#import import section} in the documentation of this resource for the id to use
