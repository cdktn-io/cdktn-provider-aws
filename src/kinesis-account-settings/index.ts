...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kinesis_account_settings
...
export class KinesisAccountSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KinesisAccountSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kinesis_account_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/kinesis_account_settings aws_kinesis_account_settings} Resource
  *
  * @param scope The scope in which to define this construct
