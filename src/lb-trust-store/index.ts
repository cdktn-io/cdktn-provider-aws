...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/lb_trust_store
...
export class LbTrustStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LbTrustStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/lb_trust_store#import import section} in the documentation of this resource for the id to use
