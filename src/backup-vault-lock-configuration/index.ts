...
// https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/backup_vault_lock_configuration
...
export class BackupVaultLockConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupVaultLockConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.20.0/docs/resources/backup_vault_lock_configuration#import import section} in the documentation of this resource for the id to use
