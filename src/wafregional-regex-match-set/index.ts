...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/wafregional_regex_match_set
...
export class WafregionalRegexMatchSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WafregionalRegexMatchSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/wafregional_regex_match_set#import import section} in the documentation of this resource for the id to use
