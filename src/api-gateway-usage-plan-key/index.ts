...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/api_gateway_usage_plan_key
...
export class ApiGatewayUsagePlanKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayUsagePlanKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/api_gateway_usage_plan_key#import import section} in the documentation of this resource for the id to use
