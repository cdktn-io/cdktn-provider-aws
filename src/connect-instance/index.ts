...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/connect_instance
...
export class ConnectInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.22.1/docs/resources/connect_instance#import import section} in the documentation of this resource for the id to use
