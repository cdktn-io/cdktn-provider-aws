...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/vpn_connection
...
export class VpnConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/vpn_connection#import import section} in the documentation of this resource for the id to use
