...
// https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/kinesisanalyticsv2_application
...
export class Kinesisanalyticsv2Application extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Kinesisanalyticsv2Application that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.48.0/docs/resources/kinesisanalyticsv2_application#import import section} in the documentation of this resource for the id to use
