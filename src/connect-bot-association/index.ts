...
// https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/connect_bot_association
...
export class ConnectBotAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectBotAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.24.0/docs/resources/connect_bot_association#import import section} in the documentation of this resource for the id to use
