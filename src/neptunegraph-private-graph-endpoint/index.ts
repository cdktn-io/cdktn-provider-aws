...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/neptunegraph_private_graph_endpoint
...
export class NeptunegraphPrivateGraphEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NeptunegraphPrivateGraphEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/resources/neptunegraph_private_graph_endpoint#import import section} in the documentation of this resource for the id to use
