...
// https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/ec2_allowed_images_settings
...
export class Ec2AllowedImagesSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2AllowedImagesSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.50.0/docs/resources/ec2_allowed_images_settings#import import section} in the documentation of this resource for the id to use
