...
// https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/autoscaling_schedule
...
export class AutoscalingSchedule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AutoscalingSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/autoscaling_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.55.0/docs/resources/autoscaling_schedule aws_autoscaling_schedule} Resource
  *
  * @param scope The scope in which to define this construct
