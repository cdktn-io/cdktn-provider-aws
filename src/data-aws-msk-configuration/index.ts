...
// https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/msk_configuration
...
export class DataAwsMskConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsMskConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs/data-sources/msk_configuration#import import section} in the documentation of this resource for the id to use
