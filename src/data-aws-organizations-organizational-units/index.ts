...
// https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/organizations_organizational_units
...
export class DataAwsOrganizationsOrganizationalUnits extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOrganizationsOrganizationalUnits that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.21.0/docs/data-sources/organizations_organizational_units#import import section} in the documentation of this resource for the id to use
