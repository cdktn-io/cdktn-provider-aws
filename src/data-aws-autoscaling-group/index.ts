...
// https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/autoscaling_group
...
export class DataAwsAutoscalingGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsAutoscalingGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.25.0/docs/data-sources/autoscaling_group#import import section} in the documentation of this resource for the id to use
