...
// https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/emrcontainers_virtual_cluster
...
export class DataAwsEmrcontainersVirtualCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEmrcontainersVirtualCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.32.1/docs/data-sources/emrcontainers_virtual_cluster#import import section} in the documentation of this resource for the id to use
