...
// https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/s3control_access_point_policy
...
export class S3ControlAccessPointPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing S3ControlAccessPointPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/s3control_access_point_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.43.0/docs/resources/s3control_access_point_policy aws_s3control_access_point_policy} Resource
  *
  * @param scope The scope in which to define this construct
