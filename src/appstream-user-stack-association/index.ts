...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/appstream_user_stack_association
...
export class AppstreamUserStackAssociation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppstreamUserStackAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/appstream_user_stack_association#import import section} in the documentation of this resource for the id to use
