...
// https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/servicecatalog_service_action
...
export class ServicecatalogServiceAction extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicecatalogServiceAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.46.0/docs/resources/servicecatalog_service_action#import import section} in the documentation of this resource for the id to use
