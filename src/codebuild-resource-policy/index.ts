...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codebuild_resource_policy
...
export class CodebuildResourcePolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodebuildResourcePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/resources/codebuild_resource_policy#import import section} in the documentation of this resource for the id to use
