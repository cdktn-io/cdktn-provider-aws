...
// https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/sfn_state_machine_versions
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/sfn_state_machine_versions aws_sfn_state_machine_versions}
*/
export class DataAwsSfnStateMachineVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSfnStateMachineVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/sfn_state_machine_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.54.0/docs/data-sources/sfn_state_machine_versions aws_sfn_state_machine_versions} Data Source
  *
  * @param scope The scope in which to define this construct
