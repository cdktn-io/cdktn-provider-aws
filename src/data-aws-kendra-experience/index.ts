...
// https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/kendra_experience
...
export class DataAwsKendraExperience extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKendraExperience that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.66.0/docs/data-sources/kendra_experience#import import section} in the documentation of this resource for the id to use
