...
// https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener
...
export interface VpclatticeListenerConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#id VpclatticeListener#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#name VpclatticeListener#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#port VpclatticeListener#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#protocol VpclatticeListener#protocol}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#service_arn VpclatticeListener#service_arn}
  */
  readonly serviceArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#service_identifier VpclatticeListener#service_identifier}
  */
  readonly serviceIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#tags VpclatticeListener#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#tags_all VpclatticeListener#tags_all}
  */
...
export interface VpclatticeListenerDefaultActionFixedResponse {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#status_code VpclatticeListener#status_code}
  */
...
export interface VpclatticeListenerDefaultActionForwardTargetGroups {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#target_group_identifier VpclatticeListener#target_group_identifier}
  */
  readonly targetGroupIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#weight VpclatticeListener#weight}
  */
...
export interface VpclatticeListenerDefaultActionForward {
  ...
  * target_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#target_groups VpclatticeListener#target_groups}
  */
...
export function vpclatticeListenerDefaultActionForwardToTerraform(struct?: VpclatticeListenerDefaultActionForward | cdktn.IResolvable): any {
  ...
  return {
    target_groups: cdktn.listMapper(vpclatticeListenerDefaultActionForwardTargetGroupsToTerraform, true)(struct!.targetGroups),
  }
}
...
export function vpclatticeListenerDefaultActionForwardToHclTerraform(struct?: VpclatticeListenerDefaultActionForward | cdktn.IResolvable): any {
  ...
  const attrs = {
    target_groups: {
      value: cdktn.listMapperHcl(vpclatticeListenerDefaultActionForwardTargetGroupsToHclTerraform, true)(struct!.targetGroups),
      isBlock: true,
      type: "list",
...
export class VpclatticeListenerDefaultActionForwardList extends cdktn.ComplexList {
  public internalValue? : VpclatticeListenerDefaultActionForward[] | cdktn.IResolvable
...
export interface VpclatticeListenerDefaultAction {
  ...
  */
  readonly forward?: VpclatticeListenerDefaultActionForward[] | cdktn.IResolvable;
}
...
export function vpclatticeListenerDefaultActionToTerraform(struct?: VpclatticeListenerDefaultActionOutputReference | VpclatticeListenerDefaultAction): any {
  ...
  return {
    ...
    forward: cdktn.listMapper(vpclatticeListenerDefaultActionForwardToTerraform, true)(struct!.forward),
  }
}
...
export function vpclatticeListenerDefaultActionToHclTerraform(struct?: VpclatticeListenerDefaultActionOutputReference | VpclatticeListenerDefaultAction): any {
  ...
  const attrs = {
    ...
    forward: {
      value: cdktn.listMapperHcl(vpclatticeListenerDefaultActionForwardToHclTerraform, true)(struct!.forward),
      isBlock: true,
      type: "list",
...
export class VpclatticeListenerDefaultActionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public putForward(value: VpclatticeListenerDefaultActionForward[] | cdktn.IResolvable) {
...
export interface VpclatticeListenerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#create VpclatticeListener#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#delete VpclatticeListener#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#update VpclatticeListener#update}
  */
  readonly update?: string;
}

export function vpclatticeListenerTimeoutsToTerraform(struct?: VpclatticeListenerTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function vpclatticeListenerTimeoutsToHclTerraform(struct?: VpclatticeListenerTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VpclatticeListenerTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): VpclatticeListenerTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: VpclatticeListenerTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener aws_vpclattice_listener}
*/
export class VpclatticeListener extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.42.0/docs/resources/vpclattice_listener aws_vpclattice_listener} Resource
  *
  * @param scope The scope in which to define this construct
