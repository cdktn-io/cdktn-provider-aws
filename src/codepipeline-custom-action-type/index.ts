...
// https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/codepipeline_custom_action_type
...
export class CodepipelineCustomActionType extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CodepipelineCustomActionType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.36.0/docs/resources/codepipeline_custom_action_type#import import section} in the documentation of this resource for the id to use
