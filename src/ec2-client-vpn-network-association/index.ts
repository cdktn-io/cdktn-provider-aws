...
// https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/ec2_client_vpn_network_association
...
export class Ec2ClientVpnNetworkAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ec2ClientVpnNetworkAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.19.0/docs/resources/ec2_client_vpn_network_association#import import section} in the documentation of this resource for the id to use
