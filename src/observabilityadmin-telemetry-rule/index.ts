...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/observabilityadmin_telemetry_rule
...
export class ObservabilityadminTelemetryRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ObservabilityadminTelemetryRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/observabilityadmin_telemetry_rule#import import section} in the documentation of this resource for the id to use
