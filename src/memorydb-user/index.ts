...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/memorydb_user
...
export class MemorydbUser extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MemorydbUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/memorydb_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/resources/memorydb_user aws_memorydb_user} Resource
  *
  * @param scope The scope in which to define this construct
