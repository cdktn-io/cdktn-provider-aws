...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/vpclattice_domain_verification
...
export class VpclatticeDomainVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpclatticeDomainVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/resources/vpclattice_domain_verification#import import section} in the documentation of this resource for the id to use
