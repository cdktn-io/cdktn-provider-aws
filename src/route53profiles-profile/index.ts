...
// https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/route53profiles_profile
...
export class Route53ProfilesProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Route53ProfilesProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.45.0/docs/resources/route53profiles_profile#import import section} in the documentation of this resource for the id to use
