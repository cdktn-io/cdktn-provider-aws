...
// https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/glue_dev_endpoint
...
export class GlueDevEndpoint extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GlueDevEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.51.0/docs/resources/glue_dev_endpoint#import import section} in the documentation of this resource for the id to use
