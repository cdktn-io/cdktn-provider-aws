...
// https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/location_geofence_collection
...
export class DataAwsLocationGeofenceCollection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsLocationGeofenceCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.31.0/docs/data-sources/location_geofence_collection#import import section} in the documentation of this resource for the id to use
