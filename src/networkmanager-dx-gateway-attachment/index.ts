...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/networkmanager_dx_gateway_attachment
...
export interface NetworkmanagerDxGatewayAttachmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function networkmanagerDxGatewayAttachmentTimeoutsToTerraform(struct?: NetworkmanagerDxGatewayAttachmentTimeouts | cdktn.IResolvable): any {
...
export function networkmanagerDxGatewayAttachmentTimeoutsToHclTerraform(struct?: NetworkmanagerDxGatewayAttachmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkmanagerDxGatewayAttachmentTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkmanagerDxGatewayAttachmentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: NetworkmanagerDxGatewayAttachmentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class NetworkmanagerDxGatewayAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkmanagerDxGatewayAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/networkmanager_dx_gateway_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.0/docs/resources/networkmanager_dx_gateway_attachment aws_networkmanager_dx_gateway_attachment} Resource
  *
  * @param scope The scope in which to define this construct
