...
// https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/vpc_route_server_peer
...
export class VpcRouteServerPeer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcRouteServerPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/vpc_route_server_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.35.1/docs/resources/vpc_route_server_peer aws_vpc_route_server_peer} Resource
  *
  * @param scope The scope in which to define this construct
