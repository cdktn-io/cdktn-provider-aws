...
// https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/api_gateway_export
...
export class DataAwsApiGatewayExport extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsApiGatewayExport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.60.0/docs/data-sources/api_gateway_export#import import section} in the documentation of this resource for the id to use
