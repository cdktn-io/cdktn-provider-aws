...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/directory_service_directory
...
export class DirectoryServiceDirectory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectoryServiceDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/directory_service_directory#import import section} in the documentation of this resource for the id to use
