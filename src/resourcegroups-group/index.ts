...
// https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/resourcegroups_group
...
export class ResourcegroupsGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcegroupsGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.37.0/docs/resources/resourcegroups_group#import import section} in the documentation of this resource for the id to use
