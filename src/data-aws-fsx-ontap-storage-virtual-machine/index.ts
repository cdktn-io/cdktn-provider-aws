...
// https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/fsx_ontap_storage_virtual_machine
...
export class DataAwsFsxOntapStorageVirtualMachine extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsFsxOntapStorageVirtualMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.41.0/docs/data-sources/fsx_ontap_storage_virtual_machine#import import section} in the documentation of this resource for the id to use
