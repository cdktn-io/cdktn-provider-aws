...
// https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/securityhub_enabled_standards
...
export class DataAwsSecurityhubEnabledStandards extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSecurityhubEnabledStandards that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/securityhub_enabled_standards#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/aws/6.57.1/docs/data-sources/securityhub_enabled_standards aws_securityhub_enabled_standards} Data Source
  *
  * @param scope The scope in which to define this construct
