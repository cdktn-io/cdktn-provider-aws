...
// https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/transfer_host_key
...
export class TransferHostKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransferHostKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/aws/6.17.0/docs/resources/transfer_host_key#import import section} in the documentation of this resource for the id to use
